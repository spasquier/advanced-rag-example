...
01. [What is Active Storage?](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#what-is-active-storage-questionmark)
02. [Setup](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#setup)    - [Disk Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#disk-service)
    - [S3 Service (Amazon S3 and S3-compatible APIs)](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#s3-service-amazon-s3-and-s3-compatible-apis)
    - [Microsoft Azure Storage Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#microsoft-azure-storage-service)
    - [Google Cloud Storage Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#google-cloud-storage-service)
    - [Mirror Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#mirror-service)
    - [Public access](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#public-access)
03. [Attaching Files to Records](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#attaching-files-to-records)    - [`has_one_attached`](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#has-one-attached)
    - [`has_many_attached`](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#has-many-attached)
    - [Attaching File/IO Objects](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#attaching-file-io-objects)
04. [Removing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#removing-files)
05. [Linking to Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#linking-to-files)
06. [Downloading Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#downloading-files)
07. [Analyzing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#analyzing-files)
08. [Transforming Images](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#transforming-images)
09. [Previewing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#previewing-files)
10. [Direct Uploads](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#direct-uploads)    - [Usage](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#usage)
    - [Cross-Origin Resource Sharing (CORS) configuration](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#cross-origin-resource-sharing-cors-configuration)
    - [Direct upload JavaScript events](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#direct-upload-javascript-events)
    - [Example](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#example)
    - [Integrating with Libraries or Frameworks](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#integrating-with-libraries-or-frameworks)
11. [Discarding Files Stored During System Tests](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#discarding-files-stored-during-system-tests)
12. [Discarding Files Stored During Integration Tests](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#discarding-files-stored-during-integration-tests)
13. [Implementing Support for Other Cloud Services](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#implementing-support-for-other-cloud-services)

### [1 What is Active Storage?](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#what-is-active-storage-questionmark)
...
### [2 Setup](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#setup)
...
If you are using UUIDs instead of integers as the primary key on your models you will need to change the column type of `record_id` for the `active_storage_attachments` table in the generated migration accordingly.
...
#### [2.1 Disk Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#disk-service)
...
#### [2.2 S3 Service (Amazon S3 and S3-compatible APIs)](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#s3-service-amazon-s3-and-s3-compatible-apis)
...
The core features of Active Storage require the following permissions: `s3:ListBucket`, `s3:PutObject`, `s3:GetObject`, and `s3:DeleteObject`. [Public access](https://guides.rubyonrails.org/v6.1/active_storage_overview.html#public-access) additionally requires `s3:PutObjectAcl`. If you have additional upload options configured such as setting ACLs then additional permissions may be required.
...
#### [2.3 Microsoft Azure Storage Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#microsoft-azure-storage-service)
...
#### [2.4 Google Cloud Storage Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#google-cloud-storage-service)
...
#### [2.5 Mirror Service](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#mirror-service)
...
#### [2.6 Public access](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#public-access)
...
### [3 Attaching Files to Records](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#attaching-files-to-records)

#### [3.1 `has_one_attached`](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#has-one-attached)

The [`has_one_attached`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/Model.html#method-i-has_one_attached) macro sets up a one-to-one mapping between records and
...
Call [`avatar.attach`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/One.html#method-i-attach) to attach an avatar to an existing user:
...
Call [`avatar.attached?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/One.html#method-i-attached-3F) to determine whether a particular user has an avatar:
...
#### [3.2 `has_many_attached`](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#has-many-attached)

The [`has_many_attached`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/Model.html#method-i-has_many_attached) macro sets up a one-to-many relationship between records
...
Call [`images.attach`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/Many.html#method-i-attach) to add new images to an existing message:
...
Call [`images.attached?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/Many.html#method-i-attached-3F) to determine whether a particular message has any images:
...
#### [3.3 Attaching File/IO Objects](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#attaching-file-io-objects)
...
### [4 Removing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#removing-files)

To remove an attachment from a model, call [`purge`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/One.html#method-i-purge) on the
attachment. If your application is set up to use Active Job, removal can be done
in the background instead by calling [`purge_later`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Attached/One.html#method-i-purge_later).
...
### [5 Linking to Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#linking-to-files)
...
To prevent XSS attacks, ActiveStorage forces the Content-Disposition header
to "attachment" for some kind of files. To change this behaviour see the
available configuration options in [Configuring Rails Applications](https://guides.rubyonrails.org/v6.1/configuring.html#configuring-active-storage).
...
### [6 Downloading Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#downloading-files)

Sometimes you need to process a blob after it’s uploaded—for example, to convert
it to a different format. Use the attachment's [`download`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob.html#method-i-download) method to read a blob’s
...
[`open`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob.html#method-i-open) method to download a blob to a tempfile on disk:
...
### [7 Analyzing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#analyzing-files)

Active Storage [analyzes](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob/Analyzable.html#method-i-analyze) files once they've been uploaded by queuing a job in Active Job. Analyzed files will store additional information in the metadata hash, including `analyzed: true`. You can check whether a blob has been analyzed by calling [`analyzed?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob/Analyzable.html#method-i-analyzed-3F) on it.
...
### [8 Transforming Images](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#transforming-images)
...
To create a variation of an image, call [`variant`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob/Representable.html#method-i-variant) on the attachment. You can pass any transformation to the method supported by the processor. The default processor for Active Storage is MiniMagick, but you can also use [Vips](https://www.rubydoc.info/gems/ruby-vips/Vips/Image).
...
### [9 Previewing Files](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#previewing-files)
...
a link to a lazily-generated preview, use the attachment's [`preview`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveStorage/Blob/Representable.html#method-i-preview) method:
...
Extracting previews requires third-party applications: FFmpeg v3.4+ for
...
### [10 Direct Uploads](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#direct-uploads)

Active Storage, with its included JavaScript library, supports uploading
directly from the client to the cloud.

#### [10.1 Usage](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#usage)
...
2. Add `direct_upload: true` to your [file field](https://guides.rubyonrails.org/v6.1/form_helpers.html#uploading-files):
...
#### [10.2 Cross-Origin Resource Sharing (CORS) configuration](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#cross-origin-resource-sharing-cors-configuration)
...
##### [10.2.1 Example: S3 CORS configuration](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#example-s3-cors-configuration)
...
##### [10.2.2 Example: Google Cloud Storage CORS configuration](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#example-google-cloud-storage-cors-configuration)
...
##### [10.2.3 Example: Azure Storage CORS configuration](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#example-azure-storage-cors-configuration)
...
#### [10.3 Direct upload JavaScript events](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#direct-upload-javascript-events)
...
#### [10.4 Example](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#example)
...
#### [10.5 Integrating with Libraries or Frameworks](https://guides.rubyonrails.org/v6.1/active_storage_overview.html\#integrating-with-libraries-or-frameworks)
