...
1. [Command Line Basics](https://guides.rubyonrails.org/v6.1/command_line.html#command-line-basics)   - [`rails new`](https://guides.rubyonrails.org/v6.1/command_line.html#rails-new)
   - [`bin/rails server`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-server)
   - [`bin/rails generate`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-generate)
   - [`bin/rails console`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-console)
   - [`bin/rails dbconsole`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-dbconsole)
   - [`bin/rails runner`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-runner)
   - [`bin/rails destroy`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-destroy)
   - [`bin/rails about`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-about)
   - [`bin/rails assets:`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-assets)
   - [`bin/rails db:`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-db)
   - [`bin/rails notes`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-notes)
   - [`bin/rails routes`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-routes)
   - [`bin/rails test`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-test)
   - [`bin/rails tmp:`](https://guides.rubyonrails.org/v6.1/command_line.html#bin-rails-tmp)
   - [Miscellaneous](https://guides.rubyonrails.org/v6.1/command_line.html#miscellaneous)
   - [Custom Rake Tasks](https://guides.rubyonrails.org/v6.1/command_line.html#custom-rake-tasks)
2. [The Rails Advanced Command Line](https://guides.rubyonrails.org/v6.1/command_line.html#the-rails-advanced-command-line)   - [Rails with Databases and SCM](https://guides.rubyonrails.org/v6.1/command_line.html#rails-with-databases-and-scm)

This tutorial assumes you have basic Rails knowledge from reading the [Getting Started with Rails Guide](https://guides.rubyonrails.org/v6.1/getting_started.html).

### [1 Command Line Basics](https://guides.rubyonrails.org/v6.1/command_line.html\#command-line-basics)
...
#### [1.1 `rails new`](https://guides.rubyonrails.org/v6.1/command_line.html\#rails-new)
...
#### [1.2 `bin/rails server`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-server)
...
#### [1.3 `bin/rails generate`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-generate)
...
Let's talk about unit tests. Unit tests are code that tests and makes assertions
...
#### [1.4 `bin/rails console`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-console)
...
##### [1.4.1 The app and helper objects](https://guides.rubyonrails.org/v6.1/command_line.html\#the-app-and-helper-objects)
...
#### [1.5 `bin/rails dbconsole`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-dbconsole)
...
#### [1.6 `bin/rails runner`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-runner)
...
#### [1.7 `bin/rails destroy`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-destroy)
...
#### [1.8 `bin/rails about`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-about)
...
#### [1.9 `bin/rails assets:`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-assets)
...
#### [1.10 `bin/rails db:`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-db)
...
More information about migrations can be found in the [Migrations](https://guides.rubyonrails.org/v6.1/active_record_migrations.html) guide.

#### [1.11 `bin/rails notes`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-notes)
...
##### [1.11.1 Annotations](https://guides.rubyonrails.org/v6.1/command_line.html\#annotations)
...
##### [1.11.2 Tags](https://guides.rubyonrails.org/v6.1/command_line.html\#tags)
...
##### [1.11.3 Directories](https://guides.rubyonrails.org/v6.1/command_line.html\#directories)
...
##### [1.11.4 Extensions](https://guides.rubyonrails.org/v6.1/command_line.html\#extensions)
...
#### [1.12 `bin/rails routes`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-routes)
...
#### [1.13 `bin/rails test`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-test)

A good description of unit testing in Rails is given in [A Guide to Testing Rails Applications](https://guides.rubyonrails.org/v6.1/testing.html)
...
#### [1.14 `bin/rails tmp:`](https://guides.rubyonrails.org/v6.1/command_line.html\#bin-rails-tmp)
...
#### [1.15 Miscellaneous](https://guides.rubyonrails.org/v6.1/command_line.html\#miscellaneous)
...
#### [1.16 Custom Rake Tasks](https://guides.rubyonrails.org/v6.1/command_line.html\#custom-rake-tasks)
...
### [2 The Rails Advanced Command Line](https://guides.rubyonrails.org/v6.1/command_line.html\#the-rails-advanced-command-line)

More advanced use of the command line is focused around finding useful (even surprising at times) options in the utilities, and fitting those to your needs and specific work flow. Listed here are some tricks up Rails' sleeve.

#### [2.1 Rails with Databases and SCM](https://guides.rubyonrails.org/v6.1/command_line.html\#rails-with-databases-and-scm)
