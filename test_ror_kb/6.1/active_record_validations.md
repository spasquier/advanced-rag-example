...
1. [Validations Overview](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validations-overview)   - [Why Use Validations?](https://guides.rubyonrails.org/v6.1/active_record_validations.html#why-use-validations-questionmark)
   - [When Does Validation Happen?](https://guides.rubyonrails.org/v6.1/active_record_validations.html#when-does-validation-happen-questionmark)
   - [Skipping Validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html#skipping-validations)
   - [`valid?` and `invalid?`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#valid-questionmark-and-invalid-questionmark)
   - [`errors[]`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validations-overview-errors)
2. [Validation Helpers](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validation-helpers)   - [`acceptance`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#acceptance)
   - [`validates_associated`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validates-associated)
   - [`confirmation`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#confirmation)
   - [`exclusion`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#exclusion)
   - [`format`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#format)
   - [`inclusion`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#inclusion)
   - [`length`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#length)
   - [`numericality`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#numericality)
   - [`presence`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#presence)
   - [`absence`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#absence)
   - [`uniqueness`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#uniqueness)
   - [`validates_with`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validates-with)
   - [`validates_each`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#validates-each)
3. [Common Validation Options](https://guides.rubyonrails.org/v6.1/active_record_validations.html#common-validation-options)   - [`:allow_nil`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#allow-nil)
   - [`:allow_blank`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#allow-blank)
   - [`:message`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#message)
   - [`:on`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#on)
4. [Strict Validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html#strict-validations)
5. [Conditional Validation](https://guides.rubyonrails.org/v6.1/active_record_validations.html#conditional-validation)   - [Using a Symbol with `:if` and `:unless`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#using-a-symbol-with-if-and-unless)
   - [Using a Proc with `:if` and `:unless`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#using-a-proc-with-if-and-unless)
   - [Grouping Conditional validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html#grouping-conditional-validations)
   - [Combining Validation Conditions](https://guides.rubyonrails.org/v6.1/active_record_validations.html#combining-validation-conditions)
6. [Performing Custom Validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html#performing-custom-validations)   - [Custom Validators](https://guides.rubyonrails.org/v6.1/active_record_validations.html#custom-validators)
   - [Custom Methods](https://guides.rubyonrails.org/v6.1/active_record_validations.html#custom-methods)
7. [Working with Validation Errors](https://guides.rubyonrails.org/v6.1/active_record_validations.html#working-with-validation-errors)   - [`errors`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#working-with-validation-errors-errors)
   - [`errors[]`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors)
   - [`errors.where` and error object](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors-where-and-error-object)
   - [`errors.add`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors-add)
   - [`errors[:base]`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors-base)
   - [`errors.clear`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors-clear)
   - [`errors.size`](https://guides.rubyonrails.org/v6.1/active_record_validations.html#errors-size)
8. [Displaying Validation Errors in Views](https://guides.rubyonrails.org/v6.1/active_record_validations.html#displaying-validation-errors-in-views)

### [1 Validations Overview](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validations-overview)
...
#### [1.1 Why Use Validations?](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#why-use-validations-questionmark)
...
#### [1.2 When Does Validation Happen?](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#when-does-validation-happen-questionmark)
...
#### [1.3 Skipping Validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#skipping-validations)
...
#### [1.4 `valid?` and `invalid?`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#valid-questionmark-and-invalid-questionmark)
...
You can also run these validations on your own. [`valid?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveRecord/Validations.html#method-i-valid-3F) triggers your validations
...
through the [`errors`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations.html#method-i-errors) instance method, which returns a collection of errors.
...
[`invalid?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations.html#method-i-invalid-3F) is the inverse of `valid?`. It triggers your validations,
returning true if any errors were found in the object, and false otherwise.

#### [1.5 `errors[]`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validations-overview-errors)

To verify whether or not a particular attribute of an object is valid, you can
use [`errors[:attribute]`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Errors.html#method-i-5B-5D). It returns an array of all the error messages for
...
Errors](https://guides.rubyonrails.org/v6.1/active_record_validations.html#working-with-validation-errors) section.

### [2 Validation Helpers](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validation-helpers)
...
#### [2.1 `acceptance`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#acceptance)
...
#### [2.2 `validates_associated`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validates-associated)
...
The default error message for [`validates_associated`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveRecord/Validations/ClassMethods.html#method-i-validates_associated) is _"is invalid"_. Note
that each associated object will contain its own `errors` collection; errors do
not bubble up to the calling model.

#### [2.3 `confirmation`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#confirmation)
...
#### [2.4 `exclusion`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#exclusion)
...
[message documentation](https://guides.rubyonrails.org/v6.1/active_record_validations.html#message).

The default error message is _"is reserved"_.

#### [2.5 `format`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#format)
...
#### [2.6 `inclusion`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#inclusion)
...
options please see the [message documentation](https://guides.rubyonrails.org/v6.1/active_record_validations.html#message).

The default error message for this helper is _"is not included in the list"_.

#### [2.7 `length`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#length)
...
#### [2.8 `numericality`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#numericality)
...
value. The default error message for this option is _"must be greater than_
_%{count}"_.
...
the supplied value. The default error message for this option is _"must be_
_less than or equal to %{count}"_.
...
#### [2.9 `presence`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#presence)
...
#### [2.10 `absence`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#absence)
...
#### [2.11 `uniqueness`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#uniqueness)
...
#### [2.12 `validates_with`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validates-with)
...
The [`validates_with`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_with) helper takes a class, or a list of classes to use for
...
Note that the validator will be initialized _only once_ for the whole application
...
#### [2.13 `validates_each`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#validates-each)
...
passed to [`validates_each`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_each) will be tested against it. In the following example,
...
### [3 Common Validation Options](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#common-validation-options)

These are common validation options:

#### [3.1 `:allow_nil`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#allow-nil)
...
#### [3.2 `:allow_blank`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#allow-blank)
...
#### [3.3 `:message`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#message)
...
#### [3.4 `:on`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#on)
...
### [5 Conditional Validation](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#conditional-validation)
...
#### [5.1 Using a Symbol with `:if` and `:unless`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#using-a-symbol-with-if-and-unless)
...
#### [5.2 Using a Proc with `:if` and `:unless`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#using-a-proc-with-if-and-unless)
...
#### [5.3 Grouping Conditional validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#grouping-conditional-validations)

Sometimes it is useful to have multiple validations use one condition. It can
be easily achieved using [`with_options`](https://api.rubyonrails.org/v6.1.7.10/classes/Object.html#method-i-with_options).
...
#### [5.4 Combining Validation Conditions](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#combining-validation-conditions)
...
### [6 Performing Custom Validations](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#performing-custom-validations)
...
#### [6.1 Custom Validators](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#custom-validators)

Custom validators are classes that inherit from [`ActiveModel::Validator`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validator.html). These
...
#### [6.2 Custom Methods](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#custom-methods)
...
register these methods by using the [`validate`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations/ClassMethods.html#method-i-validate)
...
### [7 Working with Validation Errors](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#working-with-validation-errors)

The [`valid?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveRecord/Validations.html#method-i-valid-3F) and [`invalid?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations.html#method-i-invalid-3F) methods only provide a summary status on validity. However you can dig deeper into each individual error by using various methods from the [`errors`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Validations.html#method-i-errors) collection.

The following is a list of the most commonly used methods. Please refer to the [`ActiveModel::Errors`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Errors.html) documentation for a list of all the available methods.

#### [7.1 `errors`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#working-with-validation-errors-errors)
...
each error is represented by an [`ActiveModel::Error`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Error.html) object.
...
#### [7.3 `errors.where` and error object](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#errors-where-and-error-object)

Sometimes we may need more information about each error beside its message. Each error is encapsulated as an `ActiveModel::Error` object, and [`where`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Errors.html#method-i-where) method is the most common way of access.
...
The [`full_message`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Errors.html#method-i-full_message) method generates a more user-friendly message, with the capitalized attribute name prepended.

#### [7.4 `errors.add`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#errors-add)

The [`add`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveModel/Errors.html#method-i-add) method creates the error object by taking the `attribute`, the error `type` and additional options hash. This is useful for writing your own validator.
...
#### [7.5 `errors[:base]`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#errors-base)
...
#### [7.6 `errors.clear`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#errors-clear)
...
#### [7.7 `errors.size`](https://guides.rubyonrails.org/v6.1/active_record_validations.html\#errors-size)
