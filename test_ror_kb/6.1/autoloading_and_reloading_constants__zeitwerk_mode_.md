...
01. [Introduction](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#introduction)
02. [Enabling Zeitwerk Mode](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#enabling-zeitwerk-mode)
03. [Project Structure](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#project-structure)
04. [Autoload Paths](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#autoload-paths)
05. [$LOAD\_PATH](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#%24load-path)
06. [Reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#reloading)    - [Reloading and Stale Objects](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#reloading-and-stale-objects)
    - [Autoloading when the application boots](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#autoloading-when-the-application-boots)
07. [Eager Loading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#eager-loading)
08. [Single Table Inheritance](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#single-table-inheritance)
09. [Customizing Inflections](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#customizing-inflections)
10. [Troubleshooting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#troubleshooting)
11. [Rails.autoloaders](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#rails-autoloaders)
12. [Differences with Classic Mode](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#differences-with-classic-mode)    - [Ruby Constant Lookup Compliance](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#ruby-constant-lookup-compliance)
    - [Less File Lookups](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#less-file-lookups)
    - [Underscore vs Camelize](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#underscore-vs-camelize)
    - [More Differences](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#more-differences)
13. [Classic Mode is Deprecated](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#classic-mode-is-deprecated)
14. [Opting Out](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html#opting-out)

### [1 Introduction](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#introduction)

This guide documents autoloading in `zeitwerk` mode, which is new in Rails 6. If you'd like to read about `classic` mode instead, please check [Autoloading and Reloading Constants (Classic Mode)](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html).
...
### [2 Enabling Zeitwerk Mode](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#enabling-zeitwerk-mode)
...
### [3 Project Structure](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#project-structure)
...
### [4 Autoload Paths](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#autoload-paths)
...
### [5 $LOAD\_PATH](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#%24load-path)
...
### [6 Reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#reloading)
...
#### [6.1 Reloading and Stale Objects](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#reloading-and-stale-objects)
...
#### [6.2 Autoloading when the application boots](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#autoloading-when-the-application-boots)
...
### [7 Eager Loading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#eager-loading)
...
### [8 Single Table Inheritance](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#single-table-inheritance)
...
### [9 Customizing Inflections](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#customizing-inflections)
...
### [12 Differences with Classic Mode](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#differences-with-classic-mode)

#### [12.1 Ruby Constant Lookup Compliance](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#ruby-constant-lookup-compliance)
...
#### [12.2 Less File Lookups](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#less-file-lookups)
...
#### [12.3 Underscore vs Camelize](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#underscore-vs-camelize)
...
#### [12.4 More Differences](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#more-differences)

There are some other subtle differences, please check [this section of _Upgrading Ruby on Rails_](https://guides.rubyonrails.org/v6.1/upgrading_ruby_on_rails.html#autoloading) guide for details.

### [13 Classic Mode is Deprecated](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html\#classic-mode-is-deprecated)

By now, it is still possible to use `classic` mode. However, `classic` is deprecated and will be eventually removed.

New applications should use `zeitwerk` mode (which is the default), and applications being upgrade are strongly encouraged to migrate to `zeitwerk` mode. Please check the [_Upgrading Ruby on Rails_](https://guides.rubyonrails.org/v6.1/upgrading_ruby_on_rails.html#autoloading) guide for details.
