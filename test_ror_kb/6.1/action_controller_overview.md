...
01. [What Does a Controller Do?](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#what-does-a-controller-do-questionmark)
02. [Controller Naming Convention](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#controller-naming-convention)
03. [Methods and Actions](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#methods-and-actions)
04. [Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#parameters)    - [Hash and Array Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#hash-and-array-parameters)
    - [JSON parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#json-parameters)
    - [Routing Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#routing-parameters)
    - [`default_url_options`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#default-url-options)
    - [Strong Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#strong-parameters)
05. [Session](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#session)    - [Accessing the Session](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#accessing-the-session)
    - [The Flash](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#the-flash)
06. [Cookies](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#cookies)
07. [Rendering XML and JSON data](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#rendering-xml-and-json-data)
08. [Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#filters)    - [After Filters and Around Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#after-filters-and-around-filters)
    - [Other Ways to Use Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#other-ways-to-use-filters)
09. [Request Forgery Protection](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#request-forgery-protection)
10. [The Request and Response Objects](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#the-request-and-response-objects)    - [The `request` Object](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#the-request-object)
    - [The `response` Object](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#the-response-object)
11. [HTTP Authentications](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#http-authentications)    - [HTTP Basic Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#http-basic-authentication)
    - [HTTP Digest Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#http-digest-authentication)
    - [HTTP Token Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#http-token-authentication)
12. [Streaming and File Downloads](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#streaming-and-file-downloads)    - [Sending Files](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#sending-files)
    - [RESTful Downloads](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#restful-downloads)
    - [Live Streaming of Arbitrary Data](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#live-streaming-of-arbitrary-data)
13. [Log Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#log-filtering)    - [Parameters Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#parameters-filtering)
    - [Redirects Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#redirects-filtering)
14. [Rescue](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#rescue)    - [The Default 500 and 404 Templates](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#the-default-500-and-404-templates)
    - [`rescue_from`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#rescue-from)
15. [Force HTTPS protocol](https://guides.rubyonrails.org/v6.1/action_controller_overview.html#force-https-protocol)

### [1 What Does a Controller Do?](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#what-does-a-controller-do-questionmark)
...
For more details on the routing process, see [Rails Routing from the Outside In](https://guides.rubyonrails.org/v6.1/routing.html).

### [2 Controller Naming Convention](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#controller-naming-convention)
...
### [3 Methods and Actions](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#methods-and-actions)
...
The [Layouts and Rendering Guide](https://guides.rubyonrails.org/v6.1/layouts_and_rendering.html) explains this in more detail.

`ApplicationController` inherits from [`ActionController::Base`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Base.html), which defines a number of helpful methods. This guide will cover some of these, but if you're curious to see what's in there, you can see all of them in the [API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController.html) or in the source itself.

Only public methods are callable as actions. It is a best practice to lower the visibility of methods (with `private` or `protected`) which are not intended to be actions, like auxiliary methods or filters.

### [4 Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#parameters)

You will probably want to access data sent in by the user or other parameters in your controller actions. There are two kinds of parameters possible in a web application. The first are parameters that are sent as part of the URL, called query string parameters. The query string is everything after "?" in the URL. The second type of parameter is usually referred to as POST data. This information usually comes from an HTML form which has been filled in by the user. It's called POST data because it can only be sent as part of an HTTP POST request. Rails does not make any distinction between query string parameters and POST parameters, and both are available in the [`params`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/StrongParameters.html#method-i-params) hash in your controller:
...
#### [4.1 Hash and Array Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#hash-and-array-parameters)
...
Values such as `[nil]` or `[nil, nil, ...]` in `params` are replaced
with `[]` for security reasons by default. See [Security Guide](https://guides.rubyonrails.org/v6.1/security.html#unsafe-query-generation)
...
#### [4.2 JSON parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#json-parameters)
...
You can customize the name of the key or specific parameters you want to wrap by consulting the [API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/ParamsWrapper.html)

Support for parsing XML parameters has been extracted into a gem named `actionpack-xml_parser`.

#### [4.3 Routing Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#routing-parameters)

The `params` hash will always contain the `:controller` and `:action` keys, but you should use the methods [`controller_name`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Metal.html#method-i-controller_name) and [`action_name`](https://api.rubyonrails.org/v6.1.7.10/classes/AbstractController/Base.html#method-i-action_name) instead to access these values. Any other parameters defined by the routing, such as `:id`, will also be available. As an example, consider a listing of clients where the list can show either active or inactive clients. We can add a route which captures the `:status` parameter in a "pretty" URL:
...
#### [4.4 `default_url_options`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#default-url-options)
...
#### [4.5 Strong Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#strong-parameters)
...
##### [4.5.1 Permitted Scalar Values](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#permitted-scalar-values)

Calling [`permit`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Parameters.html#method-i-permit) like:
...
To permit an entire hash of parameters, the [`permit!`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Parameters.html#method-i-permit-21) method can be
used:
...
##### [4.5.2 Nested Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#nested-parameters)
...
##### [4.5.3 More Examples](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#more-examples)

You may want to also use the permitted attributes in your `new`
action. This raises the problem that you can't use [`require`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Parameters.html#method-i-require) on the
...
##### [4.5.4 Outside the Scope of Strong Parameters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#outside-the-scope-of-strong-parameters)
...
### [5 Session](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#session)

Your application has a session for each user in which you can store small amounts of data that will be persisted between requests. The session is only available in the controller and the view and can use one of a number of different storage mechanisms:

- [`ActionDispatch::Session::CookieStore`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Session/CookieStore.html) \- Stores everything on the client.
- [`ActionDispatch::Session::CacheStore`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Session/CacheStore.html) \- Stores the data in the Rails cache.
...
- [`ActionDispatch::Session::MemCacheStore`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Session/MemCacheStore.html) \- Stores the data in a memcached cluster (this is a legacy implementation; consider using CacheStore instead).
...
Read more about session storage in the [Security Guide](https://guides.rubyonrails.org/v6.1/security.html).
...
#### [5.1 Accessing the Session](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#accessing-the-session)
...
To reset the entire session, use [`reset_session`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Metal.html#method-i-reset_session).

#### [5.2 The Flash](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#the-flash)

The flash is a special part of the session which is cleared with each request. This means that values stored there will only be available in the next request, which is useful for passing error messages, etc.

The flash is accessed via the [`flash`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Flash/RequestMethods.html#method-i-flash) method. Like the session, the flash is represented as a hash.
...
If you want a flash value to be carried over to another request, use [`flash.keep`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Flash/FlashHash.html#method-i-keep):
...
##### [5.2.1 `flash.now`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#flash-now)

By default, adding values to the flash will make them available to the next request, but sometimes you may want to access those values in the same request. For example, if the `create` action fails to save a resource and you render the `new` template directly, that's not going to result in a new request, but you may still want to display a message using the flash. To do this, you can use [`flash.now`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Flash/FlashHash.html#method-i-now) in the same way you use the normal `flash`:
...
Refer to the [API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Cookies.html)
for more details.
...
### [7 Rendering XML and JSON data](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#rendering-xml-and-json-data)
...
### [8 Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#filters)
...
#### [8.1 After Filters and Around Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#after-filters-and-around-filters)
...
"around" filters are registered via [`around_action`](https://api.rubyonrails.org/v6.1.7.10/classes/AbstractController/Callbacks/ClassMethods.html#method-i-around_action). They are responsible for running their associated actions by yielding, similar to how Rack middlewares work.
...
#### [8.2 Other Ways to Use Filters](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#other-ways-to-use-filters)
...
### [9 Request Forgery Protection](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#request-forgery-protection)
...
The [Security Guide](https://guides.rubyonrails.org/v6.1/security.html) has more about this and a lot of other security-related issues that you should be aware of when developing a web application.

### [10 The Request and Response Objects](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#the-request-and-response-objects)

In every controller there are two accessor methods pointing to the request and the response objects associated with the request cycle that is currently in execution. The [`request`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Base.html#method-i-request) method contains an instance of [`ActionDispatch::Request`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Request.html) and the [`response`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Base.html#method-i-response) method returns a response object representing what is going to be sent back to the client.

#### [10.1 The `request` Object](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#the-request-object)

The request object contains a lot of useful information about the request coming in from the client. To get a full list of the available methods, refer to the [Rails API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Request.html) and [Rack Documentation](https://www.rubydoc.info/github/rack/rack/Rack/Request). Among the properties that you can access on this object are:
...
##### [10.1.1 `path_parameters`, `query_parameters`, and `request_parameters`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#path-parameters-query-parameters-and-request-parameters)

Rails collects all of the parameters sent along with the request in the `params` hash, whether they are sent as part of the query string or the post body. The request object has three accessors that give you access to these parameters depending on where they came from. The [`query_parameters`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Request.html#method-i-query_parameters) hash contains parameters that were sent as part of the query string while the [`request_parameters`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Request.html#method-i-request_parameters) hash contains parameters sent as part of the post body. The [`path_parameters`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Http/Parameters.html#method-i-path_parameters) hash contains parameters that were recognized by the routing as being part of the path leading to this particular controller and action.

#### [10.2 The `response` Object](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#the-response-object)

The response object is not usually used directly, but is built up during the execution of the action and rendering of the data that is being sent back to the user, but sometimes - like in an after filter - it can be useful to access the response directly. Some of these accessor methods also have setters, allowing you to change their values. To get a full list of the available methods, refer to the [Rails API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Response.html) and [Rack Documentation](https://www.rubydoc.info/github/rack/rack/Rack/Response).
...
##### [10.2.1 Setting Custom Headers](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#setting-custom-headers)
...
### [11 HTTP Authentications](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#http-authentications)
...
#### [11.1 HTTP Basic Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#http-basic-authentication)

HTTP basic authentication is an authentication scheme that is supported by the majority of browsers and other HTTP clients. As an example, consider an administration section which will only be available by entering a username and a password into the browser's HTTP basic dialog window. Using the built-in authentication is quite easy and only requires you to use one method, [`http_basic_authenticate_with`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/HttpAuthentication/Basic/ControllerMethods/ClassMethods.html#method-i-http_basic_authenticate_with).
...
#### [11.2 HTTP Digest Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#http-digest-authentication)

HTTP digest authentication is superior to the basic authentication as it does not require the client to send an unencrypted password over the network (though HTTP basic authentication is safe over HTTPS). Using digest authentication with Rails is quite easy and only requires using one method, [`authenticate_or_request_with_http_digest`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/HttpAuthentication/Digest/ControllerMethods.html#method-i-authenticate_or_request_with_http_digest).
...
#### [11.3 HTTP Token Authentication](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#http-token-authentication)
...
### [12 Streaming and File Downloads](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#streaming-and-file-downloads)

Sometimes you may want to send a file to the user instead of rendering an HTML page. All controllers in Rails have the [`send_data`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/DataStreaming.html#method-i-send_data) and the [`send_file`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/DataStreaming.html#method-i-send_file) methods, which will both stream data to the client. `send_file` is a convenience method that lets you provide the name of a file on the disk and it will stream the contents of that file for you.
...
#### [12.1 Sending Files](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#sending-files)
...
#### [12.2 RESTful Downloads](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#restful-downloads)
...
#### [12.3 Live Streaming of Arbitrary Data](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#live-streaming-of-arbitrary-data)

Rails allows you to stream more than just files. In fact, you can stream anything
you would like in a response object. The [`ActionController::Live`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/Live.html) module allows
you to create a persistent connection with a browser. Using this module, you will
be able to send arbitrary data to the browser at specific points in time.

##### [12.3.1 Incorporating Live Streaming](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#incorporating-live-streaming)
...
##### [12.3.2 Example Usage](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#example-usage)
...
##### [12.3.3 Streaming Considerations](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#streaming-considerations)
...
### [13 Log Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#log-filtering)
...
#### [13.1 Parameters Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#parameters-filtering)
...
#### [13.2 Redirects Filtering](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#redirects-filtering)
...
### [14 Rescue](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#rescue)
...
#### [14.1 The Default 500 and 404 Templates](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#the-default-500-and-404-templates)
...
#### [14.2 `rescue_from`](https://guides.rubyonrails.org/v6.1/action_controller_overview.html\#rescue-from)

If you want to do something a bit more elaborate when catching errors, you can use [`rescue_from`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Rescuable/ClassMethods.html#method-i-rescue_from), which handles exceptions of a certain type (or multiple types) in an entire controller and its subclasses.
...
via HTTPS, you should do so by enabling the [`ActionDispatch::SSL`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/SSL.html) middleware via
