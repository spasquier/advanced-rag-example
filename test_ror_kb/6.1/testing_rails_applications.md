...
01. [Why Write Tests for your Rails Applications?](https://guides.rubyonrails.org/v6.1/testing.html#why-write-tests-for-your-rails-applications-questionmark)
02. [Introduction to Testing](https://guides.rubyonrails.org/v6.1/testing.html#introduction-to-testing)    - [Rails Sets up for Testing from the Word Go](https://guides.rubyonrails.org/v6.1/testing.html#rails-sets-up-for-testing-from-the-word-go)
    - [The Test Environment](https://guides.rubyonrails.org/v6.1/testing.html#the-test-environment)
    - [Rails meets Minitest](https://guides.rubyonrails.org/v6.1/testing.html#rails-meets-minitest)
    - [Available Assertions](https://guides.rubyonrails.org/v6.1/testing.html#available-assertions)
    - [Rails Specific Assertions](https://guides.rubyonrails.org/v6.1/testing.html#rails-specific-assertions)
    - [A Brief Note About Test Cases](https://guides.rubyonrails.org/v6.1/testing.html#a-brief-note-about-test-cases)
    - [The Rails Test Runner](https://guides.rubyonrails.org/v6.1/testing.html#the-rails-test-runner)
03. [Parallel Testing](https://guides.rubyonrails.org/v6.1/testing.html#parallel-testing)    - [Parallel Testing with Processes](https://guides.rubyonrails.org/v6.1/testing.html#parallel-testing-with-processes)
    - [Parallel Testing with Threads](https://guides.rubyonrails.org/v6.1/testing.html#parallel-testing-with-threads)
    - [Testing Parallel Transactions](https://guides.rubyonrails.org/v6.1/testing.html#testing-parallel-transactions)
04. [The Test Database](https://guides.rubyonrails.org/v6.1/testing.html#the-test-database)    - [Maintaining the test database schema](https://guides.rubyonrails.org/v6.1/testing.html#maintaining-the-test-database-schema)
    - [The Low-Down on Fixtures](https://guides.rubyonrails.org/v6.1/testing.html#the-low-down-on-fixtures)
05. [Model Testing](https://guides.rubyonrails.org/v6.1/testing.html#model-testing)
06. [System Testing](https://guides.rubyonrails.org/v6.1/testing.html#system-testing)    - [Changing the default settings](https://guides.rubyonrails.org/v6.1/testing.html#changing-the-default-settings)
    - [Screenshot Helper](https://guides.rubyonrails.org/v6.1/testing.html#screenshot-helper)
    - [Implementing a System Test](https://guides.rubyonrails.org/v6.1/testing.html#implementing-a-system-test)
07. [Integration Testing](https://guides.rubyonrails.org/v6.1/testing.html#integration-testing)    - [Helpers Available for Integration Tests](https://guides.rubyonrails.org/v6.1/testing.html#helpers-available-for-integration-tests)
    - [Implementing an integration test](https://guides.rubyonrails.org/v6.1/testing.html#implementing-an-integration-test)
08. [Functional Tests for Your Controllers](https://guides.rubyonrails.org/v6.1/testing.html#functional-tests-for-your-controllers)    - [What to include in your Functional Tests](https://guides.rubyonrails.org/v6.1/testing.html#what-to-include-in-your-functional-tests)
    - [Available Request Types for Functional Tests](https://guides.rubyonrails.org/v6.1/testing.html#available-request-types-for-functional-tests)
    - [Testing XHR (AJAX) requests](https://guides.rubyonrails.org/v6.1/testing.html#testing-xhr-ajax-requests)
    - [The Three Hashes of the Apocalypse](https://guides.rubyonrails.org/v6.1/testing.html#the-three-hashes-of-the-apocalypse)
    - [Instance Variables Available](https://guides.rubyonrails.org/v6.1/testing.html#instance-variables-available)
    - [Setting Headers and CGI variables](https://guides.rubyonrails.org/v6.1/testing.html#setting-headers-and-cgi-variables)
    - [Testing `flash` notices](https://guides.rubyonrails.org/v6.1/testing.html#testing-flash-notices)
    - [Putting it together](https://guides.rubyonrails.org/v6.1/testing.html#putting-it-together)
    - [Test helpers](https://guides.rubyonrails.org/v6.1/testing.html#test-helpers)
09. [Testing Routes](https://guides.rubyonrails.org/v6.1/testing.html#testing-routes)
10. [Testing Views](https://guides.rubyonrails.org/v6.1/testing.html#testing-views)
11. [Testing Helpers](https://guides.rubyonrails.org/v6.1/testing.html#testing-helpers)
12. [Testing Your Mailers](https://guides.rubyonrails.org/v6.1/testing.html#testing-your-mailers)    - [Keeping the Postman in Check](https://guides.rubyonrails.org/v6.1/testing.html#keeping-the-postman-in-check)
    - [Unit Testing](https://guides.rubyonrails.org/v6.1/testing.html#unit-testing)
    - [Functional and System Testing](https://guides.rubyonrails.org/v6.1/testing.html#functional-and-system-testing)
13. [Testing Jobs](https://guides.rubyonrails.org/v6.1/testing.html#testing-jobs)    - [A Basic Test Case](https://guides.rubyonrails.org/v6.1/testing.html#a-basic-test-case)
    - [Custom Assertions and Testing Jobs inside Other Components](https://guides.rubyonrails.org/v6.1/testing.html#custom-assertions-and-testing-jobs-inside-other-components)
14. [Testing Action Cable](https://guides.rubyonrails.org/v6.1/testing.html#testing-action-cable)    - [Connection Test Case](https://guides.rubyonrails.org/v6.1/testing.html#connection-test-case)
    - [Channel Test Case](https://guides.rubyonrails.org/v6.1/testing.html#channel-test-case)
    - [Custom Assertions And Testing Broadcasts Inside Other Components](https://guides.rubyonrails.org/v6.1/testing.html#custom-assertions-and-testing-broadcasts-inside-other-components)
15. [Additional Testing Resources](https://guides.rubyonrails.org/v6.1/testing.html#additional-testing-resources)    - [Testing Time-Dependent Code](https://guides.rubyonrails.org/v6.1/testing.html#testing-time-dependent-code)

### [1 Why Write Tests for your Rails Applications?](https://guides.rubyonrails.org/v6.1/testing.html\#why-write-tests-for-your-rails-applications-questionmark)
...
### [2 Introduction to Testing](https://guides.rubyonrails.org/v6.1/testing.html\#introduction-to-testing)
...
#### [2.1 Rails Sets up for Testing from the Word Go](https://guides.rubyonrails.org/v6.1/testing.html\#rails-sets-up-for-testing-from-the-word-go)

Rails creates a `test` directory for you as soon as you create a Rails project using `rails new` _application\_name_. If you list the contents of this directory then you shall see:
...
#### [2.2 The Test Environment](https://guides.rubyonrails.org/v6.1/testing.html\#the-test-environment)
...
#### [2.3 Rails meets Minitest](https://guides.rubyonrails.org/v6.1/testing.html\#rails-meets-minitest)

If you remember, we used the `bin/rails generate model` command in the
[Getting Started with Rails](https://guides.rubyonrails.org/v6.1/getting_started.html) guide. We created our first
...
##### [2.3.1 Your first failing test](https://guides.rubyonrails.org/v6.1/testing.html\#your-first-failing-test)
...
##### [2.3.2 What an Error Looks Like](https://guides.rubyonrails.org/v6.1/testing.html\#what-an-error-looks-like)
...
[`config.active_support.test_order` option](https://guides.rubyonrails.org/v6.1/configuring.html#configuring-active-support)
...
#### [2.4 Available Assertions](https://guides.rubyonrails.org/v6.1/testing.html\#available-assertions)
...
#### [2.5 Rails Specific Assertions](https://guides.rubyonrails.org/v6.1/testing.html\#rails-specific-assertions)

Rails adds some custom assertions of its own to the `minitest` framework:

| Assertion | Purpose |
| --- | --- |
| [`assert_difference(expressions, difference = 1, message = nil) {...}`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/Assertions.html#method-i-assert_difference) | Test numeric difference between the return value of an expression as a result of what is evaluated in the yielded block. |
| [`assert_no_difference(expressions, message = nil, &block)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/Assertions.html#method-i-assert_no_difference) | Asserts that the numeric result of evaluating an expression is not changed before and after invoking the passed in block. |
| [`assert_changes(expressions, message = nil, from:, to:, &block)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/Assertions.html#method-i-assert_changes) | Test that the result of evaluating an expression is changed after invoking the passed in block. |
| [`assert_no_changes(expressions, message = nil, &block)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/Assertions.html#method-i-assert_no_changes) | Test the result of evaluating an expression is not changed after invoking the passed in block. |
| [`assert_nothing_raised { block }`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/Assertions.html#method-i-assert_nothing_raised) | Ensures that the given block doesn't raise any exceptions. |
| [`assert_recognizes(expected_options, path, extras={}, message=nil)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Assertions/RoutingAssertions.html#method-i-assert_recognizes) | Asserts that the routing of the given path was handled correctly and that the parsed options (given in the expected\_options hash) match path. Basically, it asserts that Rails recognizes the route given by expected\_options. |
| [`assert_generates(expected_path, options, defaults={}, extras = {}, message=nil)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Assertions/RoutingAssertions.html#method-i-assert_generates) | Asserts that the provided options can be used to generate the provided path. This is the inverse of assert\_recognizes. The extras parameter is used to tell the request the names and values of additional request parameters that would be in a query string. The message parameter allows you to specify a custom error message for assertion failures. |
| [`assert_response(type, message = nil)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Assertions/ResponseAssertions.html#method-i-assert_response) | Asserts that the response comes with a specific status code. You can specify `:success` to indicate 200-299, `:redirect` to indicate 300-399, `:missing` to indicate 404, or `:error` to match the 500-599 range. You can also pass an explicit status number or its symbolic equivalent. For more information, see [full list of status codes](http://rubydoc.info/github/rack/rack/master/Rack/Utils#HTTP_STATUS_CODES-constant) and how their [mapping](https://rubydoc.info/github/rack/rack/master/Rack/Utils#SYMBOL_TO_STATUS_CODE-constant) works. |
| [`assert_redirected_to(options = {}, message=nil)`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Assertions/ResponseAssertions.html#method-i-assert_redirected_to) | Asserts that the response is a redirect to a URL matching the given options. You can also pass named routes such as `assert_redirected_to root_path` and Active Record objects such as `assert_redirected_to @article`. |

You'll see the usage of some of these assertions in the next chapter.

#### [2.6 A Brief Note About Test Cases](https://guides.rubyonrails.org/v6.1/testing.html\#a-brief-note-about-test-cases)

All the basic assertions such as `assert_equal` defined in `Minitest::Assertions` are also available in the classes we use in our own test cases. In fact, Rails provides the following classes for you to inherit from:

- [`ActiveSupport::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/TestCase.html)
- [`ActionMailer::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionMailer/TestCase.html)
- [`ActionView::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionView/TestCase.html)
- [`ActiveJob::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveJob/TestCase.html)
- [`ActionDispatch::IntegrationTest`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/IntegrationTest.html)
- [`ActionDispatch::SystemTestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/SystemTestCase.html)
- [`Rails::Generators::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/Rails/Generators/TestCase.html)

Each of these classes include `Minitest::Assertions`, allowing us to use all of the basic assertions in our tests.

For more information on `Minitest`, refer to [its\\
documentation](http://docs.seattlerb.org/minitest).

#### [2.7 The Rails Test Runner](https://guides.rubyonrails.org/v6.1/testing.html\#the-rails-test-runner)
...
### [3 Parallel Testing](https://guides.rubyonrails.org/v6.1/testing.html\#parallel-testing)
...
#### [3.1 Parallel Testing with Processes](https://guides.rubyonrails.org/v6.1/testing.html\#parallel-testing-with-processes)
...
#### [3.2 Parallel Testing with Threads](https://guides.rubyonrails.org/v6.1/testing.html\#parallel-testing-with-threads)
...
#### [3.3 Testing Parallel Transactions](https://guides.rubyonrails.org/v6.1/testing.html\#testing-parallel-transactions)
...
### [4 The Test Database](https://guides.rubyonrails.org/v6.1/testing.html\#the-test-database)
...
#### [4.1 Maintaining the test database schema](https://guides.rubyonrails.org/v6.1/testing.html\#maintaining-the-test-database-schema)
...
If there were modifications to existing migrations, the test database needs to
be rebuilt. This can be done by executing `bin/rails db:test:prepare`.

#### [4.2 The Low-Down on Fixtures](https://guides.rubyonrails.org/v6.1/testing.html\#the-low-down-on-fixtures)

For good tests, you'll need to give some thought to setting up test data.
In Rails, you can handle this by defining and customizing fixtures.
You can find comprehensive documentation in the [Fixtures API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveRecord/FixtureSet.html).

##### [4.2.1 What are Fixtures?](https://guides.rubyonrails.org/v6.1/testing.html\#what-are-fixtures-questionmark)
...
##### [4.2.2 YAML](https://guides.rubyonrails.org/v6.1/testing.html\#yaml)
...
If you are working with [associations](https://guides.rubyonrails.org/association_basics.html), you can
...
For associations to reference one another by name, you can use the fixture name instead of specifying the `id:` attribute on the associated fixtures. Rails will auto assign a primary key to be consistent between runs. For more information on this association behavior please read the [Fixtures API documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveRecord/FixtureSet.html).

##### [4.2.3 ERB'in It Up](https://guides.rubyonrails.org/v6.1/testing.html\#erb-in-it-up)
...
##### [4.2.4 Fixtures in Action](https://guides.rubyonrails.org/v6.1/testing.html\#fixtures-in-action)
...
##### [4.2.5 Fixtures are Active Record objects](https://guides.rubyonrails.org/v6.1/testing.html\#fixtures-are-active-record-objects)
...
### [5 Model Testing](https://guides.rubyonrails.org/v6.1/testing.html\#model-testing)
...
Model tests don't have their own superclass like `ActionMailer::TestCase`. Instead, they inherit from [`ActiveSupport::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/TestCase.html).

### [6 System Testing](https://guides.rubyonrails.org/v6.1/testing.html\#system-testing)
...
#### [6.1 Changing the default settings](https://guides.rubyonrails.org/v6.1/testing.html\#changing-the-default-settings)
...
#### [6.2 Screenshot Helper](https://guides.rubyonrails.org/v6.1/testing.html\#screenshot-helper)
...
#### [6.3 Implementing a System Test](https://guides.rubyonrails.org/v6.1/testing.html\#implementing-a-system-test)
...
By default, running `bin/rails test` won't run your system tests.
...
##### [6.3.1 Creating Articles System Test](https://guides.rubyonrails.org/v6.1/testing.html\#creating-articles-system-test)
...
##### [6.3.2 Testing for multiple screen sizes](https://guides.rubyonrails.org/v6.1/testing.html\#testing-for-multiple-screen-sizes)
...
##### [6.3.3 Taking it further](https://guides.rubyonrails.org/v6.1/testing.html\#implementing-a-system-test-taking-it-further)
...
### [7 Integration Testing](https://guides.rubyonrails.org/v6.1/testing.html\#integration-testing)
...
#### [7.1 Helpers Available for Integration Tests](https://guides.rubyonrails.org/v6.1/testing.html\#helpers-available-for-integration-tests)
...
For dealing with the integration test runner, see [`ActionDispatch::Integration::Runner`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Integration/Runner.html).

When performing requests, we will have [`ActionDispatch::Integration::RequestHelpers`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Integration/RequestHelpers.html) available for our use.

If we need to modify the session, or state of our integration test, take a look at [`ActionDispatch::Integration::Session`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Integration/Session.html) to help.

#### [7.2 Implementing an integration test](https://guides.rubyonrails.org/v6.1/testing.html\#implementing-an-integration-test)
...
##### [7.2.1 Creating articles integration](https://guides.rubyonrails.org/v6.1/testing.html\#creating-articles-integration)
...
##### [7.2.2 Taking it further](https://guides.rubyonrails.org/v6.1/testing.html\#implementing-an-integration-test-taking-it-further)

We were able to successfully test a very small workflow for visiting our blog and creating a new article. If we wanted to take this further we could add tests for commenting, removing articles, or editing comments. Integration tests are a great place to experiment with all kinds of use cases for our applications.

### [8 Functional Tests for Your Controllers](https://guides.rubyonrails.org/v6.1/testing.html\#functional-tests-for-your-controllers)
...
#### [8.1 What to include in your Functional Tests](https://guides.rubyonrails.org/v6.1/testing.html\#what-to-include-in-your-functional-tests)
...
If you followed the steps in the [Basic Authentication](https://guides.rubyonrails.org/v6.1/getting_started.html#basic-authentication) section, you'll need to add authorization to every request header to get all the tests passing:
...
#### [8.2 Available Request Types for Functional Tests](https://guides.rubyonrails.org/v6.1/testing.html\#available-request-types-for-functional-tests)
...
#### [8.3 Testing XHR (AJAX) requests](https://guides.rubyonrails.org/v6.1/testing.html\#testing-xhr-ajax-requests)
...
#### [8.4 The Three Hashes of the Apocalypse](https://guides.rubyonrails.org/v6.1/testing.html\#the-three-hashes-of-the-apocalypse)
...
#### [8.5 Instance Variables Available](https://guides.rubyonrails.org/v6.1/testing.html\#instance-variables-available)
...
#### [8.6 Setting Headers and CGI variables](https://guides.rubyonrails.org/v6.1/testing.html\#setting-headers-and-cgi-variables)
...
#### [8.7 Testing `flash` notices](https://guides.rubyonrails.org/v6.1/testing.html\#testing-flash-notices)
...
#### [8.8 Putting it together](https://guides.rubyonrails.org/v6.1/testing.html\#putting-it-together)
...
#### [8.9 Test helpers](https://guides.rubyonrails.org/v6.1/testing.html\#test-helpers)
...
##### [8.9.1 Using Separate Files](https://guides.rubyonrails.org/v6.1/testing.html\#using-separate-files)
...
##### [8.9.2 Eagerly Requiring Helpers](https://guides.rubyonrails.org/v6.1/testing.html\#eagerly-requiring-helpers)
...
### [9 Testing Routes](https://guides.rubyonrails.org/v6.1/testing.html\#testing-routes)
...
For more information on routing assertions available in Rails, see the API documentation for [`ActionDispatch::Assertions::RoutingAssertions`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionDispatch/Assertions/RoutingAssertions.html).
...
##### [10.1 Additional View-Based Assertions](https://guides.rubyonrails.org/v6.1/testing.html\#additional-view-based-assertions)
...
### [12 Testing Your Mailers](https://guides.rubyonrails.org/v6.1/testing.html\#testing-your-mailers)

Testing mailer classes requires some specific tools to do a thorough job.

#### [12.1 Keeping the Postman in Check](https://guides.rubyonrails.org/v6.1/testing.html\#keeping-the-postman-in-check)
...
##### [12.1.1 From All Sides](https://guides.rubyonrails.org/v6.1/testing.html\#from-all-sides)

There are two aspects of testing your mailer, the unit tests and the functional tests. In the unit tests, you run the mailer in isolation with tightly controlled inputs and compare the output to a known value (a fixture). In the functional tests you don't so much test the minute details produced by the mailer; instead, we test that our controllers and models are using the mailer in the right way. You test to prove that the right email was sent at the right time.

#### [12.2 Unit Testing](https://guides.rubyonrails.org/v6.1/testing.html\#unit-testing)

In order to test that your mailer is working as expected, you can use unit tests to compare the actual results of the mailer with pre-written examples of what should be produced.

##### [12.2.1 Revenge of the Fixtures](https://guides.rubyonrails.org/v6.1/testing.html\#revenge-of-the-fixtures)
...
##### [12.2.2 The Basic Test Case](https://guides.rubyonrails.org/v6.1/testing.html\#the-basic-test-case)
...
`email.body.to_s` is present when there's only one (HTML or text) part present.
...
#### [12.3 Functional and System Testing](https://guides.rubyonrails.org/v6.1/testing.html\#functional-and-system-testing)
...
The `assert_emails` method is not tied to a particular deliver method and will work with emails delivered with either the `deliver_now` or `deliver_later` method. If we explicitly want to assert that the email has been enqueued we can use the `assert_enqueued_emails` method. More information can be found in the [documentation here](https://api.rubyonrails.org/v6.1.7.10/classes/ActionMailer/TestHelper.html).

### [13 Testing Jobs](https://guides.rubyonrails.org/v6.1/testing.html\#testing-jobs)

Since your custom jobs can be queued at different levels inside your application,
you'll need to test both the jobs themselves (their behavior when they get enqueued)
and that other entities correctly enqueue them.

#### [13.1 A Basic Test Case](https://guides.rubyonrails.org/v6.1/testing.html\#a-basic-test-case)
...
#### [13.2 Custom Assertions and Testing Jobs inside Other Components](https://guides.rubyonrails.org/v6.1/testing.html\#custom-assertions-and-testing-jobs-inside-other-components)

Active Job ships with a bunch of custom assertions that can be used to lessen the verbosity of tests. For a full list of available assertions, see the API documentation for [`ActiveJob::TestHelper`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveJob/TestHelper.html).
...
### [14 Testing Action Cable](https://guides.rubyonrails.org/v6.1/testing.html\#testing-action-cable)
...
#### [14.1 Connection Test Case](https://guides.rubyonrails.org/v6.1/testing.html\#connection-test-case)
...
See the API documentation for [`ActionCable::Connection::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionCable/Connection/TestCase.html) for more information.

#### [14.2 Channel Test Case](https://guides.rubyonrails.org/v6.1/testing.html\#channel-test-case)
...
See the API documentation for [`ActionCable::Channel::TestCase`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionCable/Channel/TestCase.html) for more information.

#### [14.3 Custom Assertions And Testing Broadcasts Inside Other Components](https://guides.rubyonrails.org/v6.1/testing.html\#custom-assertions-and-testing-broadcasts-inside-other-components)

Action Cable ships with a bunch of custom assertions that can be used to lessen the verbosity of tests. For a full list of available assertions, see the API documentation for [`ActionCable::TestHelper`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionCable/TestHelper.html).
...
### [15 Additional Testing Resources](https://guides.rubyonrails.org/v6.1/testing.html\#additional-testing-resources)

#### [15.1 Testing Time-Dependent Code](https://guides.rubyonrails.org/v6.1/testing.html\#testing-time-dependent-code)

Rails provides built-in helper methods that enable you to assert that your time-sensitive code works as expected.

Here is an example using the [`travel_to`](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/TimeHelpers.html#method-i-travel_to) helper:
...
Please see [`ActiveSupport::Testing::TimeHelpers` API Documentation](https://api.rubyonrails.org/v6.1.7.10/classes/ActiveSupport/Testing/TimeHelpers.html)
