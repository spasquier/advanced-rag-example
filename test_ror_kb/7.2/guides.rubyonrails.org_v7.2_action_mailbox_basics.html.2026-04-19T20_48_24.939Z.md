...
1. [What is Action Mailbox?](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#what-is-action-mailbox-questionmark)
2. [Setup](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#setup)
3. [Ingress Configuration](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#ingress-configuration)
   - [Exim](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#exim)
   - [Mailgun](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#mailgun)
   - [Mandrill](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#mandrill)
   - [Postfix](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#postfix)
   - [Postmark](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#postmark)
   - [Qmail](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#qmail)
   - [SendGrid](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#sendgrid)
4. [Processing Incoming Email](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#processing-incoming-email)
   - [Configure Routing](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#configure-routing)
   - [Create a Mailbox](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#create-a-mailbox)
   - [Process Email](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#process-email)
   - [Inbound Email Status](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#inbound-email-status)
5. [Example](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#example)
6. [Local Development and Testing](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#local-development-and-testing)
7. [Incineration of InboundEmails](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#incineration-of-inboundemails)
...
while [Action Mailer](https://guides.rubyonrails.org/v7.2/action_mailer_basics.html) is for _sending_ them.

The inbound emails are routed asynchronously using [Active\\
Job](https://guides.rubyonrails.org/v7.2/active_job_basics.html) to one or several dedicated mailboxes. These emails
are turned into
[`InboundEmail`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionMailbox/InboundEmail.html)
records using [Active Record](https://guides.rubyonrails.org/v7.2/active_record_basics.html), which are capable of
...
email via [Active Storage](https://guides.rubyonrails.org/v7.2/active_storage_overview.html), and responsible data
handling with on-by-default [incineration](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#incineration-of-inboundemails).
...
[Local Development and Testing](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#local-development-and-testing) for more.
...
### [3.1 Exim](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#exim)
...
### [3.2 Mailgun](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#mailgun)
...
### [3.3 Mandrill](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#mandrill)
...
### [3.4 Postfix](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#postfix)
...
### [3.5 Postmark](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#postmark)
...
### [3.6 Qmail](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#qmail)
...
### [3.7 SendGrid](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#sendgrid)
...
### [4.1 Configure Routing](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#configure-routing)
...
[Rails router](https://guides.rubyonrails.org/v7.2/routing.html) that dispatches URLs to controllers, routing in
...
[`ActionMailbox::Base`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionMailbox/Base.html)
for more.

We need to create that "forwards" mailbox next.

### [4.2 Create a Mailbox](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#create-a-mailbox)
...
### [4.3 Process Email](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#process-email)
...
### [4.4 Inbound Email Status](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html\#inbound-email-status)
...
[incineration](https://guides.rubyonrails.org/v7.2/action_mailbox_basics.html#incineration-of-inboundemails).
...
callbacks](https://api.rubyonrails.org/v7.2.3.1/classes/ActionMailbox/Callbacks.html) are
...
API](https://api.rubyonrails.org/v7.2.3.1/classes/ActionMailbox/TestHelper.html) for
...
[`IncinerationJob`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionMailbox/IncinerationJob.html)
that's scheduled to run after
[`config.action_mailbox.incinerate_after`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailbox-incinerate-after)
