...
01. [What is Action Cable?](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#what-is-action-cable-questionmark)
02. [Terminology](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#terminology)
    - [Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#terminology-connections)
    - [Consumers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#consumers)
    - [Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#terminology-channels)
    - [Subscribers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#subscribers)
    - [Pub/Sub](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#pub-sub)
    - [Broadcastings](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#terminology-broadcastings)
03. [Server-Side Components](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#server-side-components)
    - [Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#server-side-components-connections)
    - [Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#server-side-components-channels)
04. [Client-Side Components](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#client-side-components)
    - [Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#connections)
05. [Client-Server Interactions](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#client-server-interactions)
    - [Streams](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#streams)
    - [Broadcastings](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#client-server-interactions-broadcastings)
    - [Subscriptions](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#client-server-interactions-subscriptions)
    - [Passing Parameters to Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#passing-parameters-to-channels)
    - [Rebroadcasting a Message](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#rebroadcasting-a-message)
06. [Full-Stack Examples](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#full-stack-examples)
    - [Example 1: User Appearances](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#example-1-user-appearances)
    - [Example 2: Receiving New Web Notifications](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#example-2-receiving-new-web-notifications)
    - [More Complete Examples](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#more-complete-examples)
07. [Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#configuration)
    - [Subscription Adapter](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#subscription-adapter)
    - [Allowed Request Origins](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#allowed-request-origins)
    - [Consumer Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#consumer-configuration)
    - [Worker Pool Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#worker-pool-configuration)
    - [Client-side Logging](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#client-side-logging)
    - [Other Configurations](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#other-configurations)
08. [Running Standalone Cable Servers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#running-standalone-cable-servers)
    - [In App](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#in-app)
    - [Standalone](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#standalone)
    - [Notes](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#notes)
09. [Dependencies](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#dependencies)
10. [Deployment](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#deployment)
11. [Testing](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#testing)

* * *

## [1 What is Action Cable?](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#what-is-action-cable-questionmark)
...
## [2 Terminology](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#terminology)
...
### [2.1 Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#terminology-connections)
...
### [2.2 Consumers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#consumers)
...
### [2.3 Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#terminology-channels)
...
### [2.4 Subscribers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#subscribers)
...
### [2.5 Pub/Sub](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#pub-sub)
...
### [2.6 Broadcastings](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#terminology-broadcastings)
...
## [3 Server-Side Components](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components)

### [3.1 Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components-connections)
...
[`ActionCable::Connection::Base`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Base.html). In `ApplicationCable::Connection`, you
authorize the incoming connection and proceed to establish it if the user can
be identified.

#### [3.1.1 Connection Setup](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#connection-setup)
...
Here [`identified_by`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Identification/ClassMethods.html#method-i-identified_by) designates a connection identifier that can be used to find the
...
#### [3.1.2 Exception Handling](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components-connections-exception-handling)
...
example, you can do so with [`rescue_from`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Rescuable/ClassMethods.html#method-i-rescue_from):
...
#### [3.1.3 Connection Callbacks](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#connection-callbacks)

[`ActionCable::Connection::Callbacks`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Callbacks.html) provides callback hooks that are
invoked when sending commands to the client, such as when subscribing,
unsubscribing, or performing an action:

- [`before_command`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Callbacks/ClassMethods.html#method-i-before_command)
- [`after_command`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Callbacks/ClassMethods.html#method-i-after_command)
- [`around_command`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Connection/Callbacks/ClassMethods.html#method-i-around_command)

### [3.2 Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components-channels)
...
(which extends [`ActionCable::Channel::Base`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Base.html)) for encapsulating shared logic between your channels.

#### [3.2.1 Parent Channel Setup](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#parent-channel-setup)
...
#### [3.2.2 Subscriptions](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components-channels-subscriptions)
...
#### [3.2.3 Exception Handling](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#server-side-components-channels-exception-handling)

As with `ApplicationCable::Connection`, you can also use [`rescue_from`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Rescuable/ClassMethods.html#method-i-rescue_from) on a
...
#### [3.2.4 Channel Callbacks](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#channel-callbacks)

[`ActionCable::Channel::Callbacks`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks.html) provides callback hooks that are invoked
during the life cycle of a channel:

- [`before_subscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-before_subscribe)
- [`after_subscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-after_subscribe) (aliased as [`on_subscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-on_subscribe))
- [`before_unsubscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-before_unsubscribe)
- [`after_unsubscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-after_unsubscribe) (aliased as [`on_unsubscribe`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Callbacks/ClassMethods.html#method-i-on_unsubscribe))

## [4 Client-Side Components](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-side-components)

### [4.1 Connections](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#connections)
...
#### [4.1.1 Connect Consumer](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#connect-consumer)
...
#### [4.1.2 Subscriber](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#subscriber)
...
## [5 Client-Server Interactions](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-server-interactions)

### [5.1 Streams](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#streams)
...
[`stream_from`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Streams.html#method-i-stream_from) to subscribe to the broadcasting named `chat_Best Room` when
...
calling [`broadcast`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Server/Broadcasting.html#method-i-broadcast):
...
uses [`stream_for`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Streams.html#method-i-stream_for) to subscribe to a broadcasting like
...
You can then broadcast to this channel by calling [`broadcast_to`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Channel/Broadcasting/ClassMethods.html#method-i-broadcast_to):
...
### [5.2 Broadcastings](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-server-interactions-broadcastings)
...
### [5.3 Subscriptions](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-server-interactions-subscriptions)
...
### [5.4 Passing Parameters to Channels](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#passing-parameters-to-channels)
...
### [5.5 Rebroadcasting a Message](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#rebroadcasting-a-message)
...
## [6 Full-Stack Examples](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#full-stack-examples)

The following setup steps are common to both examples:

1. [Set up your connection](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#connection-setup).
2. [Set up your parent channel](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#parent-channel-setup).
3. [Connect your consumer](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#connect-consumer).

### [6.1 Example 1: User Appearances](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#example-1-user-appearances)
...
#### [6.1.1 Client-Server Interaction](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-server-interaction)
...
### [6.2 Example 2: Receiving New Web Notifications](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#example-2-receiving-new-web-notifications)
...
### [6.3 More Complete Examples](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#more-complete-examples)
...
## [7 Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#configuration)

Action Cable has two required configurations: a subscription adapter and allowed request origins.

### [7.1 Subscription Adapter](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#subscription-adapter)
...
[Dependencies](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#dependencies) section for additional information on adapters.
...
#### [7.1.1 Adapter Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#adapter-configuration)

Below is a list of the subscription adapters available for end-users.

##### [7.1.1.1 Async Adapter](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#async-adapter)

The async adapter is intended for development/testing and should not be used in production.

##### [7.1.1.2 Redis Adapter](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#redis-adapter)
...
##### [7.1.1.3 PostgreSQL Adapter](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#postgresql-adapter)
...
### [7.2 Allowed Request Origins](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#allowed-request-origins)
...
### [7.3 Consumer Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#consumer-configuration)

To configure the URL, add a call to [`action_cable_meta_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Helpers/ActionCableHelper.html#method-i-action_cable_meta_tag) in your HTML layout
HEAD. This uses a URL or path typically set via [`config.action_cable.url`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-cable-url) in the
environment configuration files.

### [7.4 Worker Pool Configuration](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#worker-pool-configuration)
...
### [7.5 Client-side Logging](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#client-side-logging)
...
### [7.6 Other Configurations](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#other-configurations)
...
## [8 Running Standalone Cable Servers](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#running-standalone-cable-servers)
...
### [8.1 In App](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#in-app)

Action Cable can run alongside your Rails application. For example, to
listen for WebSocket requests on `/websocket`, specify that path to
[`config.action_cable.mount_path`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-cable-mount-path):
...
server if [`action_cable_meta_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionCable/Helpers/ActionCableHelper.html#method-i-action_cable_meta_tag) is invoked in the layout. Otherwise, a path is
...
### [8.2 Standalone](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#standalone)
...
Finally, ensure you have [configured the consumer correctly](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#consumer-configuration).

### [8.3 Notes](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#notes)
...
## [9 Dependencies](https://guides.rubyonrails.org/v7.2/action_cable_overview.html\#dependencies)
...
[testing guide](https://guides.rubyonrails.org/v7.2/testing.html#testing-action-cable).
