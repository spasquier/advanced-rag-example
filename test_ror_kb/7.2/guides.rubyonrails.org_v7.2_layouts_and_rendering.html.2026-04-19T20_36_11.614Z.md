...
1. [Overview: How the Pieces Fit Together](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#overview-how-the-pieces-fit-together)
2. [Creating Responses](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#creating-responses)
   - [Rendering by Default: Convention Over Configuration in Action](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#rendering-by-default-convention-over-configuration-in-action)
   - [Using `render`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-render)
   - [Using `redirect_to`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-redirect-to)
   - [Using `head` to Build Header-Only Responses](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-head-to-build-header-only-responses)
3. [Structuring Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#structuring-layouts)
   - [Asset Tag Helpers](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#asset-tag-helpers)
   - [Understanding `yield`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#understanding-yield)
   - [Using the `content_for` Method](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-the-content-for-method)
   - [Using Partials](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-partials)
   - [Using Nested Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-nested-layouts)
...
- Call [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Rendering.html#method-i-render) to create a full response to send back to the browser
- Call [`redirect_to`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Redirecting.html#method-i-redirect_to) to send an HTTP redirect status code to the browser
- Call [`head`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Head.html#method-i-head) to create a response consisting solely of HTTP headers to send back to the browser

### [2.1 Rendering by Default: Convention Over Configuration in Action](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-by-default-convention-over-configuration-in-action)
...
The actual rendering is done by nested classes of the module [`ActionView::Template::Handlers`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Template/Handlers.html). This guide does not dig into that process, but it's important to know that the file extension on your view controls the choice of template handler.

### [2.2 Using `render`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-render)

In most cases, the controller's [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Rendering.html#method-i-render) method does the heavy lifting of rendering your application's content for use by a browser. There are a variety of ways to customize the behavior of `render`. You can render the default view for a Rails template, or a specific template, or a file, or inline code, or nothing at all. You can render text, JSON, or XML. You can specify the content type or HTTP status of the rendered response as well.
...
#### [2.2.1 Rendering an Action's View](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-an-action-s-view)
...
#### [2.2.2 Rendering an Action's Template from Another Controller](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-an-action-s-template-from-another-controller)
...
#### [2.2.3 Wrapping it up](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#wrapping-it-up)
...
#### [2.2.4 Using `render` with `:inline`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-render-with-inline)
...
#### [2.2.5 Rendering Text](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-text)
...
#### [2.2.6 Rendering HTML](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-html)
...
#### [2.2.7 Rendering JSON](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-json)
...
#### [2.2.8 Rendering XML](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-xml)
...
#### [2.2.9 Rendering Vanilla JavaScript](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-vanilla-javascript)
...
#### [2.2.10 Rendering Raw Body](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-raw-body)
...
#### [2.2.11 Rendering Raw File](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-raw-file)
...
#### [2.2.12 Rendering Objects](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-objects)
...
#### [2.2.13 Options for `render`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#options-for-render)

Calls to the [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Rendering.html#method-i-render) method generally accept six options:
...
##### [2.2.13.1 The `:content_type` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-content-type-option)
...
##### [2.2.13.2 The `:layout` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-layout-option)
...
##### [2.2.13.3 The `:location` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-location-option)
...
##### [2.2.13.4 The `:status` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-status-option)
...
##### [2.2.13.5 The `:formats` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-formats-option)
...
##### [2.2.13.6 The `:variants` Option](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-variants-option)
...
#### [2.2.14 Finding Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#finding-layouts)

To find the current layout, Rails first looks for a file in `app/views/layouts` with the same base name as the controller. For example, rendering actions from the `PhotosController` class will use `app/views/layouts/photos.html.erb` (or `app/views/layouts/photos.builder`). If there is no such controller-specific layout, Rails will use `app/views/layouts/application.html.erb` or `app/views/layouts/application.builder`. If there is no `.erb` layout, Rails will use a `.builder` layout if one exists. Rails also provides several ways to more precisely assign specific layouts to individual controllers and actions.

##### [2.2.14.1 Specifying Layouts for Controllers](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#specifying-layouts-for-controllers)

You can override the default layout conventions in your controllers by using the [`layout`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Layouts/ClassMethods.html#method-i-layout) declaration. For example:
...
##### [2.2.14.2 Choosing Layouts at Runtime](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#choosing-layouts-at-runtime)
...
##### [2.2.14.3 Conditional Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#conditional-layouts)
...
##### [2.2.14.4 Layout Inheritance](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#layout-inheritance)
...
##### [2.2.14.5 Template Inheritance](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#template-inheritance)
...
#### [2.2.15 Avoiding Double Render Errors](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#avoiding-double-render-errors)
...
### [2.3 Using `redirect_to`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-redirect-to)

Another way to handle returning responses to an HTTP request is with [`redirect_to`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Redirecting.html#method-i-redirect_to). As you've seen, `render` tells Rails which view (or other asset) to use in constructing a response. The `redirect_to` method does something completely different: it tells the browser to send a new request for a different URL. For example, you could redirect from wherever you are in your code to the index of photos in your application with this call:
...
You can use [`redirect_back`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Redirecting.html#method-i-redirect_back) to return the user to the page they just came from.
...
#### [2.3.1 Getting a Different Redirect Status Code](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#getting-a-different-redirect-status-code)
...
#### [2.3.2 The Difference Between `render` and `redirect_to`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#the-difference-between-render-and-redirect-to)
...
### [2.4 Using `head` to Build Header-Only Responses](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-head-to-build-header-only-responses)

The [`head`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Head.html#method-i-head) method can be used to send responses with only headers to the browser. The `head` method accepts a number or symbol (see [reference table](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#the-status-option)) representing an HTTP status code. The options argument is interpreted as a hash of header names and values. For example, you can return only an error header:
...
- Asset tags
- `yield` and [`content_for`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/CaptureHelper.html#method-i-content_for)
- Partials

### [3.1 Asset Tag Helpers](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#asset-tag-helpers)

Asset tag helpers provide methods for generating HTML that link views to feeds, JavaScript, stylesheets, images, videos, and audios. There are six asset tag helpers available in Rails:

- [`auto_discovery_link_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-auto_discovery_link_tag)
- [`javascript_include_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-javascript_include_tag)
- [`stylesheet_link_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-stylesheet_link_tag)
- [`image_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-image_tag)
- [`video_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-video_tag)
- [`audio_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-audio_tag)
...
#### [3.1.2 Linking to JavaScript Files with the `javascript_include_tag`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#linking-to-javascript-files-with-the-javascript-include-tag)

The [`javascript_include_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-javascript_include_tag) helper returns an HTML `script` tag for each source provided.

If you are using Rails with the [Asset Pipeline](https://guides.rubyonrails.org/v7.2/asset_pipeline.html) enabled, this helper will generate a link to `/assets/javascripts/` rather than `public/javascripts` which was used in earlier versions of Rails. This link is then served by the asset pipeline.
...
#### [3.1.3 Linking to CSS Files with the `stylesheet_link_tag`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#linking-to-css-files-with-the-stylesheet-link-tag)

The [`stylesheet_link_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-stylesheet_link_tag) helper returns an HTML `<link>` tag for each source provided.
...
#### [3.1.4 Linking to Images with the `image_tag`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#linking-to-images-with-the-image-tag)

The [`image_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-image_tag) helper builds an HTML `<img />` tag to the specified file. By default, files are loaded from `public/images`.
...
#### [3.1.5 Linking to Videos with the `video_tag`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#linking-to-videos-with-the-video-tag)

The [`video_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-video_tag) helper builds an HTML5 `<video>` tag to the specified file. By default, files are loaded from `public/videos`.
...
#### [3.1.6 Linking to Audio Files with the `audio_tag`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#linking-to-audio-files-with-the-audio-tag)

The [`audio_tag`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/AssetTagHelper.html#method-i-audio_tag) helper builds an HTML5 `<audio>` tag to the specified file. By default, files are loaded from `public/audios`.
...
### [3.2 Understanding `yield`](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#understanding-yield)
...
### [3.3 Using the `content_for` Method](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-the-content-for-method)

The [`content_for`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/CaptureHelper.html#method-i-content_for) method allows you to insert content into a named `yield` block in your layout. For example, this view would work with the layout that you just saw:
...
### [3.4 Using Partials](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-partials)

Partial templates - usually just called "partials" - are another device for breaking the rendering process into more manageable chunks. With a partial, you can move the code for rendering a particular piece of a response to its own file.

#### [3.4.1 Naming Partials](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#naming-partials)

To render a partial as part of a view, you use the [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/RenderingHelper.html#method-i-render) method within the view:
...
Since view partials rely on the same [Template Inheritance](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#template-inheritance)
as templates and layouts, that code will pull in the partial from `app/views/application/_menu.html.erb`.

#### [3.4.2 Using Partials to Simplify Views](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-partials-to-simplify-views)
...
#### [3.4.3 Partial Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#partial-layouts)
...
#### [3.4.4 Passing Local Variables](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#passing-local-variables)
...
#### [3.4.5 Rendering Collections](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#rendering-collections)
...
#### [3.4.6 Local Variables](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#local-variables)
...
#### [3.4.7 Counter Variables](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#counter-variables)
...
#### [3.4.8 Spacer Templates](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#spacer-templates)
...
#### [3.4.9 Collection Partial Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#collection-partial-layouts)
...
### [3.5 Using Nested Layouts](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html\#using-nested-layouts)
