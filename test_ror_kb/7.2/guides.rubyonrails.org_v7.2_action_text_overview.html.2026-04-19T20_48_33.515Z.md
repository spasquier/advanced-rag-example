...
1. [What is Action Text?](https://guides.rubyonrails.org/v7.2/action_text_overview.html#what-is-action-text-questionmark)
2. [Installation](https://guides.rubyonrails.org/v7.2/action_text_overview.html#installation)
3. [Creating Rich Text Content](https://guides.rubyonrails.org/v7.2/action_text_overview.html#creating-rich-text-content)
4. [Rendering Rich Text Content](https://guides.rubyonrails.org/v7.2/action_text_overview.html#rendering-rich-text-content)
5. [Customizing the Rich Text Content Editor (Trix)](https://guides.rubyonrails.org/v7.2/action_text_overview.html#customizing-the-rich-text-content-editor-trix)
   - [Removing or Adding Trix Styles](https://guides.rubyonrails.org/v7.2/action_text_overview.html#removing-or-adding-trix-styles)
   - [Customizing the Editor Container](https://guides.rubyonrails.org/v7.2/action_text_overview.html#customizing-the-editor-container)
   - [Customizing HTML for Embedded Images and Attachments](https://guides.rubyonrails.org/v7.2/action_text_overview.html#customizing-html-for-embedded-images-and-attachments)
6. [Attachments](https://guides.rubyonrails.org/v7.2/action_text_overview.html#attachments)
   - [Active Storage](https://guides.rubyonrails.org/v7.2/action_text_overview.html#active-storage)
   - [Signed GlobalID](https://guides.rubyonrails.org/v7.2/action_text_overview.html#signed-globalid)
   - [Rendering an Action Text Attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html#rendering-an-action-text-attachment)
   - [Rendering a Different Partial for the action-text-attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html#rendering-a-different-partial-for-the-action-text-attachment)
   - [Rendering a Partial for an Unresolved Instance or Missing action-text-attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html#rendering-a-partial-for-an-unresolved-instance-or-missing-action-text-attachment)
   - [Attachable via API](https://guides.rubyonrails.org/v7.2/action_text_overview.html#attachable-via-api)
7. [Miscellaneous](https://guides.rubyonrails.org/v7.2/action_text_overview.html#miscellaneous)
   - [Avoiding N+1 Queries](https://guides.rubyonrails.org/v7.2/action_text_overview.html#avoiding-n-1-queries)
...
[Active Storage Overview](https://guides.rubyonrails.org/v7.2/active_storage_overview.html) guide for more
...
do so, use a
[`rich_text_area`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormHelper.html#method-i-rich_text_area)
for the form field.
...
editor](https://guides.rubyonrails.org/v7.2/action_text_overview.html#removing-or-adding-trix-styles).
...
documentation](https://api.rubyonrails.org/v7.2.3.1/classes/ActionText/RichText.html).
...
Storage](https://guides.rubyonrails.org/v7.2/active_storage_overview.html#requirements) installed.
...
### [5.1 Removing or Adding Trix Styles](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#removing-or-adding-trix-styles)
...
### [5.2 Customizing the Editor Container](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#customizing-the-editor-container)
...
### [5.3 Customizing HTML for Embedded Images and Attachments](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#customizing-html-for-embedded-images-and-attachments)
...
### [6.1 Active Storage](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#active-storage)
...
dependencies](https://guides.rubyonrails.org/v7.2/active_storage_overview.html#requirements) which are not provided
...
### [6.2 Signed GlobalID](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#signed-globalid)
...
### [6.3 Rendering an Action Text Attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#rendering-an-action-text-attachment)
...
### [6.4 Rendering a Different Partial for the action-text-attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#rendering-a-different-partial-for-the-action-text-attachment)
...
### [6.5 Rendering a Partial for an Unresolved Instance or Missing action-text-attachment](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#rendering-a-partial-for-an-unresolved-instance-or-missing-action-text-attachment)
...
### [6.6 Attachable via API](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#attachable-via-api)
...
### [7.1 Avoiding N+1 Queries](https://guides.rubyonrails.org/v7.2/action_text_overview.html\#avoiding-n-1-queries)
