...
01. [What is the Asset Pipeline?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#what-is-the-asset-pipeline-questionmark)
02. [Main Features](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#main-features)
    - [What is Fingerprinting and Why Should I Care?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#what-is-fingerprinting-and-why-should-i-care-questionmark)
    - [What are Import Maps and Why Should I Care?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#what-are-import-maps-and-why-should-i-care-questionmark)
03. [How to use Import Maps as JavaScript Asset Pipeline](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#how-to-use-import-maps-as-javascript-asset-pipeline)
    - [How it works](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#how-it-works)
    - [Usage](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#usage)
    - [Using npm packages via JavaScript CDNs](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#using-npm-packages-via-javascript-cdns)
    - [Preloading pinned modules](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#preloading-pinned-modules)
04. [How to Use Sprockets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#how-to-use-sprockets)
    - [Manifest Files and Directives](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#manifest-files-and-directives)
    - [Controller Specific Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#controller-specific-assets)
    - [Asset Organization](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#asset-organization)
    - [Coding Links to Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#coding-links-to-assets)
    - [Raise an Error When an Asset is Not Found](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#raise-an-error-when-an-asset-is-not-found)
    - [Turning Digests Off](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#turning-digests-off)
    - [Turning Source Maps On](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#turning-source-maps-on)
05. [In Production](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#in-production)
    - [Precompiling Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#precompiling-assets)
    - [Local Precompilation](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#local-precompilation)
    - [Live Compilation](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#live-compilation)
    - [CDNs](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#cdns)
06. [Customizing the Pipeline](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#customizing-the-pipeline)
    - [CSS Compression](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#css-compression)
    - [JavaScript Compression](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#javascript-compression)
    - [GZipping your assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#gzipping-your-assets)
    - [Using Your Own Compressor](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#using-your-own-compressor)
    - [Changing the _assets_ Path](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#changing-the-assets-path)
    - [X-Sendfile Headers](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#x-sendfile-headers)
07. [Assets Cache Store](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#assets-cache-store)
08. [Adding Assets to Your Gems](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#adding-assets-to-your-gems)
09. [Making Your Library or Gem a Pre-Processor](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#making-your-library-or-gem-a-pre-processor)
10. [Alternative Libraries](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#alternative-libraries)
    - [jsbundling-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#jsbundling-rails)
    - [Webpacker/Shakapacker](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#webpacker-shakapacker)
    - [cssbundling-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#cssbundling-rails)
    - [dartsass-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#dartsass-rails)
    - [tailwindcss-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#tailwindcss-rails)

* * *

## [1 What is the Asset Pipeline?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#what-is-the-asset-pipeline-questionmark)
...
This guide focuses on the default asset pipeline using only `sprockets` for CSS and `importmap-rails` for JavaScript processing. The main limitation of those two is that there is no support for transpiling so you can't use things like Babel, TypeScript, Sass, React JSX format, or Tailwind CSS. We encourage you to read the [Alternative Libraries section](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#alternative-libraries) if you need transpiling for your JavaScript/CSS.

## [2 Main Features](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#main-features)
...
### [2.1 What is Fingerprinting and Why Should I Care?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#what-is-fingerprinting-and-why-should-i-care-questionmark)
...
[`config.assets.digest`](https://guides.rubyonrails.org/v7.2/configuring.html#config-assets-digest) option.

### [2.2 What are Import Maps and Why Should I Care?](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#what-are-import-maps-and-why-should-i-care-questionmark)
...
## [3 How to use Import Maps as JavaScript Asset Pipeline](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#how-to-use-import-maps-as-javascript-asset-pipeline)
...
Import maps are used only for JavaScript files and can not be used for CSS delivery. Check the [Sprockets section](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#how-to-use-sprockets) to learn about CSS.
...
### [3.1 How it works](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#how-it-works)
...
### [3.2 Usage](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#usage)
...
### [3.3 Using npm packages via JavaScript CDNs](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#using-npm-packages-via-javascript-cdns)
...
### [3.4 Preloading pinned modules](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#preloading-pinned-modules)
...
Refer to [`importmap-rails`](https://github.com/rails/importmap-rails) repository for the most up-to-date documentation.

## [4 How to Use Sprockets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#how-to-use-sprockets)
...
[`config.public_file_server.enabled`](https://guides.rubyonrails.org/v7.2/configuring.html#config-public-file-server-enabled) is set to true. You must define `manifest.js` directives
...
### [4.1 Manifest Files and Directives](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#manifest-files-and-directives)
...
### [4.2 Controller Specific Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#controller-specific-assets)
...
### [4.3 Asset Organization](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#asset-organization)
...
Other locations could be configured in the `manifest.js` file, refer to the [Manifest Files and Directives](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#manifest-files-and-directives).

#### [4.3.1 Search Paths](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#search-paths)
...
[`Rails.application.config.assets.paths`](https://guides.rubyonrails.org/v7.2/configuring.html#config-assets-paths) in the Rails console.

#### [4.3.2 Using Index Files as proxies for folders](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#using-index-files-as-proxies-for-folders)
...
### [4.4 Coding Links to Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#coding-links-to-assets)
...
Production](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#in-production) section later on in this guide.
...
If you're precompiling your assets (see [In Production](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#in-production)
...
#### [4.4.1 CSS and ERB](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#css-and-erb)
...
### [4.5 Raise an Error When an Asset is Not Found](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#raise-an-error-when-an-asset-is-not-found)
...
### [4.6 Turning Digests Off](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#turning-digests-off)
...
### [4.7 Turning Source Maps On](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#turning-source-maps-on)
...
## [5 In Production](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#in-production)
...
The fingerprinting behavior is controlled by the [`config.assets.digest`](https://guides.rubyonrails.org/v7.2/configuring.html#config-assets-digest)
...
### [5.1 Precompiling Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#precompiling-assets)

Rails comes bundled with a command to compile the asset manifests and other
files in the pipeline.

Compiled assets are written to the location specified in [`config.assets.prefix`](https://guides.rubyonrails.org/v7.2/configuring.html#config-assets-prefix).
...
#### [5.1.1 Far-future Expires Header](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#far-future-expires-header)
...
### [5.2 Local Precompilation](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#local-precompilation)
...
### [5.3 Live Compilation](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#live-compilation)
...
Cache Store](https://guides.rubyonrails.org/v7.2/asset_pipeline.html#assets-cache-store), and the manifest names used in the helpers
...
### [5.4 CDNs](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cdns)
...
#### [5.4.1 Set up a CDN to Serve Static Assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#set-up-a-cdn-to-serve-static-assets)
...
asset host in Rails, you need to set [`config.asset_host`](https://guides.rubyonrails.org/v7.2/configuring.html#config-asset-host) in
...
[`config.action_controller.asset_host`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-asset-host).
...
#### [5.4.2 Customize CDN Caching Behavior](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#customize-cdn-caching-behavior)
...
##### [5.4.2.1 CDN Request Caching](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cdn-request-caching)
...
##### [5.4.2.2 CDN Header Debugging](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cdn-header-debugging)
...
##### [5.4.2.3 CDNs and the Cache-Control Header](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cdns-and-the-cache-control-header)

The [`Cache-Control`](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control) header describes how a request can be cached. When no CDN is used, a
...
##### [5.4.2.4 CDNs and URL-based Cache Invalidation](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cdns-and-url-based-cache-invalidation)
...
## [6 Customizing the Pipeline](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#customizing-the-pipeline)

### [6.1 CSS Compression](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#css-compression)
...
### [6.2 JavaScript Compression](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#javascript-compression)
...
### [6.3 GZipping your assets](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#gzipping-your-assets)
...
### [6.4 Using Your Own Compressor](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#using-your-own-compressor)
...
### [6.5 Changing the _assets_ Path](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#changing-the-assets-path)
...
### [6.6 X-Sendfile Headers](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#x-sendfile-headers)
...
faster. Have a look at [send\_file](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/DataStreaming.html#method-i-send_file)
...
## [7 Assets Cache Store](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#assets-cache-store)
...
## [8 Adding Assets to Your Gems](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#adding-assets-to-your-gems)
...
## [9 Making Your Library or Gem a Pre-Processor](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#making-your-library-or-gem-a-pre-processor)
...
### [10.1 jsbundling-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#jsbundling-rails)
...
### [10.2 Webpacker/Shakapacker](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#webpacker-shakapacker)
...
Read the [Comparison with Webpacker](https://github.com/rails/jsbundling-rails/blob/main/docs/comparison_with_webpacker.md) document to understand the differences between `jsbundling-rails` and `webpacker`/`shakapacker`.

### [10.3 cssbundling-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#cssbundling-rails)
...
### [10.4 dartsass-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#dartsass-rails)
...
### [10.5 tailwindcss-rails](https://guides.rubyonrails.org/v7.2/asset_pipeline.html\#tailwindcss-rails)
