[Skip to main content](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [What is Caching?](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#what-is-caching-questionmark)
2. [Types of Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#types-of-caching)
   - [Fragment Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#fragment-caching)
   - [Russian Doll Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#russian-doll-caching)
   - [Shared Partial Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#shared-partial-caching)
   - [Low-Level Caching using `Rails.cache`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#low-level-caching-using-rails-cache)
   - [SQL Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#sql-caching)
3. [Managing Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#managing-dependencies)
   - [Implicit Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#implicit-dependencies)
   - [Explicit Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#explicit-dependencies)
   - [External Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#external-dependencies)
4. [Solid Cache](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#solid-cache)
   - [Configuring the Database](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#configuring-the-database)
   - [Customizing the Cache Store](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#customizing-the-cache-store)
   - [Handling Cache Expiration](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#handling-cache-expiration)
   - [Sharding the Cache](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#sharding-the-cache)
   - [Encryption](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#encryption)
   - [Caching in Development](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#caching-in-development)
5. [Other Cache Stores](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#other-cache-stores)
   - [Configuration](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#configuration)
   - [`ActiveSupport::Cache::Store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-store)
   - [`ActiveSupport::Cache::MemoryStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-memorystore)
   - [`ActiveSupport::Cache::FileStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-filestore)
   - [`ActiveSupport::Cache::MemCacheStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-memcachestore)
   - [`ActiveSupport::Cache::RedisCacheStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-rediscachestore)
   - [`ActiveSupport::Cache::NullStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-nullstore)
   - [Custom Cache Stores](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#custom-cache-stores)
6. [Cache Keys](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#cache-keys)
7. [Conditional GET Support](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#conditional-get-support)
   - [Strong v/s Weak ETags](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#strong-v-s-weak-etags)
...
[`config.action_controller.perform_caching`](https://guides.rubyonrails.org/v8.1/configuring.html#config-action-controller-perform-caching) to `true` in `config/environments/development.rb`.
...
[below](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#low-level-caching-using-rails-cache).

### [2.1. Fragment Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#fragment-caching)
...
#### [2.1.1. Collection Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#collection-caching)
...
### [2.2. Russian Doll Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#russian-doll-caching)
...
### [2.3. Shared Partial Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#shared-partial-caching)
...
### [2.4. Low-Level Caching using `Rails.cache`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#low-level-caching-using-rails-cache)
...
#### [2.4.1. Avoid Caching Instances of Active Record Objects](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#avoid-caching-instances-of-active-record-objects)
...
### [2.5. SQL Caching](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#sql-caching)
...
### [3.1. Implicit Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#implicit-dependencies)

Most template dependencies can be derived from calls to `render` in the template
itself. Here are some examples of render calls that [`ActionView::Digestor`](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Digestor.html) knows
how to decode:
...
### [3.2. Explicit Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#explicit-dependencies)
...
### [3.3. External Dependencies](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#external-dependencies)
...
### [4.1. Configuring the Database](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#configuring-the-database)
...
If `database` or [`databases`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#sharding-the-cache) is not specified in the
...
`Rails.cache`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#low-level-caching-using-rails-cache)

### [4.2. Customizing the Cache Store](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#customizing-the-cache-store)
...
For the full list of keys for store\_options see [Cache\\
...
### [4.3. Handling Cache Expiration](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#handling-cache-expiration)
...
### [4.4. Sharding the Cache](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#sharding-the-cache)
...
### [4.5. Encryption](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#encryption)
...
Encryption](https://guides.rubyonrails.org/v8.1/active_record_encryption.html).

### [4.6. Caching in Development](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#caching-in-development)

By default, caching is _enabled_ in development mode with
[`:memory_store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-memorystore). This doesn't apply to
...
[`:null_store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-nullstore)
...
### [5.1. Configuration](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#configuration)
...
#### [5.1.1. Connection Pool Options](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#connection-pool-options)

[`:mem_cache_store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-memcachestore) and
[`:redis_cache_store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#activesupport-cache-rediscachestore) are configured to
...
### [5.2.`ActiveSupport::Cache::Store`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-store)
...
### [5.3.`ActiveSupport::Cache::MemoryStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-memorystore)

[`ActiveSupport::Cache::MemoryStore`](https://api.rubyonrails.org/v8.1.3/classes/ActiveSupport/Cache/MemoryStore.html) keeps entries in memory in the same Ruby process. The cache
...
### [5.4.`ActiveSupport::Cache::FileStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-filestore)
...
### [5.5.`ActiveSupport::Cache::MemCacheStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-memcachestore)
...
### [5.6.`ActiveSupport::Cache::RedisCacheStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-rediscachestore)

[`ActiveSupport::Cache::RedisCacheStore`](https://api.rubyonrails.org/v8.1.3/classes/ActiveSupport/Cache/RedisCacheStore.html) takes advantage of Redis support for automatic eviction
...
### [5.7.`ActiveSupport::Cache::NullStore`](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#activesupport-cache-nullstore)
...
### [5.8. Custom Cache Stores](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#custom-cache-stores)
...
### [7.1. Strong v/s Weak ETags](https://guides.rubyonrails.org/v8.1/caching_with_rails.html\#strong-v-s-weak-etags)
...
[Back to top](https://guides.rubyonrails.org/v8.1/caching_with_rails.html#main-skip-link)