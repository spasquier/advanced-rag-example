[Skip to main content](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [The Object Life Cycle](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#the-object-life-cycle)
02. [Callback Registration](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#callback-registration)
    - [Registering Callbacks to Fire on Life Cycle Events](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#registering-callbacks-to-fire-on-life-cycle-events)
03. [Available Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#available-callbacks)
    - [Creating an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#creating-an-object)
    - [Updating an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#updating-an-object)
    - [Destroying an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#destroying-an-object)
    - [`after_initialize` and `after_find`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-initialize-and-after-find)
    - [`after_touch`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-touch)
04. [Running Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#running-callbacks)
05. [Conditional Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#conditional-callbacks)
    - [Using `:if` and `:unless` with a `Symbol`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#using-if-and-unless-with-a-symbol)
    - [Using `:if` and `:unless` with a `Proc`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#using-if-and-unless-with-a-proc)
    - [Multiple Callback Conditions](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#multiple-callback-conditions)
    - [Using Both `:if` and `:unless`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#using-both-if-and-unless)
06. [Skipping Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#skipping-callbacks)
07. [Suppressing Saving](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#suppressing-saving)
08. [Halting Execution](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#halting-execution)
09. [Association Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#association-callbacks)
10. [Cascading Association Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#cascading-association-callbacks)
11. [Transaction Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#transaction-callbacks)
    - [`after_commit` and `after_rollback`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-commit-and-after-rollback)
    - [Aliases for `after_commit`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#aliases-for-after-commit)
    - [Transactional Callback Ordering](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#transactional-callback-ordering)
    - [Per transaction callback](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#per-transaction-callback)
    - [`ActiveRecord.after_all_transactions_commit`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#activerecord-after-all-transactions-commit)
12. [Callback Objects](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#callback-objects)

## [1. The Object Life Cycle](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#the-object-life-cycle)

During the normal operation of a Rails application, objects may be [created,\\
updated, and\\
destroyed](https://guides.rubyonrails.org/v8.1/active_record_basics.html#crud-reading-and-writing-data). Active
...
## [2. Callback Registration](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#callback-registration)
...
Lastly, you can define [**a custom callback object**](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#callback-objects), as
...
### [2.1. Registering Callbacks to Fire on Life Cycle Events](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#registering-callbacks-to-fire-on-life-cycle-events)
...
## [3. Available Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#available-callbacks)
...
### [3.1. Creating an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#creating-an-object)

- [`before_validation`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/Callbacks/ClassMethods.html#method-i-before_validation)
- [`after_validation`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/Callbacks/ClassMethods.html#method-i-after_validation)
- [`before_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-before_save)
- [`around_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-around_save)
- [`before_create`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-before_create)
- [`around_create`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-around_create)
- [`after_create`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_create)
- [`after_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_save)
- [`after_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_commit) / [`after_rollback`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_rollback)

See the [`after_commit` / `after_rollback`\\
section](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-commit-and-after-rollback) for
...
#### [3.1.1. Validation Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#validation-callbacks)

Validation callbacks are triggered whenever the record is validated directly via
the
[`valid?`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations.html#method-i-valid-3F)
( or its alias
[`validate`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations.html#method-i-validate))
or
[`invalid?`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations.html#method-i-invalid-3F)
...
#### [3.1.2. Save Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#save-callbacks)
...
#### [3.1.3. Create Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#create-callbacks)
...
### [3.2. Updating an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#updating-an-object)
...
- [`before_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-before_save)
- [`around_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-around_save)
- [`before_update`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-before_update)
- [`around_update`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-around_update)
- [`after_update`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_update)
- [`after_save`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_save)
- [`after_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_commit) / [`after_rollback`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_rollback)
...
We've already covered [validation](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#validation-callbacks) and
[save](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#save-callbacks) callbacks. See the [`after_commit` /\\
`after_rollback` section](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-commit-and-after-rollback) for examples using
these two callbacks.

#### [3.2.1. Update Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#update-callbacks)
...
#### [3.2.2. Using a Combination of Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#using-a-combination-of-callbacks)
...
### [3.3. Destroying an Object](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#destroying-an-object)
...
- [`before_destroy`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-before_destroy)
- [`around_destroy`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-around_destroy)
- [`after_destroy`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_destroy)
- [`after_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_commit) / [`after_rollback`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_rollback)

Find [examples for using `after_commit` /\\
`after_rollback`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#after-commit-and-after-rollback).

#### [3.3.1. Destroy Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#destroy-callbacks)
...
### [3.4.`after_initialize` and `after_find`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#after-initialize-and-after-find)

Whenever an Active Record object is instantiated, either by directly using `new`
or when a record is loaded from the database, the [`after_initialize`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_initialize)
callback will be called. It can be useful to avoid the need to directly override
your Active Record `initialize` method.

When loading a record from the database the [`after_find`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_find) callback will be
...
### [3.5.`after_touch`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#after-touch)

The [`after_touch`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Callbacks/ClassMethods.html#method-i-after_touch) callback will be called whenever an Active Record object
is touched. You can [read more about `touch` in the API\\
docs](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Persistence.html#method-i-touch).
...
## [4. Running Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#running-callbacks)
...
section](https://guides.rubyonrails.org/v8.1/active_record_querying.html#dynamic-finders).

## [5. Conditional Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#conditional-callbacks)

As with [validations](https://guides.rubyonrails.org/v8.1/active_record_validations.html), we can also make the
...
### [5.1. Using `:if` and `:unless` with a `Symbol`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#using-if-and-unless-with-a-symbol)
...
section](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#multiple-callback-conditions).

### [5.2. Using `:if` and `:unless` with a `Proc`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#using-if-and-unless-with-a-proc)
...
### [5.3. Multiple Callback Conditions](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#multiple-callback-conditions)
...
### [5.4. Using Both `:if` and `:unless`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#using-both-if-and-unless)
...
## [6. Skipping Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#skipping-callbacks)

Just as with [validations](https://guides.rubyonrails.org/v8.1/active_record_validations.html), it is also possible
...
- [`delete`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Persistence.html#method-i-delete)
- [`delete_all`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Relation.html#method-i-delete_all)
- [`delete_by`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Relation.html#method-i-delete_by)
...
## [7. Suppressing Saving](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#suppressing-saving)
...
[`ActiveRecord::Suppressor` module](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Suppressor.html).
...
## [8. Halting Execution](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#halting-execution)
...
## [9. Association Callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#association-callbacks)
...
### [11.1.`after_commit` and `after_rollback`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#after-commit-and-after-rollback)

Two additional callbacks are triggered by the completion of a database
transaction: [`after_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_commit) and [`after_rollback`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_rollback). These callbacks are
...
more about `:on`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#registering-callbacks-to-fire-on-life-cycle-events).
...
### [11.2. Aliases for `after_commit`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#aliases-for-after-commit)
...
- [`after_destroy_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_destroy_commit)
- [`after_create_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_create_commit)
- [`after_update_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_update_commit)
- [`after_save_commit`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Transactions/ClassMethods.html#method-i-after_save_commit)
...
### [11.3. Transactional Callback Ordering](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#transactional-callback-ordering)
...
options](https://guides.rubyonrails.org/v8.1/configuring.html#config-active-record-run-after-transaction-callbacks-in-order-defined)
for more details.
...
### [11.4. Per transaction callback](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#per-transaction-callback)
...
### [11.5.`ActiveRecord.after_all_transactions_commit`](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html\#activerecord-after-all-transactions-commit)
...
[Back to top](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#main-skip-link)