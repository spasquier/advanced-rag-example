[Skip to main content](https://guides.rubyonrails.org/v8.1/form_helpers.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/form_helpers.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [Working with Basic Forms](https://guides.rubyonrails.org/v8.1/form_helpers.html#working-with-basic-forms)
    - [A Generic Search Form](https://guides.rubyonrails.org/v8.1/form_helpers.html#a-generic-search-form)
    - [Helpers for Generating Form Elements](https://guides.rubyonrails.org/v8.1/form_helpers.html#helpers-for-generating-form-elements)
    - [Other Helpers of Interest](https://guides.rubyonrails.org/v8.1/form_helpers.html#other-helpers-of-interest)
02. [Creating Forms with Model Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html#creating-forms-with-model-objects)
    - [Binding a Form to an Object](https://guides.rubyonrails.org/v8.1/form_helpers.html#binding-a-form-to-an-object)
    - [Relying on Record Identification](https://guides.rubyonrails.org/v8.1/form_helpers.html#relying-on-record-identification)
    - [Working with Namespaces](https://guides.rubyonrails.org/v8.1/form_helpers.html#working-with-namespaces)
    - [Forms with PATCH, PUT, or DELETE Methods](https://guides.rubyonrails.org/v8.1/form_helpers.html#forms-with-patch-put-or-delete-methods)
03. [Making Select Boxes with Ease](https://guides.rubyonrails.org/v8.1/form_helpers.html#making-select-boxes-with-ease)
    - [Option Groups for Select Boxes](https://guides.rubyonrails.org/v8.1/form_helpers.html#option-groups-for-select-boxes)
    - [Binding Select Boxes to Model Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html#binding-select-boxes-to-model-objects)
04. [Using Date and Time Form Helpers](https://guides.rubyonrails.org/v8.1/form_helpers.html#using-date-and-time-form-helpers)
    - [Select Boxes for Time or Date Components](https://guides.rubyonrails.org/v8.1/form_helpers.html#select-boxes-for-time-or-date-components)
    - [Selecting Time Zone](https://guides.rubyonrails.org/v8.1/form_helpers.html#selecting-time-zone)
05. [Collection Related Helpers](https://guides.rubyonrails.org/v8.1/form_helpers.html#collection-related-helpers)
    - [The `collection_select` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html#the-collection-select-helper)
    - [The `collection_radio_buttons` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html#the-collection-radio-buttons-helper)
    - [The `collection_checkboxes` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html#the-collection-checkboxes-helper)
06. [Uploading Files](https://guides.rubyonrails.org/v8.1/form_helpers.html#uploading-files)
    - [CSV File Upload Example](https://guides.rubyonrails.org/v8.1/form_helpers.html#csv-file-upload-example)
07. [Customizing Form Builders](https://guides.rubyonrails.org/v8.1/form_helpers.html#customizing-form-builders)
08. [Form Input Naming Conventions and `params` Hash](https://guides.rubyonrails.org/v8.1/form_helpers.html#form-input-naming-conventions-and-params-hash)
    - [Basic Structure](https://guides.rubyonrails.org/v8.1/form_helpers.html#basic-structure)
    - [Combining Arrays and Hashes](https://guides.rubyonrails.org/v8.1/form_helpers.html#combining-arrays-and-hashes)
    - [Hashes with an Index](https://guides.rubyonrails.org/v8.1/form_helpers.html#hashes-with-an-index)
09. [Building Complex Forms](https://guides.rubyonrails.org/v8.1/form_helpers.html#building-complex-forms)
    - [Configuring the Model for Nested Attributes](https://guides.rubyonrails.org/v8.1/form_helpers.html#configuring-the-model-for-nested-attributes)
    - [Nested Forms in the View](https://guides.rubyonrails.org/v8.1/form_helpers.html#nested-forms-in-the-view)
    - [Permitting Parameters in the Controller](https://guides.rubyonrails.org/v8.1/form_helpers.html#permitting-parameters-in-the-controller)
    - [Removing Associated Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html#removing-associated-objects)
    - [Preventing Empty Records](https://guides.rubyonrails.org/v8.1/form_helpers.html#preventing-empty-records)
10. [Forms to External Resources](https://guides.rubyonrails.org/v8.1/form_helpers.html#forms-to-external-resources)
11. [Using Tag Helpers without a Form Builder](https://guides.rubyonrails.org/v8.1/form_helpers.html#using-tag-helpers-without-a-form-builder)
12. [Using `form_tag` and `form_for`](https://guides.rubyonrails.org/v8.1/form_helpers.html#using-form-tag-and-form-for)
...
## [1. Working with Basic Forms](https://guides.rubyonrails.org/v8.1/form_helpers.html\#working-with-basic-forms)
...
In general, passing `url: my_path` to `form_with` tells the form where to make the request. The other option is to pass Active Model objects to the form, as you will learn [below](https://guides.rubyonrails.org/v8.1/form_helpers.html#creating-forms-with-model-objects). You can also use [URL helpers](https://guides.rubyonrails.org/v8.1/routing.html#path-and-url-helpers).
...
### [1.2. Helpers for Generating Form Elements](https://guides.rubyonrails.org/v8.1/form_helpers.html\#helpers-for-generating-form-elements)
...
When naming inputs, Rails uses certain conventions that make it possible to submit parameters with non-scalar values such as arrays or hashes, which will also be accessible in `params`. You can read more about them in the [Form Input Naming Conventions and Params Hash](https://guides.rubyonrails.org/v8.1/form_helpers.html#form-input-naming-conventions-and-params-hash) section of this guide. For details on the precise usage of these helpers, please refer to the [API documentation](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/FormTagHelper.html).

#### [1.2.1. Checkboxes](https://guides.rubyonrails.org/v8.1/form_helpers.html\#checkboxes)
...
There is also a `collection_checkboxes`, which you can learn about in the [Collection Related Helpers section](https://guides.rubyonrails.org/v8.1/form_helpers.html#collection-related-helpers).

#### [1.2.2. Radio Buttons](https://guides.rubyonrails.org/v8.1/form_helpers.html\#radio-buttons)
...
### [1.3. Other Helpers of Interest](https://guides.rubyonrails.org/v8.1/form_helpers.html\#other-helpers-of-interest)
...
If you're using password input fields, you might want to configure your application to prevent those parameters from being logged. You can learn about how in the [Securing Rails Applications](https://guides.rubyonrails.org/v8.1/security.html#logging) guide.

## [2. Creating Forms with Model Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html\#creating-forms-with-model-objects)

### [2.1. Binding a Form to an Object](https://guides.rubyonrails.org/v8.1/form_helpers.html\#binding-a-form-to-an-object)
...
- The form field names are scoped with `book[...]`. This means that `params[:book]` will be a hash containing all these field's values. You can read more about the significance of input names in chapter [Form Input Naming Conventions and Params Hash](https://guides.rubyonrails.org/v8.1/form_helpers.html#form-input-naming-conventions-and-params-hash) of this guide.
...
#### [2.1.1. Composite Primary Key Forms](https://guides.rubyonrails.org/v8.1/form_helpers.html\#composite-primary-key-forms)

If you have a model with a [composite primary key](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html), the form building syntax is the same with slightly different output.
...
value](https://guides.rubyonrails.org/v8.1/action_controller_overview.html#composite-key-parameters) from the parameters and update the record as it would with a singular
primary key.

#### [2.1.2. The `fields_for` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html\#the-fields-for-helper)
...
docs](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/FormBuilder.html#method-i-fields_for).

### [2.2. Relying on Record Identification](https://guides.rubyonrails.org/v8.1/form_helpers.html\#relying-on-record-identification)
...
If you have a [singular resource](https://guides.rubyonrails.org/v8.1/routing.html#singular-resources), you will need to call `resource` and `resolve` for it to work with `form_with`:
...
Declaring a resource has a number of side effects. See the [Rails Routing from the Outside In](https://guides.rubyonrails.org/v8.1/routing.html#resource-routing-the-rails-default) guide for more information on setting up and using resources.

When you're using [single-table inheritance](https://guides.rubyonrails.org/v8.1/association_basics.html#single-table-inheritance-sti) with your models, you can't rely on record identification on a subclass if only their parent class is declared a resource. You will have to specify `:url`, and `:scope` (the model name) explicitly.

### [2.3. Working with Namespaces](https://guides.rubyonrails.org/v8.1/form_helpers.html\#working-with-namespaces)
...
For more information on Rails' routing system and the associated conventions, please see the [Rails Routing from the Outside In](https://guides.rubyonrails.org/v8.1/routing.html) guide.

### [2.4. Forms with PATCH, PUT, or DELETE Methods](https://guides.rubyonrails.org/v8.1/form_helpers.html\#forms-with-patch-put-or-delete-methods)
...
## [3. Making Select Boxes with Ease](https://guides.rubyonrails.org/v8.1/form_helpers.html\#making-select-boxes-with-ease)
...
### [3.1. Option Groups for Select Boxes](https://guides.rubyonrails.org/v8.1/form_helpers.html\#option-groups-for-select-boxes)
...
### [3.2. Binding Select Boxes to Model Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html\#binding-select-boxes-to-model-objects)
...
## [4. Using Date and Time Form Helpers](https://guides.rubyonrails.org/v8.1/form_helpers.html\#using-date-and-time-form-helpers)

In addition to the `date_field` and `time_field` helpers mentioned [earlier](https://guides.rubyonrails.org/v8.1/form_helpers.html#other-helpers-of-interest), Rails provides alternative date and time form helpers that render plain select boxes. The `date_select` helper renders a separate select box for year, month, and day.
...
### [4.1. Select Boxes for Time or Date Components](https://guides.rubyonrails.org/v8.1/form_helpers.html\#select-boxes-for-time-or-date-components)
...
### [4.2. Selecting Time Zone](https://guides.rubyonrails.org/v8.1/form_helpers.html\#selecting-time-zone)
...
## [5. Collection Related Helpers](https://guides.rubyonrails.org/v8.1/form_helpers.html\#collection-related-helpers)
...
### [5.1. The `collection_select` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html\#the-collection-select-helper)
...
### [5.2. The `collection_radio_buttons` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html\#the-collection-radio-buttons-helper)
...
### [5.3. The `collection_checkboxes` Helper](https://guides.rubyonrails.org/v8.1/form_helpers.html\#the-collection-checkboxes-helper)
...
## [6. Uploading Files](https://guides.rubyonrails.org/v8.1/form_helpers.html\#uploading-files)
...
### [6.1. CSV File Upload Example](https://guides.rubyonrails.org/v8.1/form_helpers.html\#csv-file-upload-example)
...
[`ActionView::Helpers::FormBuilder`](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/FormBuilder.html). This class can be extended to add custom helpers for your application.
...
## [8. Form Input Naming Conventions and `params` Hash](https://guides.rubyonrails.org/v8.1/form_helpers.html\#form-input-naming-conventions-and-params-hash)
...
The fields in the `params` hash need to be [permitted in the controller](https://guides.rubyonrails.org/v8.1/form_helpers.html#permitting-parameters-in-the-controller).

### [8.1. Basic Structure](https://guides.rubyonrails.org/v8.1/form_helpers.html\#basic-structure)
...
### [8.2. Combining Arrays and Hashes](https://guides.rubyonrails.org/v8.1/form_helpers.html\#combining-arrays-and-hashes)
...
### [8.3. Hashes with an Index](https://guides.rubyonrails.org/v8.1/form_helpers.html\#hashes-with-an-index)

Let's say you want to render a form with a set of fields for each of a person's
addresses. The [`fields_for`](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/FormHelper.html#method-i-fields_for) helper with its `:index` option can assist:
...
## [9. Building Complex Forms](https://guides.rubyonrails.org/v8.1/form_helpers.html\#building-complex-forms)
...
### [9.1. Configuring the Model for Nested Attributes](https://guides.rubyonrails.org/v8.1/form_helpers.html\#configuring-the-model-for-nested-attributes)
...
### [9.2. Nested Forms in the View](https://guides.rubyonrails.org/v8.1/form_helpers.html\#nested-forms-in-the-view)
...
### [9.3. Permitting Parameters in the Controller](https://guides.rubyonrails.org/v8.1/form_helpers.html\#permitting-parameters-in-the-controller)

As usual you need to [declare the permitted\\
parameters](https://guides.rubyonrails.org/v8.1/action_controller_overview.html#strong-parameters) in the controller
...
### [9.4. Removing Associated Objects](https://guides.rubyonrails.org/v8.1/form_helpers.html\#removing-associated-objects)
...
### [9.5. Preventing Empty Records](https://guides.rubyonrails.org/v8.1/form_helpers.html\#preventing-empty-records)
...
[Back to top](https://guides.rubyonrails.org/v8.1/form_helpers.html#main-skip-link)