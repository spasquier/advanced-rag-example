[Skip to main content](https://guides.rubyonrails.org/v8.1/getting_started.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/getting_started.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [Introduction](https://guides.rubyonrails.org/v8.1/getting_started.html#introduction)
02. [Rails Philosophy](https://guides.rubyonrails.org/v8.1/getting_started.html#rails-philosophy)
03. [Creating a New Rails App](https://guides.rubyonrails.org/v8.1/getting_started.html#creating-a-new-rails-app)
    - [Prerequisites](https://guides.rubyonrails.org/v8.1/getting_started.html#prerequisites)
    - [Creating Your First Rails App](https://guides.rubyonrails.org/v8.1/getting_started.html#creating-your-first-rails-app)
    - [Directory Structure](https://guides.rubyonrails.org/v8.1/getting_started.html#directory-structure)
    - [Model-View-Controller Basics](https://guides.rubyonrails.org/v8.1/getting_started.html#model-view-controller-basics)
04. [Hello, Rails!](https://guides.rubyonrails.org/v8.1/getting_started.html#hello-rails-bang)
    - [Autoloading in Development](https://guides.rubyonrails.org/v8.1/getting_started.html#autoloading-in-development)
05. [Creating a Database Model](https://guides.rubyonrails.org/v8.1/getting_started.html#creating-a-database-model)
    - [Database Migrations](https://guides.rubyonrails.org/v8.1/getting_started.html#database-migrations)
    - [Running Migrations](https://guides.rubyonrails.org/v8.1/getting_started.html#running-migrations)
06. [Rails Console](https://guides.rubyonrails.org/v8.1/getting_started.html#rails-console)
07. [Active Record Model Basics](https://guides.rubyonrails.org/v8.1/getting_started.html#active-record-model-basics)
    - [Creating Records](https://guides.rubyonrails.org/v8.1/getting_started.html#creating-records)
    - [Querying Records](https://guides.rubyonrails.org/v8.1/getting_started.html#querying-records)
    - [Filtering & Ordering Records](https://guides.rubyonrails.org/v8.1/getting_started.html#filtering-ordering-records)
    - [Finding Records](https://guides.rubyonrails.org/v8.1/getting_started.html#finding-records)
    - [Updating Records](https://guides.rubyonrails.org/v8.1/getting_started.html#updating-records)
    - [Deleting Records](https://guides.rubyonrails.org/v8.1/getting_started.html#deleting-records)
    - [Validations](https://guides.rubyonrails.org/v8.1/getting_started.html#validations)
08. [A Request's Journey Through Rails](https://guides.rubyonrails.org/v8.1/getting_started.html#a-request-s-journey-through-rails)
09. [Routes](https://guides.rubyonrails.org/v8.1/getting_started.html#routes)
    - [Parts of a URL](https://guides.rubyonrails.org/v8.1/getting_started.html#parts-of-a-url)
    - [HTTP Methods and Their Purpose](https://guides.rubyonrails.org/v8.1/getting_started.html#http-methods-and-their-purpose)
    - [Rails Routes](https://guides.rubyonrails.org/v8.1/getting_started.html#rails-routes)
    - [Routes Command](https://guides.rubyonrails.org/v8.1/getting_started.html#routes-command)
10. [Controllers & Actions](https://guides.rubyonrails.org/v8.1/getting_started.html#controllers-actions)
    - [Making Requests](https://guides.rubyonrails.org/v8.1/getting_started.html#making-requests)
    - [Instance Variables](https://guides.rubyonrails.org/v8.1/getting_started.html#instance-variables)
    - [CRUD Actions](https://guides.rubyonrails.org/v8.1/getting_started.html#crud-actions)
    - [Showing Individual Products](https://guides.rubyonrails.org/v8.1/getting_started.html#showing-individual-products)
    - [Creating Products](https://guides.rubyonrails.org/v8.1/getting_started.html#creating-products)
    - [Editing Products](https://guides.rubyonrails.org/v8.1/getting_started.html#editing-products)
    - [Deleting Products](https://guides.rubyonrails.org/v8.1/getting_started.html#deleting-products)
11. [Adding Authentication](https://guides.rubyonrails.org/v8.1/getting_started.html#adding-authentication)
    - [Adding Log Out](https://guides.rubyonrails.org/v8.1/getting_started.html#adding-log-out)
    - [Allowing Unauthenticated Access](https://guides.rubyonrails.org/v8.1/getting_started.html#allowing-unauthenticated-access)
    - [Showing Links for Authenticated Users Only](https://guides.rubyonrails.org/v8.1/getting_started.html#showing-links-for-authenticated-users-only)
12. [Caching Products](https://guides.rubyonrails.org/v8.1/getting_started.html#caching-products)
13. [Rich Text Fields with Action Text](https://guides.rubyonrails.org/v8.1/getting_started.html#rich-text-fields-with-action-text)
14. [File Uploads with Active Storage](https://guides.rubyonrails.org/v8.1/getting_started.html#file-uploads-with-active-storage)
15. [Internationalization (I18n)](https://guides.rubyonrails.org/v8.1/getting_started.html#internationalization-i18n)
16. [Action Mailer and Email Notifications](https://guides.rubyonrails.org/v8.1/getting_started.html#action-mailer-and-email-notifications)
    - [Basic Inventory Tracking](https://guides.rubyonrails.org/v8.1/getting_started.html#basic-inventory-tracking)
    - [Adding Subscribers to Products](https://guides.rubyonrails.org/v8.1/getting_started.html#adding-subscribers-to-products)
    - [In Stock Email Notifications](https://guides.rubyonrails.org/v8.1/getting_started.html#in-stock-email-notifications)
    - [Extracting a Concern](https://guides.rubyonrails.org/v8.1/getting_started.html#extracting-a-concern)
    - [Unsubscribe Links](https://guides.rubyonrails.org/v8.1/getting_started.html#unsubscribe-links)
17. [Adding CSS & JavaScript](https://guides.rubyonrails.org/v8.1/getting_started.html#adding-css-javascript)
    - [Propshaft](https://guides.rubyonrails.org/v8.1/getting_started.html#propshaft)
    - [Import Maps](https://guides.rubyonrails.org/v8.1/getting_started.html#import-maps)
    - [Hotwire](https://guides.rubyonrails.org/v8.1/getting_started.html#hotwire)
18. [Testing](https://guides.rubyonrails.org/v8.1/getting_started.html#testing)
    - [Fixtures](https://guides.rubyonrails.org/v8.1/getting_started.html#fixtures)
    - [Testing Emails](https://guides.rubyonrails.org/v8.1/getting_started.html#testing-emails)
19. [Consistently Formatted Code with RuboCop](https://guides.rubyonrails.org/v8.1/getting_started.html#consistently-formatted-code-with-rubocop)
20. [Security](https://guides.rubyonrails.org/v8.1/getting_started.html#security)
21. [Continuous Integration with GitHub Actions](https://guides.rubyonrails.org/v8.1/getting_started.html#continuous-integration-with-github-actions)
22. [Deploying to Production](https://guides.rubyonrails.org/v8.1/getting_started.html#deploying-to-production)
    - [Adding a User to Production](https://guides.rubyonrails.org/v8.1/getting_started.html#adding-a-user-to-production)
    - [Background Jobs using Solid Queue](https://guides.rubyonrails.org/v8.1/getting_started.html#background-jobs-using-solid-queue)
23. [What's Next?](https://guides.rubyonrails.org/v8.1/getting_started.html#what-s-next-questionmark)

## [1. Introduction](https://guides.rubyonrails.org/v8.1/getting_started.html\#introduction)
...
## [2. Rails Philosophy](https://guides.rubyonrails.org/v8.1/getting_started.html\#rails-philosophy)
...
## [3. Creating a New Rails App](https://guides.rubyonrails.org/v8.1/getting_started.html\#creating-a-new-rails-app)
...
### [3.1. Prerequisites](https://guides.rubyonrails.org/v8.1/getting_started.html\#prerequisites)
...
Follow the [Install Ruby on Rails Guide](https://guides.rubyonrails.org/v8.1/install_ruby_on_rails.html) if you need
...
### [3.2. Creating Your First Rails App](https://guides.rubyonrails.org/v8.1/getting_started.html\#creating-your-first-rails-app)
...
### [3.3. Directory Structure](https://guides.rubyonrails.org/v8.1/getting_started.html\#directory-structure)
...
| config/ | Contains configuration for your application's routes, database, and more. This is covered in more detail in [Configuring Rails Applications](https://guides.rubyonrails.org/v8.1/configuring.html). |
...
| storage/ | Contains SQLite databases and Active Storage files for Disk Service. This is covered in [Active Storage Overview](https://guides.rubyonrails.org/v8.1/active_storage_overview.html). |
| test/ | Unit tests, fixtures, and other test apparatus. These are covered in [Testing Rails Applications](https://guides.rubyonrails.org/v8.1/testing.html). |
...
### [3.4. Model-View-Controller Basics](https://guides.rubyonrails.org/v8.1/getting_started.html\#model-view-controller-basics)
...
![](https://guides.rubyonrails.org/v8.1/images/getting_started/mvc_architecture_light.jpg)

Now that we've got a basic understanding of MVC, let's see how it's used in
Rails.

## [4. Hello, Rails!](https://guides.rubyonrails.org/v8.1/getting_started.html\#hello-rails-bang)
...
To see your Rails application, open [http://localhost:3000](http://localhost:3000/) in your browser. You
will see the default Rails welcome page:

![Rails welcome page](https://guides.rubyonrails.org/v8.1/images/getting_started/rails_welcome.png)

It works!

This page is the _smoke test_ for a new Rails application, ensuring that
everything is working behind the scenes to serve a page.

To stop the Rails server anytime, press `Ctrl-C` in your terminal.

### [4.1. Autoloading in Development](https://guides.rubyonrails.org/v8.1/getting_started.html\#autoloading-in-development)
...
See
[Autoloading and Reloading Constants](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html)
for more details.

## [5. Creating a Database Model](https://guides.rubyonrails.org/v8.1/getting_started.html\#creating-a-database-model)
...
Model names are _singular_, because an instantiated model represents a
single record in the database (i.e., You are creating a _product_ to add to the
database.).

### [5.1. Database Migrations](https://guides.rubyonrails.org/v8.1/getting_started.html\#database-migrations)
...
### [5.2. Running Migrations](https://guides.rubyonrails.org/v8.1/getting_started.html\#running-migrations)
...
## [6. Rails Console](https://guides.rubyonrails.org/v8.1/getting_started.html\#rails-console)

Now that we have created our products table, we can interact with it in Rails.
Let's try it out.

For this, we're going to use a Rails feature called the _console_. The console
...
## [7. Active Record Model Basics](https://guides.rubyonrails.org/v8.1/getting_started.html\#active-record-model-basics)
...
### [7.1. Creating Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#creating-records)
...
database, and so does not have an ID, created\_at, or updated\_at timestamps.
...
### [7.2. Querying Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#querying-records)
...
The `all` method returns an `ActiveRecord::Relation` object which is an
Array-like collection of database records with features to filter, sort, and
execute other database operations.

### [7.3. Filtering & Ordering Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#filtering-ordering-records)
...
### [7.4. Finding Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#finding-records)
...
### [7.5. Updating Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#updating-records)
...
### [7.6. Deleting Records](https://guides.rubyonrails.org/v8.1/getting_started.html\#deleting-records)
...
### [7.7. Validations](https://guides.rubyonrails.org/v8.1/getting_started.html\#validations)

Active Record provides _validations_ which allows you to ensure data inserted
...
## [8. A Request's Journey Through Rails](https://guides.rubyonrails.org/v8.1/getting_started.html\#a-request-s-journey-through-rails)
...
## [9. Routes](https://guides.rubyonrails.org/v8.1/getting_started.html\#routes)
...
### [9.1. Parts of a URL](https://guides.rubyonrails.org/v8.1/getting_started.html\#parts-of-a-url)
...
### [9.2. HTTP Methods and Their Purpose](https://guides.rubyonrails.org/v8.1/getting_started.html\#http-methods-and-their-purpose)
...
### [9.3. Rails Routes](https://guides.rubyonrails.org/v8.1/getting_started.html\#rails-routes)
...
![](https://guides.rubyonrails.org/v8.1/images/getting_started/routing_light.jpg)
...
#### [9.3.1. CRUD Routes](https://guides.rubyonrails.org/v8.1/getting_started.html\#crud-routes)
...
#### [9.3.2. Resource Routes](https://guides.rubyonrails.org/v8.1/getting_started.html\#resource-routes)
...
need. Check out the [routing guide](https://guides.rubyonrails.org/v8.1/routing.html) for details.

### [9.4. Routes Command](https://guides.rubyonrails.org/v8.1/getting_started.html\#routes-command)
...
### [10.1. Making Requests](https://guides.rubyonrails.org/v8.1/getting_started.html\#making-requests)

Let's see this in our browser. First, run `bin/rails server` in your terminal to
start the Rails server. Then open [http://localhost:3000](http://localhost:3000/) and you will see the
Rails welcome page.

If we open [http://localhost:3000/products](http://localhost:3000/products) in the browser, Rails will render the
products index HTML.
...
### [10.2. Instance Variables](https://guides.rubyonrails.org/v8.1/getting_started.html\#instance-variables)
...
Now refresh [http://localhost:3000/](http://localhost:3000/) in your browser and you'll see that the
...
Check out the [Action View Helpers guide](https://guides.rubyonrails.org/v8.1/action_view_helpers.html) to see
...
Using ERB, this code loops through each product in the `@products``ActiveRecord::Relation` object and renders a `<div>` tag containing the product
name.
...
### [10.3. CRUD Actions](https://guides.rubyonrails.org/v8.1/getting_started.html\#crud-actions)
...
### [10.4. Showing Individual Products](https://guides.rubyonrails.org/v8.1/getting_started.html\#showing-individual-products)
...
The `show` action here defines the _singular_`@product` because it's loading a
...
### [10.5. Creating Products](https://guides.rubyonrails.org/v8.1/getting_started.html\#creating-products)
...
to create products. This helper uses a _form builder_ to handle things like CSRF
...
#### [10.5.1. Strong Parameters](https://guides.rubyonrails.org/v8.1/getting_started.html\#strong-parameters)
...
#### [10.5.2. Handling Errors](https://guides.rubyonrails.org/v8.1/getting_started.html\#handling-errors)
...
### [10.6. Editing Products](https://guides.rubyonrails.org/v8.1/getting_started.html\#editing-products)
...
#### [10.6.1. Extracting Partials](https://guides.rubyonrails.org/v8.1/getting_started.html\#extracting-partials)
...
[Action View Guide](https://guides.rubyonrails.org/v8.1/action_view_overview.html).
...
#### [10.6.2. Before Actions](https://guides.rubyonrails.org/v8.1/getting_started.html\#before-actions)
...
_before_ the action. In the above controller code,
...
### [10.7. Deleting Products](https://guides.rubyonrails.org/v8.1/getting_started.html\#deleting-products)
...
### [11.1. Adding Log Out](https://guides.rubyonrails.org/v8.1/getting_started.html\#adding-log-out)
...
### [11.2. Allowing Unauthenticated Access](https://guides.rubyonrails.org/v8.1/getting_started.html\#allowing-unauthenticated-access)
...
### [11.3. Showing Links for Authenticated Users Only](https://guides.rubyonrails.org/v8.1/getting_started.html\#showing-links-for-authenticated-users-only)
...
[http://localhost:3000/session/new](http://localhost:3000/session/new) and you'll see the New link on the index page.
...
Learn more in the [Caching with Rails](https://guides.rubyonrails.org/v8.1/caching_with_rails.html) guide.
...
Check out the [Action Text Overview](https://guides.rubyonrails.org/v8.1/action_text_overview.html) to learn more.
...
Check out the [Active Storage Overview](https://guides.rubyonrails.org/v8.1/active_storage_overview.html) for more
details.
...
- Visit [http://localhost:3000/products?locale=en](http://localhost:3000/products?locale=en), you will see the English
translation.
- Visit [http://localhost:3000/products?locale=es](http://localhost:3000/products?locale=es), you will see the Spanish
translation.
- Visit [http://localhost:3000/products](http://localhost:3000/products) without a locale param, it will fallback
to English.
...
Notice the `.` before `title`? This tells Rails to use a relative locale
...
Learn more about the [Rails Internationalization (I18n) API](https://guides.rubyonrails.org/v8.1/i18n.html).
...
### [16.1. Basic Inventory Tracking](https://guides.rubyonrails.org/v8.1/getting_started.html\#basic-inventory-tracking)
...
Rails infers that `AddInventoryCountToProducts` targets the `products`
...
### [16.2. Adding Subscribers to Products](https://guides.rubyonrails.org/v8.1/getting_started.html\#adding-subscribers-to-products)
...
The [flash](https://api.rubyonrails.org/v8.1.3/classes/ActionDispatch/Flash.html)
...
Learn more about the Flash in the [Action Controller Overview](https://guides.rubyonrails.org/v8.1/action_controller_overview.html#the-flash)
...
### [16.3. In Stock Email Notifications](https://guides.rubyonrails.org/v8.1/getting_started.html\#in-stock-email-notifications)
...
### [16.4. Extracting a Concern](https://guides.rubyonrails.org/v8.1/getting_started.html\#extracting-a-concern)
...
### [16.5. Unsubscribe Links](https://guides.rubyonrails.org/v8.1/getting_started.html\#unsubscribe-links)
...
### [17.1. Propshaft](https://guides.rubyonrails.org/v8.1/getting_started.html\#propshaft)
...
[Asset Pipeline guide](https://guides.rubyonrails.org/v8.1/asset_pipeline.html) to learn more about how this works.
...
### [17.2. Import Maps](https://guides.rubyonrails.org/v8.1/getting_started.html\#import-maps)
...
### [17.3. Hotwire](https://guides.rubyonrails.org/v8.1/getting_started.html\#hotwire)
...
Learn more in the [Asset Pipeline](https://guides.rubyonrails.org/v8.1/asset_pipeline.html) and
[Working with JavaScript in Rails](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html)
guides.
...
### [18.1. Fixtures](https://guides.rubyonrails.org/v8.1/getting_started.html\#fixtures)
...
### [18.2. Testing Emails](https://guides.rubyonrails.org/v8.1/getting_started.html\#testing-emails)
...
Learn more about [Testing Rails Applications](https://guides.rubyonrails.org/v8.1/testing.html)
...
Learn more about [Securing Rails Applications](https://guides.rubyonrails.org/v8.1/security.html)
...
### [22.1. Adding a User to Production](https://guides.rubyonrails.org/v8.1/getting_started.html\#adding-a-user-to-production)
...
### [22.2. Background Jobs using Solid Queue](https://guides.rubyonrails.org/v8.1/getting_started.html\#background-jobs-using-solid-queue)
...
![](https://guides.rubyonrails.org/v8.1/images/getting_started/background_jobs_light.jpg)

## [23. What's Next?](https://guides.rubyonrails.org/v8.1/getting_started.html\#what-s-next-questionmark)

Congratulations on building and deploying your first Rails application!

Next, follow the [Sign Up and Settings tutorial](https://guides.rubyonrails.org/v8.1/sign_up_and_settings.html) to continue learning.

We also recommend learning more by reading other Ruby on Rails Guides:

- [Active Record Basics](https://guides.rubyonrails.org/v8.1/active_record_basics.html)
- [Layouts and Rendering in Rails](https://guides.rubyonrails.org/v8.1/layouts_and_rendering.html)
- [Testing Rails Applications](https://guides.rubyonrails.org/v8.1/testing.html)
- [Debugging Rails Applications](https://guides.rubyonrails.org/v8.1/debugging_rails_applications.html)
- [Securing Rails Applications](https://guides.rubyonrails.org/v8.1/security.html)
...
[Back to top](https://guides.rubyonrails.org/v8.1/getting_started.html#main-skip-link)