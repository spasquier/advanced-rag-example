[Skip to main content](https://guides.rubyonrails.org/v8.1/i18n.html#main)
...
The process of "internationalization" usually means to abstract all strings and other locale specific bits (such as date or currency formats) out of your application. The process of "localization" means to provide translations and localized formats for these bits.[1](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-1)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/i18n.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [How I18n in Ruby on Rails Works](https://guides.rubyonrails.org/v8.1/i18n.html#how-i18n-in-ruby-on-rails-works)
    - [The Overall Architecture of the Library](https://guides.rubyonrails.org/v8.1/i18n.html#the-overall-architecture-of-the-library)
    - [The Public I18n API](https://guides.rubyonrails.org/v8.1/i18n.html#the-public-i18n-api)
02. [Setup the Rails Application for Internationalization](https://guides.rubyonrails.org/v8.1/i18n.html#setup-the-rails-application-for-internationalization)
    - [Configure the I18n Module](https://guides.rubyonrails.org/v8.1/i18n.html#configure-the-i18n-module)
    - [Managing the Locale across Requests](https://guides.rubyonrails.org/v8.1/i18n.html#managing-the-locale-across-requests)
03. [Internationalization and Localization](https://guides.rubyonrails.org/v8.1/i18n.html#internationalization-and-localization)
    - [Abstracting Localized Code](https://guides.rubyonrails.org/v8.1/i18n.html#abstracting-localized-code)
    - [Providing Translations for Internationalized Strings](https://guides.rubyonrails.org/v8.1/i18n.html#providing-translations-for-internationalized-strings)
    - [Passing Variables to Translations](https://guides.rubyonrails.org/v8.1/i18n.html#passing-variables-to-translations)
    - [Adding Date/Time Formats](https://guides.rubyonrails.org/v8.1/i18n.html#adding-date-time-formats)
    - [Inflection Rules for Other Locales](https://guides.rubyonrails.org/v8.1/i18n.html#inflection-rules-for-other-locales)
    - [Localized Views](https://guides.rubyonrails.org/v8.1/i18n.html#localized-views)
    - [Organization of Locale Files](https://guides.rubyonrails.org/v8.1/i18n.html#organization-of-locale-files)
04. [Overview of the I18n API Features](https://guides.rubyonrails.org/v8.1/i18n.html#overview-of-the-i18n-api-features)
    - [Looking up Translations](https://guides.rubyonrails.org/v8.1/i18n.html#looking-up-translations)
    - [Pluralization](https://guides.rubyonrails.org/v8.1/i18n.html#pluralization)
    - [Setting and Passing a Locale](https://guides.rubyonrails.org/v8.1/i18n.html#setting-and-passing-a-locale)
    - [Using Safe HTML Translations](https://guides.rubyonrails.org/v8.1/i18n.html#using-safe-html-translations)
    - [Translations for Active Record Models](https://guides.rubyonrails.org/v8.1/i18n.html#translations-for-active-record-models)
    - [Translations for Action Mailer E-Mail Subjects](https://guides.rubyonrails.org/v8.1/i18n.html#translations-for-action-mailer-e-mail-subjects)
    - [Overview of Other Built-In Methods that Provide I18n Support](https://guides.rubyonrails.org/v8.1/i18n.html#overview-of-other-built-in-methods-that-provide-i18n-support)
05. [How to Store your Custom Translations](https://guides.rubyonrails.org/v8.1/i18n.html#how-to-store-your-custom-translations)
06. [Customize Your I18n Setup](https://guides.rubyonrails.org/v8.1/i18n.html#customize-your-i18n-setup)
    - [Using Different Backends](https://guides.rubyonrails.org/v8.1/i18n.html#using-different-backends)
    - [Using Different Exception Handlers](https://guides.rubyonrails.org/v8.1/i18n.html#using-different-exception-handlers)
07. [Translating Model Content](https://guides.rubyonrails.org/v8.1/i18n.html#translating-model-content)
08. [Conclusion](https://guides.rubyonrails.org/v8.1/i18n.html#conclusion)
09. [Contributing to Rails I18n](https://guides.rubyonrails.org/v8.1/i18n.html#contributing-to-rails-i18n)
10. [Resources](https://guides.rubyonrails.org/v8.1/i18n.html#resources)
11. [Authors](https://guides.rubyonrails.org/v8.1/i18n.html#authors)
12. [Footnotes](https://guides.rubyonrails.org/v8.1/i18n.html#footnotes)
...
## [1. How I18n in Ruby on Rails Works](https://guides.rubyonrails.org/v8.1/i18n.html\#how-i18n-in-ruby-on-rails-works)
...
To localize, store, and update _content_ in your application (e.g. translate blog posts), see the [Translating model content](https://guides.rubyonrails.org/v8.1/i18n.html#translating-model-content) section.

### [1.1. The Overall Architecture of the Library](https://guides.rubyonrails.org/v8.1/i18n.html\#the-overall-architecture-of-the-library)
...
It is possible to swap the shipped Simple backend with a more powerful one, which would store translation data in a relational database, GetText dictionary, or similar. See section [Using different backends](https://guides.rubyonrails.org/v8.1/i18n.html#using-different-backends) below.

### [1.2. The Public I18n API](https://guides.rubyonrails.org/v8.1/i18n.html\#the-public-i18n-api)
...
## [2. Setup the Rails Application for Internationalization](https://guides.rubyonrails.org/v8.1/i18n.html\#setup-the-rails-application-for-internationalization)

There are a few steps to get up and running with I18n support for a Rails application.

### [2.1. Configure the I18n Module](https://guides.rubyonrails.org/v8.1/i18n.html\#configure-the-i18n-module)
...
### [2.2. Managing the Locale across Requests](https://guides.rubyonrails.org/v8.1/i18n.html\#managing-the-locale-across-requests)
...
#### [2.2.1. Setting the Locale from the Domain Name](https://guides.rubyonrails.org/v8.1/i18n.html\#setting-the-locale-from-the-domain-name)
...
#### [2.2.2. Setting the Locale from URL Params](https://guides.rubyonrails.org/v8.1/i18n.html\#setting-the-locale-from-url-params)

The most usual way of setting (and passing) the locale would be to include it in URL params, as we did in the `I18n.with_locale(params[:locale], &action)` _around\_action_ in the first example. We would like to have URLs like `www.example.com/books?locale=ja` or `www.example.com/ja/books` in this case.
...
Have a look at a gem which simplifies working with routes: [route\_translator](https://github.com/enriclluelles/route_translator).

#### [2.2.3. Setting the Locale from User Preferences](https://guides.rubyonrails.org/v8.1/i18n.html\#setting-the-locale-from-user-preferences)
...
#### [2.2.4. Choosing an Implied Locale](https://guides.rubyonrails.org/v8.1/i18n.html\#choosing-an-implied-locale)
...
##### [2.2.4.1. Inferring Locale from the Language Header](https://guides.rubyonrails.org/v8.1/i18n.html\#inferring-locale-from-the-language-header)
...
In practice, more robust code is necessary to do this reliably. Iain Hecker's [http\_accept\_language](https://github.com/iain/http_accept_language/tree/master) library or Ryan Tomayko's [locale](https://github.com/rack/rack-contrib/blob/main/lib/rack/contrib/locale.rb) Rack middleware provide solutions to this problem.

##### [2.2.4.2. Inferring the Locale from IP Geolocation](https://guides.rubyonrails.org/v8.1/i18n.html\#inferring-the-locale-from-ip-geolocation)
...
#### [2.2.5. Storing the Locale from the Session or Cookies](https://guides.rubyonrails.org/v8.1/i18n.html\#storing-the-locale-from-the-session-or-cookies)
...
## [3. Internationalization and Localization](https://guides.rubyonrails.org/v8.1/i18n.html\#internationalization-and-localization)
...
![rails i18n demo untranslated](https://guides.rubyonrails.org/v8.1/images/i18n/demo_untranslated.png)

### [3.1. Abstracting Localized Code](https://guides.rubyonrails.org/v8.1/i18n.html\#abstracting-localized-code)
...
![rails i18n demo translation missing](https://guides.rubyonrails.org/v8.1/images/i18n/demo_translation_missing.png)
...
### [3.2. Providing Translations for Internationalized Strings](https://guides.rubyonrails.org/v8.1/i18n.html\#providing-translations-for-internationalized-strings)
...
![rails i18n demo translated to English](https://guides.rubyonrails.org/v8.1/images/i18n/demo_translated_en.png)
...
![rails i18n demo translated to pirate](https://guides.rubyonrails.org/v8.1/images/i18n/demo_translated_pirate.png)
...
### [3.3. Passing Variables to Translations](https://guides.rubyonrails.org/v8.1/i18n.html\#passing-variables-to-translations)
...
### [3.4. Adding Date/Time Formats](https://guides.rubyonrails.org/v8.1/i18n.html\#adding-date-time-formats)
...
![rails i18n demo localized time to pirate](https://guides.rubyonrails.org/v8.1/images/i18n/demo_localized_pirate.png)
...
### [3.5. Inflection Rules for Other Locales](https://guides.rubyonrails.org/v8.1/i18n.html\#inflection-rules-for-other-locales)
...
### [3.6. Localized Views](https://guides.rubyonrails.org/v8.1/i18n.html\#localized-views)
...
### [3.7. Organization of Locale Files](https://guides.rubyonrails.org/v8.1/i18n.html\#organization-of-locale-files)
...
## [4. Overview of the I18n API Features](https://guides.rubyonrails.org/v8.1/i18n.html\#overview-of-the-i18n-api-features)
...
### [4.1. Looking up Translations](https://guides.rubyonrails.org/v8.1/i18n.html\#looking-up-translations)

#### [4.1.1. Basic Lookup, Scopes, and Nested Keys](https://guides.rubyonrails.org/v8.1/i18n.html\#basic-lookup-scopes-and-nested-keys)
...
#### [4.1.2. Defaults](https://guides.rubyonrails.org/v8.1/i18n.html\#defaults)
...
#### [4.1.3. Bulk and Namespace Lookup](https://guides.rubyonrails.org/v8.1/i18n.html\#bulk-and-namespace-lookup)
...
#### [4.1.4. "Lazy" Lookup](https://guides.rubyonrails.org/v8.1/i18n.html\#lazy-lookup)
...
### [4.2. Pluralization](https://guides.rubyonrails.org/v8.1/i18n.html\#pluralization)
...
#### [4.2.1. Locale-specific Rules](https://guides.rubyonrails.org/v8.1/i18n.html\#locale-specific-rules)
...
### [4.3. Setting and Passing a Locale](https://guides.rubyonrails.org/v8.1/i18n.html\#setting-and-passing-a-locale)
...
### [4.4. Using Safe HTML Translations](https://guides.rubyonrails.org/v8.1/i18n.html\#using-safe-html-translations)
...
![i18n demo HTML safe](https://guides.rubyonrails.org/v8.1/images/i18n/demo_html_safe.png)

### [4.5. Translations for Active Record Models](https://guides.rubyonrails.org/v8.1/i18n.html\#translations-for-active-record-models)
...
#### [4.5.1. Error Message Scopes](https://guides.rubyonrails.org/v8.1/i18n.html\#error-message-scopes)
...
#### [4.5.2. Error Message Interpolation](https://guides.rubyonrails.org/v8.1/i18n.html\#error-message-interpolation)
...
| comparison | :greater\_than | :greater\_than | count |
| comparison | :greater\_than\_or\_equal\_to | :greater\_than\_or\_equal\_to | count |
| comparison | :equal\_to | :equal\_to | count |
| comparison | :less\_than | :less\_than | count |
| comparison | :less\_than\_or\_equal\_to | :less\_than\_or\_equal\_to | count |
| comparison | :other\_than | :other\_than | count |

### [4.6. Translations for Action Mailer E-Mail Subjects](https://guides.rubyonrails.org/v8.1/i18n.html\#translations-for-action-mailer-e-mail-subjects)
...
### [4.7. Overview of Other Built-In Methods that Provide I18n Support](https://guides.rubyonrails.org/v8.1/i18n.html\#overview-of-other-built-in-methods-that-provide-i18n-support)

Rails uses fixed strings and other localizations, such as format strings and other format information in a couple of helpers. Here's a brief overview.

#### [4.7.1. Action View Helper Methods](https://guides.rubyonrails.org/v8.1/i18n.html\#action-view-helper-methods)
...
#### [4.7.2. Active Model Methods](https://guides.rubyonrails.org/v8.1/i18n.html\#active-model-methods)
...
## [5. How to Store your Custom Translations](https://guides.rubyonrails.org/v8.1/i18n.html\#how-to-store-your-custom-translations)

The Simple backend shipped with Active Support allows you to store translations in both plain Ruby and YAML format.[2](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-2)
...
## [6. Customize Your I18n Setup](https://guides.rubyonrails.org/v8.1/i18n.html\#customize-your-i18n-setup)

### [6.1. Using Different Backends](https://guides.rubyonrails.org/v8.1/i18n.html\#using-different-backends)

For several reasons the Simple backend shipped with Active Support only does the "simplest thing that could possibly work" _for Ruby on Rails_ [3](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-3) ... which means that it is only guaranteed to work for English and, as a side effect, languages that are very similar to English. Also, the simple backend is only capable of reading translations but cannot dynamically store them to any format.
...
### [6.2. Using Different Exception Handlers](https://guides.rubyonrails.org/v8.1/i18n.html\#using-different-exception-handlers)
...
#### [6.2.1. Customizing how `I18n::MissingTranslationData` is handled](https://guides.rubyonrails.org/v8.1/i18n.html\#customizing-how-i18n-missingtranslationdata-is-handled)
...
## [7. Translating Model Content](https://guides.rubyonrails.org/v8.1/i18n.html\#translating-model-content)
...
## [8. Conclusion](https://guides.rubyonrails.org/v8.1/i18n.html\#conclusion)

At this point you should have a good overview about how I18n support in Ruby on Rails works and are ready to start translating your project.

## [9. Contributing to Rails I18n](https://guides.rubyonrails.org/v8.1/i18n.html\#contributing-to-rails-i18n)
...
[1](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-1-ref) Or, to quote [Wikipedia](https://en.wikipedia.org/wiki/Internationalization_and_localization): _"Internationalization is the process of designing a software application so that it can be adapted to various languages and regions without engineering changes. Localization is the process of adapting software for a specific region or language by adding locale-specific components and translating text."_

[2](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-2-ref) Other backends might allow or require to use other formats, e.g. a GetText backend might allow to read GetText files.

[3](https://guides.rubyonrails.org/v8.1/i18n.html#footnote-3-ref) One of these reasons is that we don't want to imply any unnecessary load for applications that do not need any I18n capabilities, so we need to keep the I18n library as simple as possible for English. Another reason is that it is virtually impossible to implement a one-fits-all solution for all problems related to I18n for all existing languages. So a solution that allows us to exchange the entire implementation easily is appropriate anyway. This also makes it much easier to experiment with custom features and extensions.
...
[Back to top](https://guides.rubyonrails.org/v8.1/i18n.html#main-skip-link)