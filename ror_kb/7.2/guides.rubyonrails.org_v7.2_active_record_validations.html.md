---
url: "https://guides.rubyonrails.org/v7.2/active_record_validations.html"
title: "Active Record Validations — Ruby on Rails Guides"
---
...
1. [Validations Overview](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validations-overview)
   - [Why Use Validations?](https://guides.rubyonrails.org/v7.2/active_record_validations.html#why-use-validations-questionmark)
   - [Alternate Ways to Validate](https://guides.rubyonrails.org/v7.2/active_record_validations.html#alternate-ways-to-validate)
   - [Validation Triggers](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validation-triggers)
   - [Skipping Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#skipping-validations)
   - [Checking Validity](https://guides.rubyonrails.org/v7.2/active_record_validations.html#checking-validity)
   - [Inspecting and Handling Errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html#inspecting-and-handling-errors)
2. [Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validations)
   - [`absence`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#absence)
   - [`acceptance`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#acceptance)
   - [`confirmation`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#confirmation)
   - [`comparison`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#comparison)
   - [`format`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#format)
   - [`inclusion` and `exclusion`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#inclusion-and-exclusion)
   - [`length`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#length)
   - [`numericality`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#numericality)
   - [`presence`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#presence)
   - [`uniqueness`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#uniqueness)
   - [`validates_associated`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validates-associated)
   - [`validates_each`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validates-each)
   - [`validates_with`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validates-with)
3. [Validation Options](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validation-options)
   - [`:allow_nil`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#allow-nil)
   - [`:allow_blank`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#allow-blank)
   - [`:message`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#message)
   - [`:on`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#on)
4. [Conditional Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#conditional-validations)
   - [Using a Symbol with `:if` and `:unless`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#using-a-symbol-with-if-and-unless)
   - [Using a Proc with `:if` and `:unless`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#using-a-proc-with-if-and-unless)
   - [Grouping Conditional Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#grouping-conditional-validations)
   - [Combining Validation Conditions](https://guides.rubyonrails.org/v7.2/active_record_validations.html#combining-validation-conditions)
5. [Strict Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#strict-validations)
6. [Listing Validators](https://guides.rubyonrails.org/v7.2/active_record_validations.html#listing-validators)
7. [Performing Custom Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#performing-custom-validations)
   - [Custom Validators](https://guides.rubyonrails.org/v7.2/active_record_validations.html#custom-validators)
   - [Custom Methods](https://guides.rubyonrails.org/v7.2/active_record_validations.html#custom-methods)
   - [Custom Contexts](https://guides.rubyonrails.org/v7.2/active_record_validations.html#custom-contexts)
8. [Working with Validation Errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors)
   - [`errors`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors-errors)
   - [`errors[]`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors-errors)
   - [`errors.where` and Error Object](https://guides.rubyonrails.org/v7.2/active_record_validations.html#errors-where-and-error-object)
   - [`errors.add`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#errors-add)
   - [`errors[:base]`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#errors-base)
   - [`errors.size`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#errors-size)
   - [`errors.clear`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#errors-clear)
9. [Displaying Validation Errors in Views](https://guides.rubyonrails.org/v7.2/active_record_validations.html#displaying-validation-errors-in-views)
   - [Customizing Error Field Wrapper](https://guides.rubyonrails.org/v7.2/active_record_validations.html#customizing-error-field-wrapper)
...
### [1.1 Why Use Validations?](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#why-use-validations-questionmark)
...
### [1.2 Alternate Ways to Validate](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#alternate-ways-to-validate)
...
### [1.3 Validation Triggers](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#validation-triggers)
...
possible to [bypass validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#skipping-validations) and save an object in an
invalid state.

The following methods trigger validations, and will save the object to the
database only if the object is valid:

- [`create`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-create)
- [`create!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-create-21)
- [`save`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-save)
- [`save!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-save-21)
- [`update`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-update)
- [`update!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-update-21)
...
### [1.4 Skipping Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#skipping-validations)
...
- [`insert`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-insert)
- [`insert!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-insert-21)
- [`insert_all`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-insert_all)
- [`insert_all!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-insert_all-21)
- [`toggle!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-toggle-21)
- [`touch`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-touch)
...
- [`update_attribute`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-update_attribute)
- [`update_attribute!`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-update_attribute-21)
...
- [`upsert`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-upsert)
- [`upsert_all`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence/ClassMethods.html#method-i-upsert_all)
- `save(validate: false)`
...
### [1.5 Checking Validity](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#checking-validity)
...
You can also run the validations on your own. [`valid?`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Validations.html#method-i-valid-3F) triggers your
...
through the [`errors`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html#method-i-errors) instance method, which returns a collection of errors.
...
[`invalid?`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html#method-i-invalid-3F) is the inverse of `valid?`. It triggers your validations,
returning true if any errors were found in the object, and false otherwise.

### [1.6 Inspecting and Handling Errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#inspecting-and-handling-errors)

To verify whether or not a particular attribute of an object is valid, you can
use [`errors[:attribute]`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-5B-5D). It returns an array of all
...
[`errors.add`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-add)
...
with Validation Errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors) section.
...
[`ActiveModel::Validations::HelperMethods`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations/HelperMethods.html). This API section uses the older
notation as described above.

Below we outline the most commonly used validations.

### [2.1`absence`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#absence)

This validator validates that the specified attributes are absent. It uses the
[`Object#present?`](https://api.rubyonrails.org/v7.2.3.1/classes/Object.html#method-i-present-3F) method to check if the value is neither nil nor a blank
...
documentation](https://guides.rubyonrails.org/v7.2/association_basics.html#bi-directional-associations).
...
[validates\_associated section](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validates-associated).

If you validate the absence of an object associated via a
[`has_one`](https://guides.rubyonrails.org/v7.2/association_basics.html#the-has-one-association) or
[`has_many`](https://guides.rubyonrails.org/v7.2/association_basics.html#the-has-many-association) relationship, it
...
### [2.2`acceptance`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#acceptance)
...
### [2.3`confirmation`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#confirmation)
...
attribute (we'll take a look at the [`presence`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#presence) check later on in
this guide):
...
validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#conditional-validations) later.
...
### [2.4`comparison`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#comparison)
...
### [2.5`format`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#format)
...
### [2.6`inclusion` and `exclusion`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#inclusion-and-exclusion)
...
[message documentation](https://guides.rubyonrails.org/v7.2/active_record_validations.html#message).
...
#### [2.6.1 Examples](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#examples)
...
### [2.7`length`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#length)
...
### [2.8`numericality`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#numericality)
...
### [2.9`presence`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#presence)

This validator validates that the specified attributes are not empty. It uses
the [`Object#blank?`](https://api.rubyonrails.org/v7.2.3.1/classes/Object.html#method-i-blank-3F) method to check if the value is either `nil` or a blank
...
[below](https://guides.rubyonrails.org/v7.2/active_record_validations.html#validates-associated).
...
### [2.10`uniqueness`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#uniqueness)
...
[`add_index`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_index) statement in a migration and include the `unique: true` option.
...
See [`validates_uniqueness_of`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Validations/ClassMethods.html#method-i-validates_uniqueness_of) for more information.

### [2.11`validates_associated`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#validates-associated)
...
The default error message for [`validates_associated`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Validations/ClassMethods.html#method-i-validates_associated) is _"is invalid"_. Note
that each associated object will contain its own `errors` collection; errors do
not bubble up to the calling model.

[`validates_associated`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Validations/ClassMethods.html#method-i-validates_associated) can only be used with ActiveRecord objects,
everything up until now can also be used on any object which includes
[`ActiveModel::Validations`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html).

### [2.12`validates_each`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#validates-each)
...
attribute passed to [`validates_each`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_each) will be tested against it.
...
### [2.13`validates_with`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#validates-with)
...
We will cover [validation errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors) in greater
detail later.

The [`validates_with`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_with) validator takes a class, or a list of classes to use
for validation.
...
We will cover [custom validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html#performing-custom-validations) more later.

## [3 Validation Options](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#validation-options)

There are several common options supported by the validators. These options are:

- [`:allow_nil`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#allow-nil): Skip validation if the attribute is `nil`.
- [`:allow_blank`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#allow-blank): Skip validation if the attribute is blank.
- [`:message`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#message): Specify a custom error message.
- [`:on`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#on): Specify the contexts where this validation is active.
- [`:strict`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#strict-validations): Raise an exception when the validation
fails.
- [`:if` and `:unless`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#conditional-validations): Specify when the validation
should or should not occur.

Not all of these options are supported by every validator, please refer to
the API documentation for [`ActiveModel::Validations`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html).

### [3.1`:allow_nil`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#allow-nil)
...
documentation](https://guides.rubyonrails.org/v7.2/active_record_validations.html#message).

### [3.2`:allow_blank`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#allow-blank)
...
### [3.3`:message`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#message)
...
guide](https://guides.rubyonrails.org/v7.2/i18n.html#error-message-scopes).

### [3.4`:on`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#on)
...
section](https://guides.rubyonrails.org/v7.2/active_record_validations.html#custom-contexts).
...
### [4.1 Using a Symbol with `:if` and `:unless`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#using-a-symbol-with-if-and-unless)
...
### [4.2 Using a Proc with `:if` and `:unless`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#using-a-proc-with-if-and-unless)
...
### [4.3 Grouping Conditional Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#grouping-conditional-validations)

Sometimes it is useful to have multiple validations use one condition. It can be
easily achieved using [`with_options`](https://api.rubyonrails.org/v7.2.3.1/classes/Object.html#method-i-with_options).
...
### [4.4 Combining Validation Conditions](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#combining-validation-conditions)
...
### [7.1 Custom Validators](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#custom-validators)

Custom validators are classes that inherit from [`ActiveModel::Validator`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validator.html).
...
with the convenient [`ActiveModel::EachValidator`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/EachValidator.html). In this case, the custom
...
### [7.2 Custom Methods](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#custom-methods)
...
methods by using the [`validate`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations/ClassMethods.html#method-i-validate) class method, passing in the symbols for the
...
See the section above for more details about [`:on`](https://guides.rubyonrails.org/v7.2/active_record_validations.html#on).

### [7.3 Custom Contexts](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#custom-contexts)
...
callbacks](https://guides.rubyonrails.org/v7.2/active_record_callbacks.html#skipping-callbacks) altogether, but
...
The [`valid?`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Validations.html#method-i-valid-3F) and [`invalid?`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html#method-i-invalid-3F) methods only provide a summary status on
validity. However you can dig deeper into each individual error by using various
methods from the [`errors`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html#method-i-errors) collection.

The following is a list of the most commonly used methods. Please refer to the
[`ActiveModel::Errors`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html) documentation for a list of all the available methods.

### [8.1`errors`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#working-with-validation-errors-errors)

The [`errors`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Validations.html#method-i-errors) method is the starting point through which you can drill down
into various details of each error.

This returns an instance of the class `ActiveModel::Errors` containing all
errors, each error is represented by an [`ActiveModel::Error`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Error.html) object.
...
### [8.2`errors[]`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#working-with-validation-errors-errors)

[`errors[]`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-5B-5D) is used when you want to check the error
...
### [8.3`errors.where` and Error Object](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#errors-where-and-error-object)
...
[`where`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-where) method is the most common way of access.
...
The [`full_message`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-full_message) method generates a more user-friendly message, with the
capitalized attribute name prepended. (To customize the format that
`full_message` uses, see the [I18n guide](https://guides.rubyonrails.org/v7.2/i18n.html#active-model-methods).)

### [8.4`errors.add`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#errors-add)

The [`add`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-add) method creates the error object by taking the `attribute`, the
...
### [8.5`errors[:base]`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#errors-base)
...
### [8.6`errors.size`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#errors-size)
...
### [8.7`errors.clear`](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#errors-clear)
...
### [9.1 Customizing Error Field Wrapper](https://guides.rubyonrails.org/v7.2/active_record_validations.html\#customizing-error-field-wrapper)
...
field\_error\_proc](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-field-error-proc).
