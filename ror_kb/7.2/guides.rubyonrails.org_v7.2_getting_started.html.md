---
url: "https://guides.rubyonrails.org/v7.2/getting_started.html"
...
01. [Guide Assumptions](https://guides.rubyonrails.org/v7.2/getting_started.html#guide-assumptions)
02. [What is Rails?](https://guides.rubyonrails.org/v7.2/getting_started.html#what-is-rails-questionmark)
03. [Creating a New Rails Project](https://guides.rubyonrails.org/v7.2/getting_started.html#creating-a-new-rails-project)
    - [Installing Rails](https://guides.rubyonrails.org/v7.2/getting_started.html#creating-a-new-rails-project-installing-rails)
    - [Creating the Blog Application](https://guides.rubyonrails.org/v7.2/getting_started.html#creating-the-blog-application)
04. [Hello, Rails!](https://guides.rubyonrails.org/v7.2/getting_started.html#hello-rails-bang)
    - [Starting Up the Web Server](https://guides.rubyonrails.org/v7.2/getting_started.html#starting-up-the-web-server)
    - [Say "Hello", Rails](https://guides.rubyonrails.org/v7.2/getting_started.html#say-hello-rails)
    - [Setting the Application Home Page](https://guides.rubyonrails.org/v7.2/getting_started.html#setting-the-application-home-page)
05. [Autoloading](https://guides.rubyonrails.org/v7.2/getting_started.html#autoloading)
06. [MVC and You](https://guides.rubyonrails.org/v7.2/getting_started.html#mvc-and-you)
    - [Generating a Model](https://guides.rubyonrails.org/v7.2/getting_started.html#mvc-and-you-generating-a-model)
    - [Database Migrations](https://guides.rubyonrails.org/v7.2/getting_started.html#database-migrations)
    - [Using a Model to Interact with the Database](https://guides.rubyonrails.org/v7.2/getting_started.html#using-a-model-to-interact-with-the-database)
    - [Showing a List of Articles](https://guides.rubyonrails.org/v7.2/getting_started.html#showing-a-list-of-articles)
07. [CRUDit Where CRUDit Is Due](https://guides.rubyonrails.org/v7.2/getting_started.html#crudit-where-crudit-is-due)
    - [Showing a Single Article](https://guides.rubyonrails.org/v7.2/getting_started.html#showing-a-single-article)
    - [Resourceful Routing](https://guides.rubyonrails.org/v7.2/getting_started.html#resourceful-routing)
    - [Creating a New Article](https://guides.rubyonrails.org/v7.2/getting_started.html#creating-a-new-article)
    - [Updating an Article](https://guides.rubyonrails.org/v7.2/getting_started.html#updating-an-article)
    - [Deleting an Article](https://guides.rubyonrails.org/v7.2/getting_started.html#deleting-an-article)
08. [Adding a Second Model](https://guides.rubyonrails.org/v7.2/getting_started.html#adding-a-second-model)
    - [Generating a Model](https://guides.rubyonrails.org/v7.2/getting_started.html#adding-a-second-model-generating-a-model)
    - [Associating Models](https://guides.rubyonrails.org/v7.2/getting_started.html#associating-models)
    - [Adding a Route for Comments](https://guides.rubyonrails.org/v7.2/getting_started.html#adding-a-route-for-comments)
    - [Generating a Controller](https://guides.rubyonrails.org/v7.2/getting_started.html#generating-a-controller)
09. [Refactoring](https://guides.rubyonrails.org/v7.2/getting_started.html#refactoring)
    - [Rendering Partial Collections](https://guides.rubyonrails.org/v7.2/getting_started.html#rendering-partial-collections)
    - [Rendering a Partial Form](https://guides.rubyonrails.org/v7.2/getting_started.html#rendering-a-partial-form)
    - [Using Concerns](https://guides.rubyonrails.org/v7.2/getting_started.html#using-concerns)
10. [Deleting Comments](https://guides.rubyonrails.org/v7.2/getting_started.html#deleting-comments)
    - [Deleting Associated Objects](https://guides.rubyonrails.org/v7.2/getting_started.html#deleting-associated-objects)
11. [Security](https://guides.rubyonrails.org/v7.2/getting_started.html#security)
    - [Basic Authentication](https://guides.rubyonrails.org/v7.2/getting_started.html#basic-authentication)
    - [Other Security Considerations](https://guides.rubyonrails.org/v7.2/getting_started.html#other-security-considerations)
12. [What's Next?](https://guides.rubyonrails.org/v7.2/getting_started.html#what-s-next-questionmark)
13. [Configuration Gotchas](https://guides.rubyonrails.org/v7.2/getting_started.html#configuration-gotchas)

* * *

## [1 Guide Assumptions](https://guides.rubyonrails.org/v7.2/getting_started.html\#guide-assumptions)
...
## [2 What is Rails?](https://guides.rubyonrails.org/v7.2/getting_started.html\#what-is-rails-questionmark)
...
## [3 Creating a New Rails Project](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-a-new-rails-project)

You can create new Rails apps with a preconfigured Dev Container development environment. This
is the fastest way to get started with Rails.
For instructions see [Getting Started with Dev Containers](https://guides.rubyonrails.org/v7.2/getting_started_with_devcontainer.html)
...
### [3.1 Installing Rails](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-a-new-rails-project-installing-rails)
...
#### [3.1.1 Installing Ruby](https://guides.rubyonrails.org/v7.2/getting_started.html\#installing-ruby)
...
#### [3.1.2 Installing SQLite3](https://guides.rubyonrails.org/v7.2/getting_started.html\#installing-sqlite3)
...
#### [3.1.3 Installing Rails](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-a-new-rails-project-installing-rails-installing-rails)
...
### [3.2 Creating the Blog Application](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-the-blog-application)
...
| config/ | Contains configuration for your application's routes, database, and more. This is covered in more detail in [Configuring Rails Applications](https://guides.rubyonrails.org/v7.2/configuring.html). |
...
| storage/ | Active Storage files for Disk Service. This is covered in [Active Storage Overview](https://guides.rubyonrails.org/v7.2/active_storage_overview.html). |
| test/ | Unit tests, fixtures, and other test apparatus. These are covered in [Testing Rails Applications](https://guides.rubyonrails.org/v7.2/testing.html). |
...
## [4 Hello, Rails!](https://guides.rubyonrails.org/v7.2/getting_started.html\#hello-rails-bang)

To begin with, let's get some text up on screen quickly. To do this, you need to
get your Rails application server running.

### [4.1 Starting Up the Web Server](https://guides.rubyonrails.org/v7.2/getting_started.html\#starting-up-the-web-server)
...
JavaScript asset compression requires you to
...
![Rails startup page screenshot](https://guides.rubyonrails.org/v7.2/images/getting_started/rails_welcome.png)
...
### [4.2 Say "Hello", Rails](https://guides.rubyonrails.org/v7.2/getting_started.html\#say-hello-rails)
...
### [4.3 Setting the Application Home Page](https://guides.rubyonrails.org/v7.2/getting_started.html\#setting-the-application-home-page)

At the moment, [http://localhost:3000](http://localhost:3000/) still displays a page with the Ruby on Rails logo.
...
To learn more about routing, see [Rails Routing from the Outside In](https://guides.rubyonrails.org/v7.2/routing.html).

## [5 Autoloading](https://guides.rubyonrails.org/v7.2/getting_started.html\#autoloading)
...
## [6 MVC and You](https://guides.rubyonrails.org/v7.2/getting_started.html\#mvc-and-you)
...
### [6.1 Generating a Model](https://guides.rubyonrails.org/v7.2/getting_started.html\#mvc-and-you-generating-a-model)
...
### [6.2 Database Migrations](https://guides.rubyonrails.org/v7.2/getting_started.html\#database-migrations)
...
To learn more about migrations, see [Active Record Migrations](https://guides.rubyonrails.org/v7.2/active_record_migrations.html).

Now we can interact with the table using our model.

### [6.3 Using a Model to Interact with the Database](https://guides.rubyonrails.org/v7.2/getting_started.html\#using-a-model-to-interact-with-the-database)
...
moment. To save the object to the database, we must call [`save`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-save):
...
When we want to fetch this article from the database, we can call [`find`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/FinderMethods.html#method-i-find)
...
And when we want to fetch all articles from the database, we can call [`all`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Scoping/Named/ClassMethods.html#method-i-all)
on the model:
...
This method returns an [`ActiveRecord::Relation`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Relation.html) object, which
you can think of as a super-powered array.

To learn more about models, see [Active Record Basics](https://guides.rubyonrails.org/v7.2/active_record_basics.html) and [Active Record Query Interface](https://guides.rubyonrails.org/v7.2/active_record_querying.html).

Models are the final piece of the MVC puzzle. Next, we will connect all of the
pieces together.

### [6.4 Showing a List of Articles](https://guides.rubyonrails.org/v7.2/getting_started.html\#showing-a-list-of-articles)
...
## [7 CRUDit Where CRUDit Is Due](https://guides.rubyonrails.org/v7.2/getting_started.html\#crudit-where-crudit-is-due)
...
### [7.1 Showing a Single Article](https://guides.rubyonrails.org/v7.2/getting_started.html\#showing-a-single-article)
...
previously](https://guides.rubyonrails.org/v7.2/getting_started.html#using-a-model-to-interact-with-the-database)) with the ID captured
...
### [7.2 Resourceful Routing](https://guides.rubyonrails.org/v7.2/getting_started.html\#resourceful-routing)
...
Rails provides a routes method named [`resources`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionDispatch/Routing/Mapper/Resources.html#method-i-resources)
...
However, we will take this one step further by using the [`link_to`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/UrlHelper.html#method-i-link_to)
...
### [7.3 Creating a New Article](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-a-new-article)
...
[`redirect_to`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Redirecting.html#method-i-redirect_to)
will cause the browser to make a new request,
whereas [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/AbstractController/Rendering.html#method-i-render)
...
#### [7.3.1 Using a Form Builder](https://guides.rubyonrails.org/v7.2/getting_started.html\#using-a-form-builder)
...
The [`form_with`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormHelper.html#method-i-form_with)
helper method instantiates a form builder. In the `form_with` block we call
methods like [`label`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormBuilder.html#method-i-label)
and [`text_field`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormBuilder.html#method-i-text_field)
...
To learn more about form builders, see [Action View Form Helpers](https://guides.rubyonrails.org/v7.2/form_helpers.html).

#### [7.3.2 Using Strong Parameters](https://guides.rubyonrails.org/v7.2/getting_started.html\#using-strong-parameters)
...
Strong Parameters](https://guides.rubyonrails.org/v7.2/action_controller_overview.html#strong-parameters).

#### [7.3.3 Validations and Displaying Error Messages](https://guides.rubyonrails.org/v7.2/getting_started.html\#validations-and-displaying-error-messages)
...
The [`full_messages_for`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Errors.html#method-i-full_messages_for)
...
To learn more about validations, see [Active Record Validations](https://guides.rubyonrails.org/v7.2/active_record_validations.html). To learn more about validation error messages,
see [Active Record Validations § Working with Validation Errors](https://guides.rubyonrails.org/v7.2/active_record_validations.html#working-with-validation-errors).

#### [7.3.4 Finishing Up](https://guides.rubyonrails.org/v7.2/getting_started.html\#creating-a-new-article-finishing-up)
...
### [7.4 Updating an Article](https://guides.rubyonrails.org/v7.2/getting_started.html\#updating-an-article)
...
#### [7.4.1 Using Partials to Share View Code](https://guides.rubyonrails.org/v7.2/getting_started.html\#using-partials-to-share-view-code)
...
Let's update `app/views/articles/new.html.erb` to use the partial via [`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/RenderingHelper.html#method-i-render):
...
Partials](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html#using-partials).

#### [7.4.2 Finishing Up](https://guides.rubyonrails.org/v7.2/getting_started.html\#updating-an-article-finishing-up)
...
### [7.5 Deleting an Article](https://guides.rubyonrails.org/v7.2/getting_started.html\#deleting-an-article)
...
The `destroy` action fetches the article from the database, and calls [`destroy`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Persistence.html#method-i-destroy)
...
## [8 Adding a Second Model](https://guides.rubyonrails.org/v7.2/getting_started.html\#adding-a-second-model)

It's time to add a second model to the application. The second model will handle
comments on articles.

### [8.1 Generating a Model](https://guides.rubyonrails.org/v7.2/getting_started.html\#adding-a-second-model-generating-a-model)
...
| File | Purpose |
| --- | --- |
| db/migrate/<timestamp>\_create\_comments.rb | Migration to create the comments table in your database |
...
### [8.2 Associating Models](https://guides.rubyonrails.org/v7.2/getting_started.html\#associating-models)
...
Associations](https://guides.rubyonrails.org/v7.2/association_basics.html) guide.

### [8.3 Adding a Route for Comments](https://guides.rubyonrails.org/v7.2/getting_started.html\#adding-a-route-for-comments)
...
For more information on routing, see the [Rails Routing](https://guides.rubyonrails.org/v7.2/routing.html)
guide.

### [8.4 Generating a Controller](https://guides.rubyonrails.org/v7.2/getting_started.html\#generating-a-controller)
...
![Article with Comments](https://guides.rubyonrails.org/v7.2/images/getting_started/article_with_comments.png)

## [9 Refactoring](https://guides.rubyonrails.org/v7.2/getting_started.html\#refactoring)

Now that we have articles and comments working, take a look at the
`app/views/articles/show.html.erb` template. It is getting long and awkward. We
can use partials to clean it up.

### [9.1 Rendering Partial Collections](https://guides.rubyonrails.org/v7.2/getting_started.html\#rendering-partial-collections)
...
### [9.2 Rendering a Partial Form](https://guides.rubyonrails.org/v7.2/getting_started.html\#rendering-a-partial-form)
...
### [9.3 Using Concerns](https://guides.rubyonrails.org/v7.2/getting_started.html\#using-concerns)
...
We can add our status validation to the concern, but this is slightly more complex as validations are methods called at the class level. The `ActiveSupport::Concern` ( [API Guide](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Concern.html)) gives us a simpler way to include them:
...
### [10.1 Deleting Associated Objects](https://guides.rubyonrails.org/v7.2/getting_started.html\#deleting-associated-objects)
...
### [11.1 Basic Authentication](https://guides.rubyonrails.org/v7.2/getting_started.html\#basic-authentication)
...
![Basic HTTP Authentication Challenge](https://guides.rubyonrails.org/v7.2/images/getting_started/challenge.png)
...
### [11.2 Other Security Considerations](https://guides.rubyonrails.org/v7.2/getting_started.html\#other-security-considerations)

Security, especially in web applications, is a broad and detailed area. Security
in your Rails application is covered in more depth in
the [Ruby on Rails Security Guide](https://guides.rubyonrails.org/v7.2/security.html).
...
- The [Ruby on Rails Guides](https://guides.rubyonrails.org/v7.2/index.html)
