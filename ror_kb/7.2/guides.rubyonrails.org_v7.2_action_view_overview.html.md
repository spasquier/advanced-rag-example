---
url: "https://guides.rubyonrails.org/v7.2/action_view_overview.html"
title: "Action View Overview — Ruby on Rails Guides"
---
...
1. [What is Action View?](https://guides.rubyonrails.org/v7.2/action_view_overview.html#what-is-action-view-questionmark)
2. [Using Action View with Rails](https://guides.rubyonrails.org/v7.2/action_view_overview.html#using-action-view-with-rails)
3. [Templates](https://guides.rubyonrails.org/v7.2/action_view_overview.html#templates)
   - [ERB](https://guides.rubyonrails.org/v7.2/action_view_overview.html#erb)
   - [Jbuilder](https://guides.rubyonrails.org/v7.2/action_view_overview.html#jbuilder)
   - [Builder](https://guides.rubyonrails.org/v7.2/action_view_overview.html#builder)
   - [Template Compilation](https://guides.rubyonrails.org/v7.2/action_view_overview.html#template-compilation)
4. [Partials](https://guides.rubyonrails.org/v7.2/action_view_overview.html#partials)
   - [Rendering Partials](https://guides.rubyonrails.org/v7.2/action_view_overview.html#rendering-partials)
   - [Using Partials to Simplify Views](https://guides.rubyonrails.org/v7.2/action_view_overview.html#using-partials-to-simplify-views)
   - [Passing Data to Partials with `locals` Option](https://guides.rubyonrails.org/v7.2/action_view_overview.html#passing-data-to-partials-with-locals-option)
   - [Using `local_assigns`](https://guides.rubyonrails.org/v7.2/action_view_overview.html#using-local-assigns)
   - [`render` without `partial` and `locals` Options](https://guides.rubyonrails.org/v7.2/action_view_overview.html#render-without-partial-and-locals-options)
   - [The `as` and `object` Options](https://guides.rubyonrails.org/v7.2/action_view_overview.html#the-as-and-object-options)
   - [Rendering Collections](https://guides.rubyonrails.org/v7.2/action_view_overview.html#rendering-collections)
   - [Spacer Templates](https://guides.rubyonrails.org/v7.2/action_view_overview.html#spacer-templates)
   - [Counter Variables](https://guides.rubyonrails.org/v7.2/action_view_overview.html#counter-variables)
   - [`local_assigns` with Pattern Matching](https://guides.rubyonrails.org/v7.2/action_view_overview.html#local-assigns-with-pattern-matching)
   - [Strict Locals](https://guides.rubyonrails.org/v7.2/action_view_overview.html#strict-locals)
5. [Layouts](https://guides.rubyonrails.org/v7.2/action_view_overview.html#layouts)
   - [Partial Layouts](https://guides.rubyonrails.org/v7.2/action_view_overview.html#partial-layouts)
   - [Collection with Partial Layouts](https://guides.rubyonrails.org/v7.2/action_view_overview.html#collection-with-partial-layouts)
6. [Helpers](https://guides.rubyonrails.org/v7.2/action_view_overview.html#helpers)
7. [Localized Views](https://guides.rubyonrails.org/v7.2/action_view_overview.html#localized-views)
...
[Action Controller](https://guides.rubyonrails.org/v7.2/action_controller_overview.html) and Action View work
...
Action View provides many [helper](https://guides.rubyonrails.org/v7.2/action_view_overview.html#helpers) methods for dynamically generating
...
[`to_param`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Conversion.html#method-i-to_param)
and
[`to_partial_path`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Conversion.html#method-i-to_partial_path)
...
### [3.1 ERB](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#erb)
...
### [3.2 Jbuilder](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#jbuilder)
...
### [3.3 Builder](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#builder)
...
### [3.4 Template Compilation](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#template-compilation)
...
guide](https://guides.rubyonrails.org/v7.2/caching_with_rails.html#fragment-caching).
...
### [4.1 Rendering Partials](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#rendering-partials)

To render a partial as part of a view, you use the
[`render`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/RenderingHelper.html#method-i-render)
...
### [4.2 Using Partials to Simplify Views](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#using-partials-to-simplify-views)
...
### [4.3 Passing Data to Partials with `locals` Option](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#passing-data-to-partials-with-locals-option)
...
However, if a template refers to a variable that _isn't_ passed into the view as
...
### [4.4 Using `local_assigns`](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#using-local-assigns)

Each partial has a method called [local\_assigns](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Template.html#method-i-local_assigns) available. You can use this
...
### [4.5`render` without `partial` and `locals` Options](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#render-without-partial-and-locals-options)
...
### [4.6 The `as` and `object` Options](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#the-as-and-object-options)
...
### [4.7 Rendering Collections](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#rendering-collections)
...
### [4.8 Spacer Templates](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#spacer-templates)
...
### [4.9 Counter Variables](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#counter-variables)
...
Note: The following two sections, [Strict Locals](https://guides.rubyonrails.org/v7.2/action_view_overview.html#strict-locals) and [Local\\
Assigns with Pattern Matching](https://guides.rubyonrails.org/v7.2/action_view_overview.html#local-assigns-with-pattern-matching) are more
advanced features of using partials, included here for completeness.

### [4.10`local_assigns` with Pattern Matching](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#local-assigns-with-pattern-matching)
...
[Hash#with\_defaults](https://api.rubyonrails.org/v7.2.3.1/classes/Hash.html#method-i-with_defaults)
...
By default, partials will accept any `locals` as keyword arguments. To
define what `locals` a partial accepts, use a `locals:` magic comment. To learn
more, read about [Strict Locals](https://guides.rubyonrails.org/v7.2/action_view_overview.html#strict-locals).

### [4.11 Strict Locals](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#strict-locals)
...
Rendering the partial with _any_ local variable arguments will raise an
exception:
...
Rendering in Rails](https://guides.rubyonrails.org/v7.2/layouts_and_rendering.html) guide.

### [5.1 Partial Layouts](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#partial-layouts)
...
### [5.2 Collection with Partial Layouts](https://guides.rubyonrails.org/v7.2/action_view_overview.html\#collection-with-partial-layouts)
...
collection. The current object and object\_counter variables, `article` and
...
Guide](https://guides.rubyonrails.org/v7.2/action_view_helpers.html) and the [Action View Form Helpers\\
Guide](https://guides.rubyonrails.org/v7.2/form_helpers.html).
...
See the [Rails Internationalization (I18n) API documentation](https://guides.rubyonrails.org/v7.2/i18n.html) for
more details.
