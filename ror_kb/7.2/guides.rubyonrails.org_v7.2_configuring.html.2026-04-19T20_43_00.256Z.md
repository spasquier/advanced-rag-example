...
01. [Locations for Initialization Code](https://guides.rubyonrails.org/v7.2/configuring.html#locations-for-initialization-code)
02. [Running Code Before Rails](https://guides.rubyonrails.org/v7.2/configuring.html#running-code-before-rails)
03. [Configuring Rails Components](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-rails-components)
    - [Versioned Default Values](https://guides.rubyonrails.org/v7.2/configuring.html#versioned-default-values)
    - [Rails General Configuration](https://guides.rubyonrails.org/v7.2/configuring.html#rails-general-configuration)
    - [Configuring Assets](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-assets)
    - [Configuring Generators](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-generators)
    - [Configuring Middleware](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-middleware)
    - [Configuring i18n](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-i18n)
    - [Configuring Active Model](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-active-model)
    - [Configuring Active Record](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-active-record)
    - [Configuring Action Controller](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-controller)
    - [Configuring Action Dispatch](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-dispatch)
    - [Configuring Action View](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-view)
    - [Configuring Action Mailbox](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-mailbox)
    - [Configuring Action Mailer](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-mailer)
    - [Configuring Active Support](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-active-support)
    - [Configuring Active Job](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-active-job)
    - [Configuring Action Cable](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-cable)
    - [Configuring Active Storage](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-active-storage)
    - [Configuring Action Text](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-action-text)
    - [Configuring a Database](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-a-database)
    - [Connection Preference](https://guides.rubyonrails.org/v7.2/configuring.html#connection-preference)
    - [Creating Rails Environments](https://guides.rubyonrails.org/v7.2/configuring.html#creating-rails-environments)
    - [Deploy to a Subdirectory (relative URL root)](https://guides.rubyonrails.org/v7.2/configuring.html#deploy-to-a-subdirectory-relative-url-root)
04. [Rails Environment Settings](https://guides.rubyonrails.org/v7.2/configuring.html#rails-environment-settings)
05. [Using Initializer Files](https://guides.rubyonrails.org/v7.2/configuring.html#using-initializer-files)
06. [Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html#load-hooks)
    - [Avoid Loading Rails Frameworks](https://guides.rubyonrails.org/v7.2/configuring.html#avoid-loading-rails-frameworks)
    - [When are Hooks called?](https://guides.rubyonrails.org/v7.2/configuring.html#when-are-hooks-called-questionmark)
    - [Modifying Code to Use Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html#modifying-code-to-use-load-hooks)
    - [Available Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html#available-load-hooks)
07. [Initialization Events](https://guides.rubyonrails.org/v7.2/configuring.html#initialization-events)
    - [`Rails::Railtie#initializer`](https://guides.rubyonrails.org/v7.2/configuring.html#rails-railtie-initializer)
    - [Initializers](https://guides.rubyonrails.org/v7.2/configuring.html#initializers)
08. [Database Pooling](https://guides.rubyonrails.org/v7.2/configuring.html#database-pooling)
09. [Custom Configuration](https://guides.rubyonrails.org/v7.2/configuring.html#custom-configuration)
10. [Search Engines Indexing](https://guides.rubyonrails.org/v7.2/configuring.html#search-engines-indexing)

* * *

## [1 Locations for Initialization Code](https://guides.rubyonrails.org/v7.2/configuring.html\#locations-for-initialization-code)
...
## [2 Running Code Before Rails](https://guides.rubyonrails.org/v7.2/configuring.html\#running-code-before-rails)

In the rare event that your application needs to run some code before Rails itself is loaded, put it above the call to `require "rails/all"` in `config/application.rb`.

## [3 Configuring Rails Components](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-rails-components)
...
If you need to apply configuration directly to a class, use a [lazy load hook](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/LazyLoadHooks.html) in an initializer to avoid autoloading the class before initialization has completed. This will break because autoloading during initialization cannot be safely repeated when the app reloads.

### [3.1 Versioned Default Values](https://guides.rubyonrails.org/v7.2/configuring.html\#versioned-default-values)

[`config.load_defaults`](https://api.rubyonrails.org/v7.2.3.1/classes/Rails/Application/Configuration.html#method-i-load_defaults) loads default configuration values for a target version and all versions prior. For example, `config.load_defaults 6.1` will load defaults for all versions up to and including version 6.1.
...
#### [3.1.1 Default Values for Target Version 7.2](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-7-2)

- [`config.active_job.enqueue_after_transaction_commit`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-enqueue-after-transaction-commit): `:default`
- [`config.active_record.postgresql_adapter_decode_dates`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-postgresql-adapter-decode-dates): `true`
- [`config.active_record.validate_migration_timestamps`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-validate-migration-timestamps): `true`
- [`config.active_storage.web_image_content_types`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-web-image-content-types): `%w[image/png image/jpeg image/gif image/webp]`
- [`config.yjit`](https://guides.rubyonrails.org/v7.2/configuring.html#config-yjit): `true`

#### [3.1.2 Default Values for Target Version 7.1](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-7-1)

- [`config.action_dispatch.debug_exception_log_level`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-debug-exception-log-level): `:error`
- [`config.action_dispatch.default_headers`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-default-headers): `{ "X-Frame-Options" => "SAMEORIGIN", "X-XSS-Protection" => "0", "X-Content-Type-Options" => "nosniff", "X-Permitted-Cross-Domain-Policies" => "none", "Referrer-Policy" => "strict-origin-when-cross-origin" }`
- [`config.action_text.sanitizer_vendor`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-text-sanitizer-vendor): `Rails::HTML::Sanitizer.best_supported_vendor`
- [`config.action_view.sanitizer_vendor`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-sanitizer-vendor): `Rails::HTML::Sanitizer.best_supported_vendor`
- [`config.active_record.before_committed_on_all_records`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-before-committed-on-all-records): `true`
- [`config.active_record.belongs_to_required_validates_foreign_key`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-belongs-to-required-validates-foreign-key): `false`
- [`config.active_record.default_column_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-default-column-serializer): `nil`
- [`config.active_record.encryption.hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-encryption-hash-digest-class): `OpenSSL::Digest::SHA256`
- [`config.active_record.encryption.support_sha1_for_non_deterministic_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-encryption-support-sha1-for-non-deterministic-encryption): `false`
- [`config.active_record.generate_secure_token_on`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-generate-secure-token-on): `:initialize`
- [`config.active_record.marshalling_format_version`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-marshalling-format-version): `7.1`
- [`config.active_record.query_log_tags_format`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-query-log-tags-format): `:sqlcommenter`
- [`config.active_record.raise_on_assign_to_attr_readonly`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-raise-on-assign-to-attr-readonly): `true`
- [`config.active_record.run_after_transaction_callbacks_in_order_defined`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-run-after-transaction-callbacks-in-order-defined): `true`
- [`config.active_record.run_commit_callbacks_on_first_saved_instances_in_transaction`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-run-commit-callbacks-on-first-saved-instances-in-transaction): `false`
- [`config.active_record.sqlite3_adapter_strict_strings_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-sqlite3-adapter-strict-strings-by-default): `true`
- [`config.active_support.cache_format_version`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-cache-format-version): `7.1`
- [`config.active_support.message_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-message-serializer): `:json_allow_marshal`
- [`config.active_support.raise_on_invalid_cache_expiration_time`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-raise-on-invalid-cache-expiration-time): `true`
- [`config.active_support.use_message_serializer_for_metadata`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-use-message-serializer-for-metadata): `true`
- [`config.add_autoload_paths_to_load_path`](https://guides.rubyonrails.org/v7.2/configuring.html#config-add-autoload-paths-to-load-path): `false`
- [`config.dom_testing_default_html_version`](https://guides.rubyonrails.org/v7.2/configuring.html#config-dom-testing-default-html-version): `defined?(Nokogiri::HTML5) ? :html5 : :html4`
- [`config.log_file_size`](https://guides.rubyonrails.org/v7.2/configuring.html#config-log-file-size): `100 * 1024 * 1024`
- [`config.precompile_filter_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html#config-precompile-filter-parameters): `true`

#### [3.1.3 Default Values for Target Version 7.0](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-7-0)

- [`config.action_controller.raise_on_open_redirects`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-raise-on-open-redirects): `true`
- [`config.action_controller.wrap_parameters_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-wrap-parameters-by-default): `true`
- [`config.action_dispatch.cookies_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-cookies-serializer): `:json`
- [`config.action_dispatch.default_headers`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-default-headers): `{ "X-Frame-Options" => "SAMEORIGIN", "X-XSS-Protection" => "0", "X-Content-Type-Options" => "nosniff", "X-Download-Options" => "noopen", "X-Permitted-Cross-Domain-Policies" => "none", "Referrer-Policy" => "strict-origin-when-cross-origin" }`
- [`config.action_mailer.smtp_timeout`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailer-smtp-timeout): `5`
- [`config.action_view.apply_stylesheet_media_default`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-apply-stylesheet-media-default): `false`
- [`config.action_view.button_to_generates_button_tag`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-button-to-generates-button-tag): `true`
- [`config.active_record.automatic_scope_inversing`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-automatic-scope-inversing): `true`
- [`config.active_record.partial_inserts`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-partial-inserts): `false`
- [`config.active_record.verify_foreign_keys_for_fixtures`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-verify-foreign-keys-for-fixtures): `true`
- [`config.active_storage.multiple_file_field_include_hidden`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-multiple-file-field-include-hidden): `true`
- [`config.active_storage.variant_processor`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-variant-processor): `:vips`
- [`config.active_storage.video_preview_arguments`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-video-preview-arguments): `"-vf 'select=eq(n\\,0)+eq(key\\,1)+gt(scene\\,0.015),loop=loop=-1:size=2,trim=start_frame=1' -frames:v 1 -f image2"`
- [`config.active_support.cache_format_version`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-cache-format-version): `7.0`
- [`config.active_support.executor_around_test_case`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-executor-around-test-case): `true`
- [`config.active_support.hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-hash-digest-class): `OpenSSL::Digest::SHA256`
- [`config.active_support.key_generator_hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-key-generator-hash-digest-class): `OpenSSL::Digest::SHA256`

#### [3.1.4 Default Values for Target Version 6.1](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-6-1)

- [`ActiveSupport.utc_to_local_returns_utc_offset_times`](https://guides.rubyonrails.org/v7.2/configuring.html#activesupport-utc-to-local-returns-utc-offset-times): `true`
- [`config.action_dispatch.cookies_same_site_protection`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-cookies-same-site-protection): `:lax`
- [`config.action_dispatch.ssl_default_redirect_status`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-ssl-default-redirect-status): `308`
- [`config.action_mailbox.queues.incineration`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailbox-queues-incineration): `nil`
- [`config.action_mailbox.queues.routing`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailbox-queues-routing): `nil`
- [`config.action_mailer.deliver_later_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailer-deliver-later-queue-name): `nil`
- [`config.action_view.form_with_generates_remote_forms`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-form-with-generates-remote-forms): `false`
- [`config.action_view.preload_links_header`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-preload-links-header): `true`
- [`config.active_job.retry_jitter`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-retry-jitter): `0.15`
- [`config.active_record.has_many_inversing`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-has-many-inversing): `true`
- [`config.active_storage.queues.analysis`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-queues-analysis): `nil`
- [`config.active_storage.queues.purge`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-queues-purge): `nil`
- [`config.active_storage.track_variants`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-track-variants): `true`

#### [3.1.5 Default Values for Target Version 6.0](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-6-0)

- [`config.action_dispatch.use_cookies_with_metadata`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-use-cookies-with-metadata): `true`
- [`config.action_mailer.delivery_job`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-mailer-delivery-job): `"ActionMailer::MailDeliveryJob"`
- [`config.action_view.default_enforce_utf8`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-default-enforce-utf8): `false`
- [`config.active_record.collection_cache_versioning`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-collection-cache-versioning): `true`
- [`config.active_storage.queues.analysis`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-queues-analysis): `:active_storage_analysis`
- [`config.active_storage.queues.purge`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-storage-queues-purge): `:active_storage_purge`

#### [3.1.6 Default Values for Target Version 5.2](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-5-2)

- [`config.action_controller.default_protect_from_forgery`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-default-protect-from-forgery): `true`
- [`config.action_dispatch.use_authenticated_cookie_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-use-authenticated-cookie-encryption): `true`
- [`config.action_view.form_with_generates_ids`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-form-with-generates-ids): `true`
- [`config.active_record.cache_versioning`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-cache-versioning): `true`
- [`config.active_support.hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-hash-digest-class): `OpenSSL::Digest::SHA1`
- [`config.active_support.use_authenticated_message_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-use-authenticated-message-encryption): `true`

#### [3.1.7 Default Values for Target Version 5.1](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-5-1)

- [`config.action_view.form_with_generates_remote_forms`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-view-form-with-generates-remote-forms): `true`
- [`config.assets.unknown_asset_fallback`](https://guides.rubyonrails.org/v7.2/configuring.html#config-assets-unknown-asset-fallback): `false`

#### [3.1.8 Default Values for Target Version 5.0](https://guides.rubyonrails.org/v7.2/configuring.html\#default-values-for-target-version-5-0)

- [`ActiveSupport.to_time_preserves_timezone`](https://guides.rubyonrails.org/v7.2/configuring.html#activesupport-to-time-preserves-timezone): `true`
- [`config.action_controller.forgery_protection_origin_check`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-forgery-protection-origin-check): `true`
- [`config.action_controller.per_form_csrf_tokens`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-controller-per-form-csrf-tokens): `true`
- [`config.active_record.belongs_to_required_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-belongs-to-required-by-default): `true`
- [`config.ssl_options`](https://guides.rubyonrails.org/v7.2/configuring.html#config-ssl-options): `{ hsts: { subdomains: true } }`

### [3.2 Rails General Configuration](https://guides.rubyonrails.org/v7.2/configuring.html\#rails-general-configuration)
...
#### [3.2.1`config.add_autoload_paths_to_load_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-add-autoload-paths-to-load-path)
...
#### [3.2.2`config.after_initialize`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-after-initialize)
...
#### [3.2.3`config.after_routes_loaded`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-after-routes-loaded)
...
#### [3.2.4`config.allow_concurrency`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-allow-concurrency)
...
#### [3.2.5`config.asset_host`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-asset-host)
...
#### [3.2.6`config.assume_ssl`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assume-ssl)
...
#### [3.2.7`config.autoflush_log`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-autoflush-log)

Enables writing log file output immediately instead of buffering. Defaults to
`true`.

#### [3.2.8`config.autoload_lib(ignore:)`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-autoload-lib-ignore)
...
Please, see more details in the [autoloading guide](https://guides.rubyonrails.org/v7.2/autoloading_and_reloading_constants.html).

#### [3.2.9`config.autoload_lib_once(ignore:)`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-autoload-lib-once-ignore)
...
#### [3.2.10`config.autoload_once_paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-autoload-once-paths)
...
#### [3.2.11`config.autoload_paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-autoload-paths)

Accepts an array of paths from which Rails will autoload constants. Default is an empty array. Since [Rails 6](https://guides.rubyonrails.org/v7.2/upgrading_ruby_on_rails.html#autoloading), it is not recommended to adjust this. See [Autoloading and Reloading Constants](https://guides.rubyonrails.org/v7.2/autoloading_and_reloading_constants.html#autoload-paths).

#### [3.2.12`config.beginning_of_week`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-beginning-of-week)

Sets the default beginning of week for the
application. Accepts a valid day of week as a symbol (e.g. `:monday`).

#### [3.2.13`config.cache_classes`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-cache-classes)

Old setting equivalent to `!config.enable_reloading`. Supported for backwards compatibility.

#### [3.2.14`config.cache_store`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-cache-store)
...
#### [3.2.15`config.colorize_logging`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-colorize-logging)

Specifies whether or not to use ANSI color codes when logging information. Defaults to `true`.

#### [3.2.16`config.consider_all_requests_local`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-consider-all-requests-local)
...
#### [3.2.17`config.console`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-console)
...
#### [3.2.18`config.content_security_policy_nonce_directives`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-content-security-policy-nonce-directives)

See [Adding a Nonce](https://guides.rubyonrails.org/v7.2/security.html#adding-a-nonce) in the Security Guide

#### [3.2.19`config.content_security_policy_nonce_generator`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-content-security-policy-nonce-generator)

See [Adding a Nonce](https://guides.rubyonrails.org/v7.2/security.html#adding-a-nonce) in the Security Guide

#### [3.2.20`config.content_security_policy_report_only`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-content-security-policy-report-only)

See [Reporting Violations](https://guides.rubyonrails.org/v7.2/security.html#reporting-violations) in the Security
Guide

#### [3.2.21`config.credentials.content_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-credentials-content-path)
...
#### [3.2.22`config.credentials.key_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-credentials-key-path)
...
#### [3.2.23`config.debug_exception_response_format`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-debug-exception-response-format)
...
#### [3.2.24`config.disable_sandbox`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-disable-sandbox)
...
#### [3.2.25`config.dom_testing_default_html_version`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-dom-testing-default-html-version)
...
#### [3.2.26`config.eager_load`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-eager-load)
...
#### [3.2.27`config.eager_load_namespaces`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-eager-load-namespaces)
...
#### [3.2.28`config.eager_load_paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-eager-load-paths)
...
#### [3.2.29`config.enable_reloading`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-enable-reloading)
...
#### [3.2.30`config.encoding`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-encoding)

Sets up the application-wide encoding. Defaults to UTF-8.

#### [3.2.31`config.exceptions_app`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-exceptions-app)
...
#### [3.2.32`config.file_watcher`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-file-watcher)
...
#### [3.2.33`config.filter_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-filter-parameters)
...
#### [3.2.34`config.filter_redirect`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-filter-redirect)
...
#### [3.2.35`config.force_ssl`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-force-ssl)
...
#### [3.2.36`config.helpers_paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-helpers-paths)

Defines an array of additional paths to load view helpers.

#### [3.2.37`config.host_authorization`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-host-authorization)

Accepts a hash of options to configure the [HostAuthorization\\
middleware](https://guides.rubyonrails.org/v7.2/configuring.html#actiondispatch-hostauthorization)

#### [3.2.38`config.hosts`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-hosts)

An array of strings, regular expressions, or `IPAddr` used to validate the
`Host` header. Used by the [HostAuthorization\\
middleware](https://guides.rubyonrails.org/v7.2/configuring.html#actiondispatch-hostauthorization) to help prevent DNS rebinding
attacks.

#### [3.2.39`config.javascript_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-javascript-path)
...
#### [3.2.40`config.log_file_size`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-log-file-size)
...
#### [3.2.41`config.log_formatter`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-log-formatter)
...
#### [3.2.42`config.log_level`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-log-level)
...
#### [3.2.43`config.log_tags`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-log-tags)
...
#### [3.2.44`config.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-logger)
...
#### [3.2.45`config.middleware`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-middleware)

Allows you to configure the application's middleware. This is covered in depth in the [Configuring Middleware](https://guides.rubyonrails.org/v7.2/configuring.html#configuring-middleware) section below.

#### [3.2.46`config.precompile_filter_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-precompile-filter-parameters)

When `true`, will precompile [`config.filter_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html#config-filter-parameters)
using [`ActiveSupport::ParameterFilter.precompile_filters`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/ParameterFilter.html#method-c-precompile_filters).
...
#### [3.2.47`config.public_file_server.enabled`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-public-file-server-enabled)
...
#### [3.2.48`config.railties_order`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-railties-order)
...
#### [3.2.49`config.rake_eager_load`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-rake-eager-load)

When `true`, eager load the application when running Rake tasks. Defaults to `false`.

#### [3.2.50`config.read_encrypted_secrets`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-read-encrypted-secrets)

_DEPRECATED_: You should be using
...
#### [3.2.51`config.relative_url_root`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-relative-url-root)

Can be used to tell Rails that you are [deploying to a subdirectory](https://guides.rubyonrails.org/v7.2/configuring.html#deploy-to-a-subdirectory-relative-url-root). The default
is `ENV['RAILS_RELATIVE_URL_ROOT']`.

#### [3.2.52`config.reload_classes_only_on_change`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-reload-classes-only-on-change)
...
#### [3.2.53`config.require_master_key`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-require-master-key)
...
#### [3.2.54`config.sandbox_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-sandbox-by-default)
...
#### [3.2.55`config.secret_key_base`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-secret-key-base)
...
in `config/credentials.yml.enc`. See the [`secret_key_base` API documentation](https://api.rubyonrails.org/v7.2.3.1/classes/Rails/Application.html#method-i-secret_key_base)
for more information and alternative configuration methods.

#### [3.2.56`config.server_timing`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-server-timing)

When `true`, adds the [`ServerTiming` middleware](https://guides.rubyonrails.org/v7.2/configuring.html#actiondispatch-servertiming)
...
#### [3.2.57`config.session_options`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-session-options)
...
#### [3.2.58`config.session_store`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-session-store)
...
#### [3.2.59`config.ssl_options`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-ssl-options)

Configuration options for the [`ActionDispatch::SSL`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionDispatch/SSL.html) middleware.
...
#### [3.2.60`config.time_zone`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-time-zone)

Sets the default time zone for the application and enables time zone awareness for Active Record.

#### [3.2.61`config.x`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-x)
...
See [Custom Configuration](https://guides.rubyonrails.org/v7.2/configuring.html#custom-configuration)

#### [3.2.62`config.yjit`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-yjit)
...
### [3.3 Configuring Assets](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-assets)

#### [3.3.1`config.assets.css_compressor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-css-compressor)
...
#### [3.3.2`config.assets.js_compressor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-js-compressor)
...
#### [3.3.3`config.assets.gzip`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-gzip)
...
#### [3.3.4`config.assets.paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-paths)
...
#### [3.3.5`config.assets.precompile`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-precompile)
...
#### [3.3.6`config.assets.unknown_asset_fallback`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-unknown-asset-fallback)
...
#### [3.3.7`config.assets.prefix`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-prefix)

Defines the prefix where assets are served from. Defaults to `/assets`.

#### [3.3.8`config.assets.manifest`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-manifest)
...
#### [3.3.9`config.assets.digest`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-digest)

Enables the use of SHA256 fingerprints in asset names. Set to `true` by default.

#### [3.3.10`config.assets.debug`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-debug)

Disables the concatenation and compression of assets.

#### [3.3.11`config.assets.version`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-version)

Is an option string that is used in SHA256 hash generation. This can be changed to force all files to be recompiled.

#### [3.3.12`config.assets.compile`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-compile)

Is a boolean that can be used to turn on live Sprockets compilation in production.

#### [3.3.13`config.assets.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-logger)
...
#### [3.3.14`config.assets.quiet`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-assets-quiet)

Disables logging of assets requests. Set to `true` by default in `config/environments/development.rb`.

### [3.4 Configuring Generators](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-generators)
...
### [3.5 Configuring Middleware](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-middleware)

Every Rails application comes with a standard set of middleware which it uses in this order in the development environment:

#### [3.5.1`ActionDispatch::HostAuthorization`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-hostauthorization)
...
#### [3.5.2`ActionDispatch::ServerTiming`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-servertiming)
...
#### [3.5.3`ActionDispatch::SSL`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-ssl)
...
#### [3.5.4`ActionDispatch::Static`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-static)
...
#### [3.5.5`ActionDispatch::Executor`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-executor)
...
#### [3.5.6`ActiveSupport::Cache::Strategy::LocalCache`](https://guides.rubyonrails.org/v7.2/configuring.html\#activesupport-cache-strategy-localcache)
...
#### [3.5.7`Rack::Runtime`](https://guides.rubyonrails.org/v7.2/configuring.html\#rack-runtime)

Sets an `X-Runtime` header, containing the time (in seconds) taken to execute the request.

#### [3.5.8`Rails::Rack::Logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#rails-rack-logger)

Notifies the logs that the request has begun. After request is complete, flushes all the logs.

#### [3.5.9`ActionDispatch::ShowExceptions`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-showexceptions)
...
#### [3.5.10`ActionDispatch::RequestId`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-requestid)
...
#### [3.5.11`ActionDispatch::RemoteIp`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-remoteip)
...
#### [3.5.12`Rack::Sendfile`](https://guides.rubyonrails.org/v7.2/configuring.html\#rack-sendfile)
...
#### [3.5.13`ActionDispatch::Callbacks`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-callbacks)

Runs the prepare callbacks before serving the request.

#### [3.5.14`ActionDispatch::Cookies`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-cookies)

Sets cookies for the request.

#### [3.5.15`ActionDispatch::Session::CookieStore`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-session-cookiestore)

Is responsible for storing the session in cookies. An alternate middleware can be used for this by changing [`config.session_store`](https://guides.rubyonrails.org/v7.2/configuring.html#config-session-store).

#### [3.5.16`ActionDispatch::Flash`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-flash)

Sets up the `flash` keys. Only available if [`config.session_store`](https://guides.rubyonrails.org/v7.2/configuring.html#config-session-store) is set to a value.

#### [3.5.17`Rack::MethodOverride`](https://guides.rubyonrails.org/v7.2/configuring.html\#rack-methodoverride)
...
#### [3.5.18`Rack::Head`](https://guides.rubyonrails.org/v7.2/configuring.html\#rack-head)

Returns an empty body for all HEAD requests. It leaves all other requests unchanged.

#### [3.5.19 Adding Custom Middleware](https://guides.rubyonrails.org/v7.2/configuring.html\#adding-custom-middleware)
...
### [3.6 Configuring i18n](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-i18n)

All these configuration options are delegated to the `I18n` library.

#### [3.6.1`config.i18n.available_locales`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-available-locales)
...
#### [3.6.2`config.i18n.default_locale`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-default-locale)

Sets the default locale of an application used for i18n. Defaults to `:en`.

#### [3.6.3`config.i18n.enforce_available_locales`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-enforce-available-locales)
...
#### [3.6.4`config.i18n.load_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-load-path)

Sets the path Rails uses to look for locale files. Defaults to `config/locales/**/*.{yml,rb}`.

#### [3.6.5`config.i18n.raise_on_missing_translations`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-raise-on-missing-translations)

Determines whether an error should be raised for missing translations. This defaults to `false`.

#### [3.6.6`config.i18n.fallbacks`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-i18n-fallbacks)
...
### [3.7 Configuring Active Model](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-active-model)

#### [3.7.1`config.active_model.i18n_customize_full_message`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-model-i18n-customize-full-message)

Controls whether the [`Error#full_message`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveModel/Error.html#method-i-full_message) format can be overridden in an i18n locale file. Defaults to `false`.
...
### [3.8 Configuring Active Record](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-active-record)

`config.active_record` includes a variety of configuration options:

#### [3.8.1`config.active_record.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-logger)
...
#### [3.8.2`config.active_record.primary_key_prefix_type`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-primary-key-prefix-type)
...
#### [3.8.3`config.active_record.table_name_prefix`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-table-name-prefix)
...
#### [3.8.4`config.active_record.table_name_suffix`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-table-name-suffix)
...
#### [3.8.5`config.active_record.schema_migrations_table_name`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-schema-migrations-table-name)

Lets you set a string to be used as the name of the schema migrations table.

#### [3.8.6`config.active_record.internal_metadata_table_name`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-internal-metadata-table-name)

Lets you set a string to be used as the name of the internal metadata table.

#### [3.8.7`config.active_record.protected_environments`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-protected-environments)

Lets you set an array of names of environments where destructive actions should be prohibited.

#### [3.8.8`config.active_record.pluralize_table_names`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-pluralize-table-names)
...
#### [3.8.9`config.active_record.default_timezone`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-default-timezone)
...
#### [3.8.10`config.active_record.schema_format`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-schema-format)
...
#### [3.8.11`config.active_record.error_on_ignored_order`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-error-on-ignored-order)
...
#### [3.8.12`config.active_record.timestamped_migrations`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-timestamped-migrations)
...
#### [3.8.13`config.active_record.automatically_invert_plural_associations`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-automatically-invert-plural-associations)
...
#### [3.8.14`config.active_record.validate_migration_timestamps`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-validate-migration-timestamps)
...
#### [3.8.15`config.active_record.db_warnings_action`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-db-warnings-action)
...
#### [3.8.16`config.active_record.db_warnings_ignore`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-db-warnings-ignore)
...
#### [3.8.17`config.active_record.migration_strategy`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-migration-strategy)
...
#### [3.8.18`config.active_record.lock_optimistically`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-lock-optimistically)

Controls whether Active Record will use optimistic locking and is `true` by default.

#### [3.8.19`config.active_record.cache_timestamp_format`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-cache-timestamp-format)

Controls the format of the timestamp value in the cache key. Default is `:usec`.

#### [3.8.20`config.active_record.record_timestamps`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-record-timestamps)
...
#### [3.8.21`config.active_record.partial_inserts`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-partial-inserts)
...
#### [3.8.22`config.active_record.partial_updates`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-partial-updates)
...
#### [3.8.23`config.active_record.maintain_test_schema`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-maintain-test-schema)
...
#### [3.8.24`config.active_record.dump_schema_after_migration`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-dump-schema-after-migration)
...
#### [3.8.25`config.active_record.dump_schemas`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-dump-schemas)
...
#### [3.8.26`config.active_record.before_committed_on_all_records`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-before-committed-on-all-records)
...
#### [3.8.27`config.active_record.belongs_to_required_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-belongs-to-required-by-default)
...
#### [3.8.28`config.active_record.belongs_to_required_validates_foreign_key`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-belongs-to-required-validates-foreign-key)
...
#### [3.8.29`config.active_record.marshalling_format_version`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-marshalling-format-version)
...
#### [3.8.30`config.active_record.action_on_strict_loading_violation`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-action-on-strict-loading-violation)
...
#### [3.8.31`config.active_record.strict_loading_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-strict-loading-by-default)

Is a boolean value that either enables or disables strict\_loading mode by
default. Defaults to `false`.

#### [3.8.32`config.active_record.warn_on_records_fetched_greater_than`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-warn-on-records-fetched-greater-than)
...
#### [3.8.33`config.active_record.index_nested_attribute_errors`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-index-nested-attribute-errors)

Allows errors for nested `has_many` relationships to be displayed with an index
as well as the error. Defaults to `false`.

#### [3.8.34`config.active_record.use_schema_cache_dump`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-use-schema-cache-dump)
...
#### [3.8.35`config.active_record.cache_versioning`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-cache-versioning)
...
#### [3.8.36`config.active_record.collection_cache_versioning`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-collection-cache-versioning)
...
#### [3.8.37`config.active_record.has_many_inversing`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-has-many-inversing)
...
#### [3.8.38`config.active_record.automatic_scope_inversing`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-automatic-scope-inversing)
...
#### [3.8.39`config.active_record.destroy_association_async_job`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-destroy-association-async-job)
...
#### [3.8.40`config.active_record.destroy_association_async_batch_size`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-destroy-association-async-batch-size)
...
#### [3.8.41`config.active_record.queues.destroy`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-queues-destroy)
...
[`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)). It defaults to `nil`.

#### [3.8.42`config.active_record.enumerate_columns_in_select_statements`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-enumerate-columns-in-select-statements)
...
#### [3.8.43`config.active_record.verify_foreign_keys_for_fixtures`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-verify-foreign-keys-for-fixtures)
...
#### [3.8.44`config.active_record.raise_on_assign_to_attr_readonly`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-raise-on-assign-to-attr-readonly)
...
#### [3.8.45`config.active_record.run_commit_callbacks_on_first_saved_instances_in_transaction`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-run-commit-callbacks-on-first-saved-instances-in-transaction)
...
#### [3.8.46`config.active_record.default_column_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-default-column-serializer)
...
#### [3.8.47`config.active_record.run_after_transaction_callbacks_in_order_defined`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-run-after-transaction-callbacks-in-order-defined)
...
#### [3.8.48`config.active_record.query_log_tags_enabled`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-query-log-tags-enabled)
...
#### [3.8.49`config.active_record.query_log_tags`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-query-log-tags)
...
#### [3.8.50`config.active_record.query_log_tags_format`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-query-log-tags-format)
...
#### [3.8.51`config.active_record.cache_query_log_tags`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-cache-query-log-tags)
...
#### [3.8.52`config.active_record.schema_cache_ignored_tables`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-schema-cache-ignored-tables)
...
#### [3.8.53`config.active_record.verbose_query_logs`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-verbose-query-logs)
...
#### [3.8.54`config.active_record.sqlite3_adapter_strict_strings_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-sqlite3-adapter-strict-strings-by-default)
...
#### [3.8.55`config.active_record.postgresql_adapter_decode_dates`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-postgresql-adapter-decode-dates)
...
#### [3.8.56`config.active_record.async_query_executor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-async-query-executor)
...
#### [3.8.57`config.active_record.global_executor_concurrency`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-global-executor-concurrency)
...
#### [3.8.58`config.active_record.yaml_column_permitted_classes`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-yaml-column-permitted-classes)
...
#### [3.8.59`config.active_record.use_yaml_unsafe_load`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-use-yaml-unsafe-load)

Defaults to `false`. Allows applications to opt into using `unsafe_load` on the `ActiveRecord::Coders::YAMLColumn`.

#### [3.8.60`config.active_record.raise_int_wider_than_64bit`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-raise-int-wider-than-64bit)
...
#### [3.8.61`config.active_record.generate_secure_token_on`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-generate-secure-token-on)
...
#### [3.8.62`config.active_record.permanent_connection_checkout`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-permanent-connection-checkout)
...
#### [3.8.63`ActiveRecord::ConnectionAdapters::Mysql2Adapter.emulate_booleans` and `ActiveRecord::ConnectionAdapters::TrilogyAdapter.emulate_booleans`](https://guides.rubyonrails.org/v7.2/configuring.html\#activerecord-connectionadapters-mysql2adapter-emulate-booleans-and-activerecord-connectionadapters-trilogyadapter-emulate-booleans)

Controls whether the Active Record MySQL adapter will consider all `tinyint(1)` columns as booleans. Defaults to `true`.

#### [3.8.64`ActiveRecord::ConnectionAdapters::PostgreSQLAdapter.create_unlogged_tables`](https://guides.rubyonrails.org/v7.2/configuring.html\#activerecord-connectionadapters-postgresqladapter-create-unlogged-tables)
...
#### [3.8.65`ActiveRecord::ConnectionAdapters::PostgreSQLAdapter.datetime_type`](https://guides.rubyonrails.org/v7.2/configuring.html\#activerecord-connectionadapters-postgresqladapter-datetime-type)
...
#### [3.8.66`ActiveRecord::SchemaDumper.ignore_tables`](https://guides.rubyonrails.org/v7.2/configuring.html\#activerecord-schemadumper-ignore-tables)

Accepts an array of tables that should _not_ be included in any generated schema file.

#### [3.8.67`ActiveRecord::SchemaDumper.fk_ignore_pattern`](https://guides.rubyonrails.org/v7.2/configuring.html\#activerecord-schemadumper-fk-ignore-pattern)
...
#### [3.8.68`config.active_record.encryption.add_to_filter_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-encryption-add-to-filter-parameters)

Enables automatic filtering of encrypted attributes on `inspect`.

The default value is `true`.

#### [3.8.69`config.active_record.encryption.hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-encryption-hash-digest-class)
...
#### [3.8.70`config.active_record.encryption.support_sha1_for_non_deterministic_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-encryption-support-sha1-for-non-deterministic-encryption)
...
#### [3.8.71`config.active_record.protocol_adapters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-record-protocol-adapters)
...
### [3.9 Configuring Action Controller](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-controller)

`config.action_controller` includes a number of configuration settings:

#### [3.9.1`config.action_controller.asset_host`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-asset-host)
...
#### [3.9.2`config.action_controller.perform_caching`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-perform-caching)
...
#### [3.9.3`config.action_controller.default_static_extension`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-default-static-extension)

Configures the extension used for cached pages. Defaults to `.html`.

#### [3.9.4`config.action_controller.include_all_helpers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-include-all-helpers)
...
#### [3.9.5`config.action_controller.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-logger)
...
#### [3.9.6`config.action_controller.request_forgery_protection_token`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-request-forgery-protection-token)

Sets the token parameter name for RequestForgery. Calling `protect_from_forgery` sets it to `:authenticity_token` by default.

#### [3.9.7`config.action_controller.allow_forgery_protection`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-allow-forgery-protection)

Enables or disables CSRF protection. By default this is `false` in the test environment and `true` in all other environments.

#### [3.9.8`config.action_controller.forgery_protection_origin_check`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-forgery-protection-origin-check)
...
#### [3.9.9`config.action_controller.per_form_csrf_tokens`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-per-form-csrf-tokens)
...
#### [3.9.10`config.action_controller.default_protect_from_forgery`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-default-protect-from-forgery)
...
#### [3.9.11`config.action_controller.relative_url_root`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-relative-url-root)

Can be used to tell Rails that you are [deploying to a subdirectory](https://guides.rubyonrails.org/v7.2/configuring.html#deploy-to-a-subdirectory-relative-url-root). The default is
[`config.relative_url_root`](https://guides.rubyonrails.org/v7.2/configuring.html#config-relative-url-root).

#### [3.9.12`config.action_controller.permit_all_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-permit-all-parameters)

Sets all the parameters for mass assignment to be permitted by default. The default value is `false`.

#### [3.9.13`config.action_controller.action_on_unpermitted_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-action-on-unpermitted-parameters)
...
#### [3.9.14`config.action_controller.always_permitted_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-always-permitted-parameters)

Sets a list of permitted parameters that are permitted by default. The default values are `['controller', 'action']`.

#### [3.9.15`config.action_controller.enable_fragment_cache_logging`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-enable-fragment-cache-logging)
...
#### [3.9.16`config.action_controller.raise_on_missing_callback_actions`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-raise-on-missing-callback-actions)
...
#### [3.9.17`config.action_controller.raise_on_open_redirects`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-raise-on-open-redirects)
...
with an external host is passed to [redirect\_to](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/Redirecting.html#method-i-redirect_to). If an open redirect should
...
#### [3.9.18`config.action_controller.log_query_tags_around_actions`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-log-query-tags-around-actions)
...
#### [3.9.19`config.action_controller.wrap_parameters_by_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-controller-wrap-parameters-by-default)
...
See [`ParamsWrapper`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/ParamsWrapper.html) for more information on parameter
wrapping.
...
#### [3.9.20`ActionController::Base.wrap_parameters`](https://guides.rubyonrails.org/v7.2/configuring.html\#actioncontroller-base-wrap-parameters)

Configures the [`ParamsWrapper`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/ParamsWrapper.html). This can be called at
the top level, or on individual controllers.

### [3.10 Configuring Action Dispatch](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-dispatch)

#### [3.10.1`config.action_dispatch.cookies_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-cookies-serializer)

Specifies which serializer to use for cookies. Accepts the same values as
[`config.active_support.message_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-message-serializer),
...
#### [3.10.2`config.action_dispatch.debug_exception_log_level`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-debug-exception-log-level)

Configures the log level used by the [`ActionDispatch::DebugExceptions`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionDispatch/DebugExceptions.html)
...
#### [3.10.3`config.action_dispatch.default_headers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-default-headers)
...
#### [3.10.4`config.action_dispatch.default_charset`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-default-charset)

Specifies the default character set for all renders. Defaults to `nil`.

#### [3.10.5`config.action_dispatch.tld_length`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-tld-length)

Sets the TLD (top-level domain) length for the application. Defaults to `1`.

#### [3.10.6`config.action_dispatch.ignore_accept_header`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-ignore-accept-header)

Is used to determine whether to ignore accept headers from a request. Defaults to `false`.

#### [3.10.7`config.action_dispatch.x_sendfile_header`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-x-sendfile-header)
...
#### [3.10.8`config.action_dispatch.http_auth_salt`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-http-auth-salt)

Sets the HTTP Auth salt value. Defaults
to `'http authentication'`.

#### [3.10.9`config.action_dispatch.signed_cookie_salt`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-signed-cookie-salt)

Sets the signed cookies salt value.
Defaults to `'signed cookie'`.

#### [3.10.10`config.action_dispatch.encrypted_cookie_salt`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-encrypted-cookie-salt)

Sets the encrypted cookies salt value. Defaults to `'encrypted cookie'`.

#### [3.10.11`config.action_dispatch.encrypted_signed_cookie_salt`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-encrypted-signed-cookie-salt)

Sets the signed encrypted cookies salt value. Defaults to `'signed encrypted
cookie'`.

#### [3.10.12`config.action_dispatch.authenticated_encrypted_cookie_salt`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-authenticated-encrypted-cookie-salt)

Sets the authenticated encrypted cookie salt. Defaults to `'authenticated
encrypted cookie'`.

#### [3.10.13`config.action_dispatch.encrypted_cookie_cipher`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-encrypted-cookie-cipher)

Sets the cipher to be used for encrypted cookies. This defaults to
`"aes-256-gcm"`.

#### [3.10.14`config.action_dispatch.signed_cookie_digest`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-signed-cookie-digest)

Sets the digest to be used for signed cookies. This defaults to `"SHA1"`.

#### [3.10.15`config.action_dispatch.cookies_rotations`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-cookies-rotations)

Allows rotating secrets, ciphers, and digests for encrypted and signed cookies.

#### [3.10.16`config.action_dispatch.use_authenticated_cookie_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-use-authenticated-cookie-encryption)
...
#### [3.10.17`config.action_dispatch.use_cookies_with_metadata`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-use-cookies-with-metadata)
...
#### [3.10.18`config.action_dispatch.perform_deep_munge`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-perform-deep-munge)

Configures whether `deep_munge` method should be performed on the parameters.
See [Security Guide](https://guides.rubyonrails.org/v7.2/security.html#unsafe-query-generation) for more
information. It defaults to `true`.

#### [3.10.19`config.action_dispatch.rescue_responses`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-rescue-responses)
...
#### [3.10.20`config.action_dispatch.cookies_same_site_protection`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-cookies-same-site-protection)
...
#### [3.10.21`config.action_dispatch.ssl_default_redirect_status`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-ssl-default-redirect-status)
...
#### [3.10.22`config.action_dispatch.log_rescued_responses`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-log-rescued-responses)

Enables logging those unhandled exceptions configured in `rescue_responses`. It
defaults to `true`.

#### [3.10.23`config.action_dispatch.show_exceptions`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-show-exceptions)
...
#### [3.10.24`config.action_dispatch.always_write_cookie`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-dispatch-always-write-cookie)
...
#### [3.10.25`ActionDispatch::Callbacks.before`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-callbacks-before)

Takes a block of code to run before the request.

#### [3.10.26`ActionDispatch::Callbacks.after`](https://guides.rubyonrails.org/v7.2/configuring.html\#actiondispatch-callbacks-after)

Takes a block of code to run after the request.

### [3.11 Configuring Action View](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-view)

`config.action_view` includes a small number of configuration settings:

#### [3.11.1`config.action_view.cache_template_loading`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-cache-template-loading)

Controls whether or not templates should be reloaded on each request. Defaults to `!config.enable_reloading`.

#### [3.11.2`config.action_view.field_error_proc`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-field-error-proc)
...
#### [3.11.3`config.action_view.default_form_builder`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-default-form-builder)
...
#### [3.11.4`config.action_view.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-logger)
...
#### [3.11.5`config.action_view.erb_trim_mode`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-erb-trim-mode)
...
#### [3.11.6`config.action_view.frozen_string_literal`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-frozen-string-literal)
...
#### [3.11.7`config.action_view.embed_authenticity_token_in_remote_forms`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-embed-authenticity-token-in-remote-forms)
...
#### [3.11.8`config.action_view.prefix_partial_path_with_controller_namespace`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-prefix-partial-path-with-controller-namespace)
...
#### [3.11.9`config.action_view.automatically_disable_submit_tag`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-automatically-disable-submit-tag)

Determines whether `submit_tag` should automatically disable on click, this
defaults to `true`.

#### [3.11.10`config.action_view.debug_missing_translation`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-debug-missing-translation)

Determines whether to wrap the missing translations key in a `<span>` tag or not. This defaults to `true`.

#### [3.11.11`config.action_view.form_with_generates_remote_forms`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-form-with-generates-remote-forms)
...
#### [3.11.12`config.action_view.form_with_generates_ids`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-form-with-generates-ids)
...
#### [3.11.13`config.action_view.default_enforce_utf8`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-default-enforce-utf8)
...
#### [3.11.14`config.action_view.image_loading`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-image-loading)
...
#### [3.11.15`config.action_view.image_decoding`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-image-decoding)

Specifies a default value for the `decoding` attribute of `<img>` tags rendered by the `image_tag` helper. Defaults to `nil`.

#### [3.11.16`config.action_view.annotate_rendered_view_with_filenames`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-annotate-rendered-view-with-filenames)

Determines whether to annotate rendered view with template file names. This defaults to `false`.

#### [3.11.17`config.action_view.preload_links_header`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-preload-links-header)
...
#### [3.11.18`config.action_view.button_to_generates_button_tag`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-button-to-generates-button-tag)
...
#### [3.11.19`config.action_view.apply_stylesheet_media_default`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-apply-stylesheet-media-default)
...
#### [3.11.20`config.action_view.prepend_content_exfiltration_prevention`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-prepend-content-exfiltration-prevention)
...
#### [3.11.21`config.action_view.sanitizer_vendor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-view-sanitizer-vendor)
...
### [3.12 Configuring Action Mailbox](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-mailbox)

`config.action_mailbox` provides the following configuration options:

#### [3.12.1`config.action_mailbox.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailbox-logger)
...
#### [3.12.2`config.action_mailbox.incinerate_after`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailbox-incinerate-after)
...
#### [3.12.3`config.action_mailbox.queues.incineration`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailbox-queues-incineration)
...
queue (see [`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)).
...
#### [3.12.4`config.action_mailbox.queues.routing`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailbox-queues-routing)
...
[`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)).
...
#### [3.12.5`config.action_mailbox.storage_service`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailbox-storage-service)
...
### [3.13 Configuring Action Mailer](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-mailer)

There are a number of settings available on `config.action_mailer`:

#### [3.13.1`config.action_mailer.asset_host`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-asset-host)
...
#### [3.13.2`config.action_mailer.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-logger)
...
#### [3.13.3`config.action_mailer.smtp_settings`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-smtp-settings)
...
#### [3.13.4`config.action_mailer.smtp_timeout`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-smtp-timeout)
...
#### [3.13.5`config.action_mailer.sendmail_settings`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-sendmail-settings)
...
#### [3.13.6`config.action_mailer.file_settings`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-file-settings)
...
#### [3.13.7`config.action_mailer.raise_delivery_errors`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-raise-delivery-errors)

Specifies whether to raise an error if email delivery cannot be completed. It defaults to `true`.

#### [3.13.8`config.action_mailer.delivery_method`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-delivery-method)

Defines the delivery method and defaults to `:smtp`. See the [configuration section in the Action Mailer guide](https://guides.rubyonrails.org/v7.2/action_mailer_basics.html#action-mailer-configuration) for more info.

#### [3.13.9`config.action_mailer.perform_deliveries`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-perform-deliveries)
...
#### [3.13.10`config.action_mailer.default_options`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-default-options)
...
#### [3.13.11`config.action_mailer.observers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-observers)
...
#### [3.13.12`config.action_mailer.interceptors`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-interceptors)
...
#### [3.13.13`config.action_mailer.preview_interceptors`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-preview-interceptors)
...
#### [3.13.14`config.action_mailer.preview_paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-preview-paths)
...
#### [3.13.15`config.action_mailer.show_previews`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-show-previews)
...
#### [3.13.16`config.action_mailer.perform_caching`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-perform-caching)
...
#### [3.13.17`config.action_mailer.deliver_later_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-deliver-later-queue-name)
...
#### [3.13.18`config.action_mailer.delivery_job`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-mailer-delivery-job)
...
### [3.14 Configuring Active Support](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-active-support)

There are a few configuration options available in Active Support:

#### [3.14.1`config.active_support.bare`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-bare)
...
#### [3.14.2`config.active_support.test_order`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-test-order)

Sets the order in which the test cases are executed. Possible values are `:random` and `:sorted`. Defaults to `:random`.

#### [3.14.3`config.active_support.escape_html_entities_in_json`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-escape-html-entities-in-json)

Enables or disables the escaping of HTML entities in JSON serialization. Defaults to `true`.

#### [3.14.4`config.active_support.use_standard_json_time_format`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-use-standard-json-time-format)

Enables or disables serializing dates to ISO 8601 format. Defaults to `true`.

#### [3.14.5`config.active_support.time_precision`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-time-precision)

Sets the precision of JSON encoded time values. Defaults to `3`.

#### [3.14.6`config.active_support.hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-hash-digest-class)
...
#### [3.14.7`config.active_support.key_generator_hash_digest_class`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-key-generator-hash-digest-class)
...
#### [3.14.8`config.active_support.use_authenticated_message_encryption`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-use-authenticated-message-encryption)
...
#### [3.14.9`config.active_support.message_serializer`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-message-serializer)

Specifies the default serializer used by [`ActiveSupport::MessageEncryptor`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/MessageEncryptor.html)
and [`ActiveSupport::MessageVerifier`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/MessageVerifier.html) instances. To make migrating between
...
Each of the above serializers will emit a [`message_serializer_fallback.active_support`](https://guides.rubyonrails.org/v7.2/active_support_instrumentation.html#message-serializer-fallback-active-support)
...
#### [3.14.10`config.active_support.use_message_serializer_for_metadata`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-use-message-serializer-for-metadata)
...
#### [3.14.11`config.active_support.cache_format_version`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-cache-format-version)
...
#### [3.14.12`config.active_support.deprecation`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-deprecation)

Configures the behavior of deprecation warnings. See
[`Deprecation::Behavior`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Deprecation/Behavior.html#method-i-behavior-3D) for a description of the
available options.
...
[`config.active_support.report_deprecations`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-report-deprecations).

#### [3.14.13`config.active_support.disallowed_deprecation`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-disallowed-deprecation)
...
#### [3.14.14`config.active_support.disallowed_deprecation_warnings`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-disallowed-deprecation-warnings)
...
#### [3.14.15`config.active_support.report_deprecations`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-report-deprecations)

When `false`, disables all deprecation warnings, including disallowed deprecations, from the [application’s deprecators](https://api.rubyonrails.org/v7.2.3.1/classes/Rails/Application.html#method-i-deprecators). This includes all the deprecations from Rails and other gems that may add their deprecator to the collection of deprecators, but may not prevent all deprecation warnings emitted from ActiveSupport::Deprecation.

In the default generated `config/environments` files, this is set to `false` for production.

#### [3.14.16`config.active_support.isolation_level`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-isolation-level)
...
#### [3.14.17`config.active_support.executor_around_test_case`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-executor-around-test-case)
...
#### [3.14.18`ActiveSupport::Logger.silencer`](https://guides.rubyonrails.org/v7.2/configuring.html\#activesupport-logger-silencer)

Is set to `false` to disable the ability to silence logging in a block. The default is `true`.

#### [3.14.19`ActiveSupport::Cache::Store.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#activesupport-cache-store-logger)

Specifies the logger to use within cache store operations.

#### [3.14.20`ActiveSupport.to_time_preserves_timezone`](https://guides.rubyonrails.org/v7.2/configuring.html\#activesupport-to-time-preserves-timezone)
...
#### [3.14.21`ActiveSupport.utc_to_local_returns_utc_offset_times`](https://guides.rubyonrails.org/v7.2/configuring.html\#activesupport-utc-to-local-returns-utc-offset-times)

Configures [`ActiveSupport::TimeZone.utc_to_local`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/TimeZone.html#method-i-utc_to_local) to return a time with a UTC
...
#### [3.14.22`config.active_support.raise_on_invalid_cache_expiration_time`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-support-raise-on-invalid-cache-expiration-time)

Specifies whether an `ArgumentError` should be raised if `Rails.cache` [`fetch`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Cache/Store.html#method-i-fetch) or [`write`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Cache/Store.html#method-i-write)
...
### [3.15 Configuring Active Job](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-active-job)

`config.active_job` provides the following configuration options:

#### [3.15.1`config.active_job.queue_adapter`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-queue-adapter)

Sets the adapter for the queuing backend. The default adapter is `:async`. For an up-to-date list of built-in adapters see the [ActiveJob::QueueAdapters API documentation](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveJob/QueueAdapters.html).
...
#### [3.15.2`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-default-queue-name)
...
#### [3.15.3`config.active_job.queue_name_prefix`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-queue-name-prefix)
...
#### [3.15.4`config.active_job.queue_name_delimiter`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-queue-name-delimiter)
...
#### [3.15.5`config.active_job.enqueue_after_transaction_commit`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-enqueue-after-transaction-commit)
...
#### [3.15.6`config.active_job.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-logger)
...
#### [3.15.7`config.active_job.custom_serializers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-custom-serializers)

Allows to set custom argument serializers. Defaults to `[]`.

#### [3.15.8`config.active_job.log_arguments`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-log-arguments)

Controls if the arguments of a job are logged. Defaults to `true`.

#### [3.15.9`config.active_job.verbose_enqueue_logs`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-verbose-enqueue-logs)
...
#### [3.15.10`config.active_job.retry_jitter`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-retry-jitter)
...
#### [3.15.11`config.active_job.log_query_tags_around_perform`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-job-log-query-tags-around-perform)
...
### [3.16 Configuring Action Cable](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-cable)

#### [3.16.1`config.action_cable.url`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-cable-url)
...
#### [3.16.2`config.action_cable.mount_path`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-cable-mount-path)
...
[Action Cable Overview](https://guides.rubyonrails.org/v7.2/action_cable_overview.html#configuration).

#### [3.16.3`config.action_cable.precompile_assets`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-cable-precompile-assets)
...
### [3.17 Configuring Active Storage](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-active-storage)

`config.active_storage` provides the following configuration options:

#### [3.17.1`config.active_storage.variant_processor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-variant-processor)
...
#### [3.17.2`config.active_storage.analyzers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-analyzers)
...
#### [3.17.3`config.active_storage.previewers`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-previewers)
...
#### [3.17.4`config.active_storage.paths`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-paths)
...
#### [3.17.5`config.active_storage.variable_content_types`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-variable-content-types)
...
#### [3.17.6`config.active_storage.web_image_content_types`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-web-image-content-types)
...
#### [3.17.7`config.active_storage.content_types_to_serve_as_binary`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-content-types-to-serve-as-binary)
...
#### [3.17.8`config.active_storage.content_types_allowed_inline`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-content-types-allowed-inline)
...
#### [3.17.9`config.active_storage.queues.analysis`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-queues-analysis)
...
(see [`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)).
...
#### [3.17.10`config.active_storage.queues.mirror`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-queues-mirror)
...
default Active Job queue (see [`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)). The
default is `nil`.

#### [3.17.11`config.active_storage.queues.preview_image`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-queues-preview-image)
...
Active Job queue (see [`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)). The default
is `nil`.

#### [3.17.12`config.active_storage.queues.purge`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-queues-purge)
...
#### [3.17.13`config.active_storage.queues.transform`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-queues-transform)

Accepts a symbol indicating the Active Job queue to use for preprocessing
variants. When this option is `nil`, jobs are sent to the default Active Job
queue (see [`config.active_job.default_queue_name`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-job-default-queue-name)). The default is `nil`.

#### [3.17.14`config.active_storage.logger`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-logger)
...
#### [3.17.15`config.active_storage.service_urls_expire_in`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-service-urls-expire-in)

Determines the default expiry of URLs generated by:

- [`ActiveStorage::Blob#url`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveStorage/Blob.html#method-i-url)
- [`ActiveStorage::Blob#service_url_for_direct_upload`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveStorage/Blob.html#method-i-service_url_for_direct_upload)
- [`ActiveStorage::Preview#url`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveStorage/Preview.html#method-i-url)
- [`ActiveStorage::Variant#url`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveStorage/Variant.html#method-i-url)

The default is 5 minutes.

#### [3.17.16`config.active_storage.urls_expire_in`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-urls-expire-in)

Determines the default expiry of URLs in the Rails application generated by Active Storage. The default is nil.

#### [3.17.17`config.active_storage.touch_attachment_records`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-touch-attachment-records)

Directs ActiveStorage::Attachments to touch its corresponding record when updated. The default is true.

#### [3.17.18`config.active_storage.routes_prefix`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-routes-prefix)
...
#### [3.17.19`config.active_storage.track_variants`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-track-variants)
...
#### [3.17.20`config.active_storage.draw_routes`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-draw-routes)

Can be used to toggle Active Storage route generation. The default is `true`.

#### [3.17.21`config.active_storage.resolve_model_to_route`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-resolve-model-to-route)
...
#### [3.17.22`config.active_storage.video_preview_arguments`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-video-preview-arguments)
...
#### [3.17.23`config.active_storage.multiple_file_field_include_hidden`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-multiple-file-field-include-hidden)
...
is `true`, the [`file_field`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormBuilder.html#method-i-file_field)
helper will render an auxiliary hidden field, similar to the auxiliary field
rendered by the [`check_box`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionView/Helpers/FormBuilder.html#method-i-check_box)
helper.
...
#### [3.17.24`config.active_storage.precompile_assets`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-precompile-assets)

Determines whether the Active Storage assets should be added to the asset pipeline precompilation. It
has no effect if Sprockets is not used. The default value is `true`.

#### [3.17.25`config.active_storage.streaming_max_ranges`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-active-storage-streaming-max-ranges)
...
### [3.18 Configuring Action Text](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-action-text)

#### [3.18.1`config.action_text.attachment_tag_name`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-text-attachment-tag-name)

Accepts a string for the HTML tag used to wrap attachments. Defaults to `"action-text-attachment"`.

#### [3.18.2`config.action_text.sanitizer_vendor`](https://guides.rubyonrails.org/v7.2/configuring.html\#config-action-text-sanitizer-vendor)
...
### [3.19 Configuring a Database](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-a-database)
...
[`config.active_record.protocol_adapters`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-record-protocol-adapters).

You don't have to update the database configurations manually. If you look at the options of the application generator, you will see that one of the options is named `--database`. This option allows you to choose an adapter from a list of the most used relational databases. You can even run the generator repeatedly: `cd .. && rails new blog --database=mysql`. When you confirm the overwriting of the `config/database.yml` file, your application will be configured for MySQL instead of SQLite. Detailed examples of the common database connections are below.

### [3.20 Connection Preference](https://guides.rubyonrails.org/v7.2/configuring.html\#connection-preference)
...
#### [3.20.1 Configuring an SQLite3 Database](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-an-sqlite3-database)
...
#### [3.20.2 Configuring a MySQL or MariaDB Database](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-a-mysql-or-mariadb-database)
...
#### [3.20.3 Configuring a PostgreSQL Database](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-a-postgresql-database)
...
#### [3.20.4 Configuring an SQLite3 Database for JRuby Platform](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-an-sqlite3-database-for-jruby-platform)
...
#### [3.20.5 Configuring a MySQL or MariaDB Database for JRuby Platform](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-a-mysql-or-mariadb-database-for-jruby-platform)
...
#### [3.20.6 Configuring a PostgreSQL Database for JRuby Platform](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-a-postgresql-database-for-jruby-platform)
...
#### [3.20.7 Configuring Metadata Storage](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-metadata-storage)
...
#### [3.20.8 Configuring Retry Behaviour](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-retry-behaviour)
...
#### [3.20.9 Configuring Query Cache](https://guides.rubyonrails.org/v7.2/configuring.html\#configuring-query-cache)
...
### [3.21 Creating Rails Environments](https://guides.rubyonrails.org/v7.2/configuring.html\#creating-rails-environments)
...
### [3.22 Deploy to a Subdirectory (relative URL root)](https://guides.rubyonrails.org/v7.2/configuring.html\#deploy-to-a-subdirectory-relative-url-root)
...
#### [3.22.1 Using Passenger](https://guides.rubyonrails.org/v7.2/configuring.html\#using-passenger)
...
#### [3.22.2 Using a Reverse Proxy](https://guides.rubyonrails.org/v7.2/configuring.html\#using-a-reverse-proxy)
...
## [4 Rails Environment Settings](https://guides.rubyonrails.org/v7.2/configuring.html\#rails-environment-settings)

Some parts of Rails can also be configured externally by supplying environment variables. The following environment variables are recognized by various parts of Rails:

- `ENV["RAILS_ENV"]` defines the Rails environment (production, development, test, and so on) that Rails will run under.

- `ENV["RAILS_RELATIVE_URL_ROOT"]` is used by the routing code to recognize URLs when you [deploy your application to a subdirectory](https://guides.rubyonrails.org/v7.2/configuring.html#deploy-to-a-subdirectory-relative-url-root).

- `ENV["RAILS_CACHE_ID"]` and `ENV["RAILS_APP_VERSION"]` are used to generate expanded cache keys in Rails' caching code. This allows you to have multiple separate caches from the same application.


## [5 Using Initializer Files](https://guides.rubyonrails.org/v7.2/configuring.html\#using-initializer-files)
...
## [6 Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html\#load-hooks)
...
### [6.1 Avoid Loading Rails Frameworks](https://guides.rubyonrails.org/v7.2/configuring.html\#avoid-loading-rails-frameworks)
...
### [6.2 When are Hooks called?](https://guides.rubyonrails.org/v7.2/configuring.html\#when-are-hooks-called-questionmark)
...
### [6.3 Modifying Code to Use Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html\#modifying-code-to-use-load-hooks)
...
### [6.4 Available Load Hooks](https://guides.rubyonrails.org/v7.2/configuring.html\#available-load-hooks)
...
## [7 Initialization Events](https://guides.rubyonrails.org/v7.2/configuring.html\#initialization-events)
...
### [7.1`Rails::Railtie\#initializer`](https://guides.rubyonrails.org/v7.2/configuring.html\#rails-railtie-initializer)
...
### [7.2 Initializers](https://guides.rubyonrails.org/v7.2/configuring.html\#initializers)
...
- `active_support.deprecation_behavior`: Sets up deprecation reporting behavior for [`Rails.application.deprecators`](https://api.rubyonrails.org/v7.2.3.1/classes/Rails/Application.html#method-i-deprecators) based on [`config.active_support.report_deprecations`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-report-deprecations), [`config.active_support.deprecation`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-deprecation), [`config.active_support.disallowed_deprecation`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-disallowed-deprecation), and [`config.active_support.disallowed_deprecation_warnings`](https://guides.rubyonrails.org/v7.2/configuring.html#config-active-support-disallowed-deprecation-warnings).
...
## [8 Database Pooling](https://guides.rubyonrails.org/v7.2/configuring.html\#database-pooling)

Active Record database connections are managed by [`ActiveRecord::ConnectionAdapters::ConnectionPool`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/ConnectionAdapters/ConnectionPool.html) which ensures that a connection pool synchronizes the amount of thread access to a limited number of database connections. This limit defaults to 5 and can be configured in `database.yml`.
...
## [9 Custom Configuration](https://guides.rubyonrails.org/v7.2/configuring.html\#custom-configuration)
