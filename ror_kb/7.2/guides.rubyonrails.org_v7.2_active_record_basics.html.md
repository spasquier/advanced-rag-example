---
url: "https://guides.rubyonrails.org/v7.2/active_record_basics.html"
...
1. [What is Active Record?](https://guides.rubyonrails.org/v7.2/active_record_basics.html#what-is-active-record-questionmark)
   - [The Active Record Pattern](https://guides.rubyonrails.org/v7.2/active_record_basics.html#the-active-record-pattern)
   - [Object Relational Mapping](https://guides.rubyonrails.org/v7.2/active_record_basics.html#object-relational-mapping)
   - [Active Record as an ORM Framework](https://guides.rubyonrails.org/v7.2/active_record_basics.html#active-record-as-an-orm-framework)
2. [Convention over Configuration in Active Record](https://guides.rubyonrails.org/v7.2/active_record_basics.html#convention-over-configuration-in-active-record)
   - [Naming Conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html#naming-conventions)
   - [Schema Conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html#schema-conventions)
3. [Creating Active Record Models](https://guides.rubyonrails.org/v7.2/active_record_basics.html#creating-active-record-models)
   - [Creating Namespaced Models](https://guides.rubyonrails.org/v7.2/active_record_basics.html#creating-namespaced-models)
4. [Overriding the Naming Conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html#overriding-the-naming-conventions)
5. [CRUD: Reading and Writing Data](https://guides.rubyonrails.org/v7.2/active_record_basics.html#crud-reading-and-writing-data)
   - [Create](https://guides.rubyonrails.org/v7.2/active_record_basics.html#create)
   - [Read](https://guides.rubyonrails.org/v7.2/active_record_basics.html#read)
   - [Update](https://guides.rubyonrails.org/v7.2/active_record_basics.html#update)
   - [Delete](https://guides.rubyonrails.org/v7.2/active_record_basics.html#delete)
6. [Validations](https://guides.rubyonrails.org/v7.2/active_record_basics.html#validations)
7. [Callbacks](https://guides.rubyonrails.org/v7.2/active_record_basics.html#callbacks)
8. [Migrations](https://guides.rubyonrails.org/v7.2/active_record_basics.html#migrations)
9. [Associations](https://guides.rubyonrails.org/v7.2/active_record_basics.html#associations)
...
database. [Active Model](https://guides.rubyonrails.org/v7.2/active_model_basics.html) is commonly used for that in
...
### [1.1 The Active Record Pattern](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#the-active-record-pattern)
...
### [1.2 Object Relational Mapping](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#object-relational-mapping)
...
### [1.3 Active Record as an ORM Framework](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#active-record-as-an-orm-framework)
...
possible to [override naming conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html#overriding-the-naming-conventions).

### [2.1 Naming Conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#naming-conventions)
...
This uses the [Active Support](https://guides.rubyonrails.org/v7.2/active_support_core_extensions.html#pluralize) [pluralize](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveSupport/Inflector.html#method-i-pluralize) method.
...
### [2.2 Schema Conventions](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#schema-conventions)
...
`integer` for SQLite). When using [Active Record Migrations](https://guides.rubyonrails.org/v7.2/active_record_basics.html#migrations) to
...
locking](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Locking.html) to a
model.
- `type` \- Specifies that the model uses [Single Table\\
Inheritance](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Base.html#class-ActiveRecord::Base-label-Single+table+inheritance).
- `(association_name)_type` \- Stores the type for [polymorphic\\
associations](https://guides.rubyonrails.org/v7.2/association_basics.html#polymorphic-associations).
...
inherits from
[`ActiveRecord::Base`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/Base.html)
...
are typically created using [Active Record Migrations](https://guides.rubyonrails.org/v7.2/active_record_basics.html#migrations) and not raw
...
### [3.1 Creating Namespaced Models](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#creating-namespaced-models)
...
Setting the
[table\_name\_prefix](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/ModelSchema.html#method-c-table_name_prefix-3D)
...
[the fixtures](https://guides.rubyonrails.org/v7.2/testing.html#the-low-down-on-fixtures) (`my_books.yml`) using the
...
[`id_value`](https://api.rubyonrails.org/v7.2.3.1/classes/ActiveRecord/ModelSchema.html#method-i-id_value) alias attribute to access the value of the non-PK `id` column.
...
### [5.1 Create](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#create)
...
### [5.2 Read](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#read)
...
learn more about them in the [Active Record Query](https://guides.rubyonrails.org/v7.2/active_record_querying.html) guide.

### [5.3 Update](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#update)
...
### [5.4 Delete](https://guides.rubyonrails.org/v7.2/active_record_basics.html\#delete)
...
guide](https://guides.rubyonrails.org/v7.2/active_record_validations.html).
...
guide](https://guides.rubyonrails.org/v7.2/active_record_callbacks.html).
...
guide](https://guides.rubyonrails.org/v7.2/active_record_migrations.html).
...
guide](https://guides.rubyonrails.org/v7.2/association_basics.html).
