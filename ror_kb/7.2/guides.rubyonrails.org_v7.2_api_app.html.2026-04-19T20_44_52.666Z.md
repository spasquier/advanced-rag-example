...
1. [What is an API Application?](https://guides.rubyonrails.org/v7.2/api_app.html#what-is-an-api-application-questionmark)
2. [Why Use Rails for JSON APIs?](https://guides.rubyonrails.org/v7.2/api_app.html#why-use-rails-for-json-apis-questionmark)
3. [The Basic Configuration](https://guides.rubyonrails.org/v7.2/api_app.html#the-basic-configuration)
   - [Creating a New Application](https://guides.rubyonrails.org/v7.2/api_app.html#creating-a-new-application)
   - [Generating a New Resource](https://guides.rubyonrails.org/v7.2/api_app.html#generating-a-new-resource)
   - [Changing an Existing Application](https://guides.rubyonrails.org/v7.2/api_app.html#changing-an-existing-application)
4. [Choosing Middleware](https://guides.rubyonrails.org/v7.2/api_app.html#choosing-middleware)
   - [Using Rack::Cache](https://guides.rubyonrails.org/v7.2/api_app.html#using-rack-cache)
   - [Using Rack::Sendfile](https://guides.rubyonrails.org/v7.2/api_app.html#using-rack-sendfile)
   - [Using ActionDispatch::Request](https://guides.rubyonrails.org/v7.2/api_app.html#using-actiondispatch-request)
   - [Using Session Middlewares](https://guides.rubyonrails.org/v7.2/api_app.html#using-session-middlewares)
   - [Other Middleware](https://guides.rubyonrails.org/v7.2/api_app.html#other-middleware)
   - [Removing Middleware](https://guides.rubyonrails.org/v7.2/api_app.html#removing-middleware)
5. [Choosing Controller Modules](https://guides.rubyonrails.org/v7.2/api_app.html#choosing-controller-modules)
   - [Adding Other Modules](https://guides.rubyonrails.org/v7.2/api_app.html#adding-other-modules)
...
[`stale?`](https://api.rubyonrails.org/v7.2.3.1/classes/ActionController/ConditionalGet.html#method-i-stale-3F)
...
### [3.1 Creating a New Application](https://guides.rubyonrails.org/v7.2/api_app.html\#creating-a-new-application)
...
### [3.2 Generating a New Resource](https://guides.rubyonrails.org/v7.2/api_app.html\#generating-a-new-resource)
...
### [3.3 Changing an Existing Application](https://guides.rubyonrails.org/v7.2/api_app.html\#changing-an-existing-application)
...
In `config/environments/development.rb`, set [`config.debug_exception_response_format`](https://guides.rubyonrails.org/v7.2/configuring.html#config-debug-exception-response-format)
...
See the [internal middleware](https://guides.rubyonrails.org/v7.2/rails_on_rack.html#internal-middleware-stack)
...
### [4.1 Using Rack::Cache](https://guides.rubyonrails.org/v7.2/api_app.html\#using-rack-cache)
...
### [4.2 Using Rack::Sendfile](https://guides.rubyonrails.org/v7.2/api_app.html\#using-rack-sendfile)
...
this purpose using [`config.action_dispatch.x_sendfile_header`](https://guides.rubyonrails.org/v7.2/configuring.html#config-action-dispatch-x-sendfile-header) in the appropriate
...
### [4.3 Using ActionDispatch::Request](https://guides.rubyonrails.org/v7.2/api_app.html\#using-actiondispatch-request)
...
### [4.4 Using Session Middlewares](https://guides.rubyonrails.org/v7.2/api_app.html\#using-session-middlewares)
...
### [4.5 Other Middleware](https://guides.rubyonrails.org/v7.2/api_app.html\#other-middleware)
...
### [4.6 Removing Middleware](https://guides.rubyonrails.org/v7.2/api_app.html\#removing-middleware)
...
| `ActionController::Instrumentation` | Support for the instrumentation hooks defined by Action Controller (see [the instrumentation guide](https://guides.rubyonrails.org/v7.2/active_support_instrumentation.html#action-controller) for more information regarding this). |
...
### [5.1 Adding Other Modules](https://guides.rubyonrails.org/v7.2/api_app.html\#adding-other-modules)
