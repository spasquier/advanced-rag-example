[Skip to main content](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [Introduction](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#introduction)
02. [Project Structure](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#project-structure)
03. [config.autoload\_paths](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-paths)
04. [config.autoload\_lib(ignore:)](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-lib-ignore)
05. [config.autoload\_once\_paths](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-once-paths)
06. [config.autoload\_lib\_once(ignore:)](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-lib-once-ignore)
07. [Reloading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#reloading)
    - [Reloading and Stale Objects](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#reloading-and-stale-objects)
08. [Autoloading When the Application Boots](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#autoloading-when-the-application-boots)
    - [Use Case 1: During Boot, Load Reloadable Code](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#use-case-1-during-boot-load-reloadable-code)
    - [Use Case 2: During Boot, Load Code that Remains Cached](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#use-case-2-during-boot-load-code-that-remains-cached)
    - [Use Case 3: Configure Application Classes for Engines](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#use-case-3-configure-application-classes-for-engines)
09. [Eager Loading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#eager-loading)
10. [Single Table Inheritance](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#single-table-inheritance)
    - [Option 1: Enable Eager Loading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#option-1-enable-eager-loading)
    - [Option 2: Preload a Collapsed Directory](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#option-2-preload-a-collapsed-directory)
    - [Option 3: Preload a Regular Directory](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#option-3-preload-a-regular-directory)
    - [Option 4: Preload Types from the Database](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#option-4-preload-types-from-the-database)
11. [Customizing Inflections](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#customizing-inflections)
    - [Where Should Inflection Customization Go?](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#where-should-inflection-customization-go-questionmark)
12. [Custom Namespaces](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#custom-namespaces)
13. [Autoloading and Engines](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#autoloading-and-engines)
14. [Testing](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#testing)
    - [Manual Testing](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#manual-testing)
    - [Automated Testing](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#automated-testing)
15. [Troubleshooting](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#troubleshooting)
16. [Rails.autoloaders](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#rails-autoloaders)

## [1. Introduction](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#introduction)
...
## [2. Project Structure](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#project-structure)
...
## [3. config.autoload\_paths](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#config-autoload-paths)
...
You cannot autoload code in the autoload paths while the application boots. In particular, directly in `config/initializers/*.rb`. Please check [_Autoloading when the application boots_](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#autoloading-when-the-application-boots) down below for valid ways to do that.

The autoload paths are managed by the `Rails.autoloaders.main` autoloader.

## [4. config.autoload\_lib(ignore:)](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#config-autoload-lib-ignore)
...
## [5. config.autoload\_once\_paths](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#config-autoload-once-paths)
...
## [6. config.autoload\_lib\_once(ignore:)](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#config-autoload-lib-once-ignore)
...
## [7. Reloading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#reloading)
...
### [7.1. Reloading and Stale Objects](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#reloading-and-stale-objects)
...
## [8. Autoloading When the Application Boots](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#autoloading-when-the-application-boots)

While booting, applications can autoload from the autoload once paths, which are managed by the `once` autoloader. Please check the section [`config.autoload_once_paths`](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-once-paths) above.
...
### [8.1. Use Case 1: During Boot, Load Reloadable Code](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#use-case-1-during-boot-load-reloadable-code)

#### [8.1.1. Autoload on Boot and on Each Reload](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#autoload-on-boot-and-on-each-reload)
...
#### [8.1.2. Autoload on Boot Only](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#autoload-on-boot-only)
...
### [8.2. Use Case 2: During Boot, Load Code that Remains Cached](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#use-case-2-during-boot-load-code-that-remains-cached)
...
As noted above, another option is to have the directory that defines them in the autoload once paths and autoload. Please check the [section about config.autoload\_once\_paths](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#config-autoload-once-paths) for details.

### [8.3. Use Case 3: Configure Application Classes for Engines](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#use-case-3-configure-application-classes-for-engines)
...
## [9. Eager Loading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#eager-loading)
...
Eager loading is controlled by the flag [`config.eager_load`](https://guides.rubyonrails.org/v8.1/configuring.html#config-eager-load), which is disabled by default in all environments except `production`. When a Rake task gets executed, `config.eager_load` is overridden by [`config.rake_eager_load`](https://guides.rubyonrails.org/v8.1/configuring.html#config-rake-eager-load), which is `false` by default. So, by default, in production environments Rake tasks do not eager load the application.
...
### [10.1. Option 1: Enable Eager Loading](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#option-1-enable-eager-loading)
...
### [10.2. Option 2: Preload a Collapsed Directory](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#option-2-preload-a-collapsed-directory)
...
### [10.3. Option 3: Preload a Regular Directory](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#option-3-preload-a-regular-directory)
...
### [10.4. Option 4: Preload Types from the Database](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#option-4-preload-types-from-the-database)
...
### [11.1. Where Should Inflection Customization Go?](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#where-should-inflection-customization-go-questionmark)
...
### [14.1. Manual Testing](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#manual-testing)
...
### [14.2. Automated Testing](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html\#automated-testing)

It is a good practice to verify in the test suite that the project eager loads correctly.

That covers Zeitwerk naming compliance and other possible error conditions. Please check the [section about testing eager loading](https://guides.rubyonrails.org/v8.1/testing.html#testing-eager-loading) in the [_Testing Rails Applications_](https://guides.rubyonrails.org/v8.1/testing.html) guide.
...
[Back to top](https://guides.rubyonrails.org/v8.1/autoloading_and_reloading_constants.html#main-skip-link)