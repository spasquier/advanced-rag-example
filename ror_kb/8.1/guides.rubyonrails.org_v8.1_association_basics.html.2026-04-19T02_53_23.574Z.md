[Skip to main content](https://guides.rubyonrails.org/v8.1/association_basics.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/association_basics.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [Associations Overview](https://guides.rubyonrails.org/v8.1/association_basics.html#associations-overview)
   - [Without Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#without-associations)
   - [Using Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#using-associations)
2. [Types of Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#types-of-associations)
   - [`belongs_to`](https://guides.rubyonrails.org/v8.1/association_basics.html#belongs-to)
   - [`has_one`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-one)
   - [`has_many`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many)
   - [`has_many :through`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through)
   - [`has_one :through`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-one-through)
   - [`has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-and-belongs-to-many)
3. [Choosing an Association](https://guides.rubyonrails.org/v8.1/association_basics.html#choosing-an-association)
   - [`belongs_to` vs `has_one`](https://guides.rubyonrails.org/v8.1/association_basics.html#belongs-to-vs-has-one)
   - [`has_many :through` vs `has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through-vs-has-and-belongs-to-many)
4. [Advanced Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#advanced-associations)
   - [Polymorphic Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations)
   - [Models with Composite Primary Keys](https://guides.rubyonrails.org/v8.1/association_basics.html#models-with-composite-primary-keys)
   - [Self Joins](https://guides.rubyonrails.org/v8.1/association_basics.html#self-joins)
5. [Single Table Inheritance (STI)](https://guides.rubyonrails.org/v8.1/association_basics.html#single-table-inheritance-sti)
   - [Generating the Base Vehicle Model](https://guides.rubyonrails.org/v8.1/association_basics.html#generating-the-base-vehicle-model)
   - [Generating Child Models](https://guides.rubyonrails.org/v8.1/association_basics.html#generating-child-models)
   - [Creating Records](https://guides.rubyonrails.org/v8.1/association_basics.html#creating-records)
   - [Querying Records](https://guides.rubyonrails.org/v8.1/association_basics.html#querying-records)
   - [Adding Specific Behavior](https://guides.rubyonrails.org/v8.1/association_basics.html#adding-specific-behavior)
   - [Controllers](https://guides.rubyonrails.org/v8.1/association_basics.html#controllers)
   - [Overriding the inheritance column](https://guides.rubyonrails.org/v8.1/association_basics.html#overriding-the-inheritance-column)
   - [Disabling the inheritance column](https://guides.rubyonrails.org/v8.1/association_basics.html#disabling-the-inheritance-column)
   - [Considerations](https://guides.rubyonrails.org/v8.1/association_basics.html#considerations)
6. [Delegated Types](https://guides.rubyonrails.org/v8.1/association_basics.html#delegated-types)
   - [Setting up Delegated Types](https://guides.rubyonrails.org/v8.1/association_basics.html#setting-up-delegated-types)
   - [Generating Models](https://guides.rubyonrails.org/v8.1/association_basics.html#generating-models)
   - [Declaring `delegated_type`](https://guides.rubyonrails.org/v8.1/association_basics.html#declaring-delegated-type)
   - [Defining the `Entryable` Module](https://guides.rubyonrails.org/v8.1/association_basics.html#defining-the-entryable-module)
   - [Object creation](https://guides.rubyonrails.org/v8.1/association_basics.html#object-creation)
   - [Adding further delegation](https://guides.rubyonrails.org/v8.1/association_basics.html#adding-further-delegation)
7. [Tips, Tricks, and Warnings](https://guides.rubyonrails.org/v8.1/association_basics.html#tips-tricks-and-warnings)
   - [Controlling Association Caching](https://guides.rubyonrails.org/v8.1/association_basics.html#controlling-association-caching)
   - [Avoiding Name Collisions](https://guides.rubyonrails.org/v8.1/association_basics.html#avoiding-name-collisions)
   - [Updating the Schema](https://guides.rubyonrails.org/v8.1/association_basics.html#updating-the-schema)
   - [Controlling Association Scope](https://guides.rubyonrails.org/v8.1/association_basics.html#controlling-association-scope)
   - [Bi-directional Associations](https://guides.rubyonrails.org/v8.1/association_basics.html#bi-directional-associations)
8. [Association References](https://guides.rubyonrails.org/v8.1/association_basics.html#association-references)
   - [Options](https://guides.rubyonrails.org/v8.1/association_basics.html#options)
   - [Scopes](https://guides.rubyonrails.org/v8.1/association_basics.html#scopes)
   - [Counter Cache](https://guides.rubyonrails.org/v8.1/association_basics.html#counter-cache)
   - [Callbacks](https://guides.rubyonrails.org/v8.1/association_basics.html#callbacks)
   - [Extensions](https://guides.rubyonrails.org/v8.1/association_basics.html#extensions)
...
### [1.1. Without Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#without-associations)
...
### [1.2. Using Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#using-associations)
...
[migration](https://guides.rubyonrails.org/v8.1/active_record_migrations.html) to ensure that the database is
...
- [`belongs_to`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-belongs_to)
- [`has_one`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_one)
- [`has_many`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_many)
- [`has_many :through`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_many)
- [`has_one :through`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_one)
- [`has_and_belongs_to_many`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_and_belongs_to_many)
...
### [2.1.`belongs_to`](https://guides.rubyonrails.org/v8.1/association_basics.html\#belongs-to)

A [`belongs_to`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-belongs_to) association sets up a relationship with another model, such
...
![belongs_to Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/belongs_to.png)

A `belongs_to` association _must_ use the singular term. If you use the
...
association](https://guides.rubyonrails.org/v8.1/association_basics.html#bi-directional-associations) \- use `belongs_to` in combination
...
#### [2.1.1. Methods Added by `belongs_to`](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-belongs-to)
...
API](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-belongs_to).
...
##### [2.1.1.1. Retrieving the association](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-belongs-to-retrieving-the-association)
...
##### [2.1.1.2. Assigning the Association](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-belongs-to-assigning-the-association)
...
##### [2.1.1.3. Checking for Association Changes](https://guides.rubyonrails.org/v8.1/association_basics.html\#checking-for-association-changes)
...
##### [2.1.1.4. Checking for Existing Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-belongs-to-checking-for-existing-associations)
...
##### [2.1.1.5. Saving Behavior of Associated Objects](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-belongs-to-saving-behavior-of-associated-objects)
...
### [2.2.`has_one`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-one)

A [`has_one`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_one) association indicates that one other model has a reference to
...
![has_one Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/has_one.png)
...
This relation can be [bi-directional](https://guides.rubyonrails.org/v8.1/association_basics.html#bi-directional-associations) when used in
combination with `belongs_to` on the other model.

#### [2.2.1. Methods Added by](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-one) [`has_one`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-one)
...
We'll discuss some of the common methods, but you can find an exhaustive list in
the [ActiveRecord Associations\\
API](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_one).

Like with the [`belongs_to` references](https://guides.rubyonrails.org/v8.1/association_basics.html#methods-added-by-belongs-to), in all of
...
##### [2.2.1.1. Retrieving the association](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-one-retrieving-the-association)
...
##### [2.2.1.2. Assigning the Association](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-one-assigning-the-association)
...
##### [2.2.1.3. Checking for Existing Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-one-checking-for-existing-associations)
...
##### [2.2.1.4. Saving Behavior of Associated Objects](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-one-saving-behavior-of-associated-objects)
...
### [2.3.`has_many`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-many)

A [`has_many`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_many) association is similar to `has_one`, but indicates a
...
![has_many Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/has_many.png)
...
level, add the [`foreign_key: true`](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#foreign-keys)
...
#### [2.3.1. Methods Added by `has_many`](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many)
...
- `collection`
- [`collection<<(object, ...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-3C-3C)
- [`collection.delete(object, ...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-delete)
- [`collection.destroy(object, ...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-destroy)
- `collection=(objects)`
- `collection_singular_ids`
- `collection_singular_ids=(ids)`
- [`collection.clear`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-clear)
- [`collection.empty?`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-empty-3F)
- [`collection.size`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-size)
- [`collection.find(...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-find)
- [`collection.where(...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/QueryMethods.html#method-i-where)
- [`collection.exists?(...)`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/FinderMethods.html#method-i-exists-3F)
- [`collection.build(attributes = {})`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-build)
- [`collection.create(attributes = {})`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-create)
...
- [`collection.reload`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-reload)

We'll discuss some of the common methods, but you can find an exhaustive list in
the [ActiveRecord Associations\\
API](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_many).
...
##### [2.3.1.1. Managing the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many-managing-the-collection)
...
The [`collection.delete`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-delete) method removes one or more objects from the
...
The [`collection.destroy`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-destroy) method removes one or more objects from the
...
Objects will _always_ be removed from the database, ignoring the
`:dependent` option.

The [`collection.clear`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-clear) method removes all objects from the collection
...
The [`collection.reload`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-reload) method returns a Relation of all of the associated
...
##### [2.3.1.2. Assigning the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many-assigning-the-collection)
...
##### [2.3.1.3. Querying the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many-querying-the-collection)
...
The [`collection.empty?`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-empty-3F) method returns `true` if the collection does not
...
The [`collection.size`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-size) method returns the number of objects in the
collection.
...
The [`collection.where`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/QueryMethods.html#method-i-where) method finds objects within the collection based on
...
The [`collection.exists?`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/FinderMethods.html#method-i-exists-3F) method checks whether an object meeting the
supplied conditions exists in the collection's table.

##### [2.3.1.4. Building and Creating Associated Objects](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many-building-and-creating-associated-objects)

The [`collection.build`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-build) method returns a single or array of new objects of
...
The [`collection.create`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-create) method returns a single or array of new objects of
the associated type. The object(s) will be instantiated from the passed
...
##### [2.3.1.5. When are Objects Saved?](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-many-when-are-objects-saved-questionmark)
...
### [2.4.`has_many :through`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-many-through)

A [`has_many :through`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_many) association is often used to set up a
...
![has_many :through Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/has_many_through.png)
...
through associations, but it cannot be [polymorphic](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations).
...
key](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html) for the join table in the
...
methods](https://guides.rubyonrails.org/v8.1/association_basics.html#methods-added-by-has-many). For example, if you assign a list of
...
Guide](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html).
...
### [2.5.`has_one :through`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-one-through)

A [`has_one :through`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_one) association sets up a one-to-one relationship
...
![has_one :through Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/has_one_through.png)
...
### [2.6.`has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-and-belongs-to-many)

A [`has_and_belongs_to_many`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_and_belongs_to_many) association creates a direct many-to-many
...
![has_and_belongs_to_many Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/habtm.png)
...
#### [2.6.1. Methods Added by `has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many)
...
We'll discuss some of the common methods, but you can find an exhaustive list in
the [ActiveRecord Associations\\
API](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html#method-i-has_and_belongs_to_many).
...
##### [2.6.1.1. Managing the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many-managing-the-collection)
...
The [`collection<<`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-3C-3C) method adds one or more objects to the collection by
...
The [`collection.clear`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-clear) method removes every object from the collection by
deleting the rows from the joining table. This does not destroy the associated
objects.

##### [2.6.1.2. Assigning the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many-assigning-the-collection)
...
##### [2.6.1.3. Querying the Collection](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many-querying-the-collection)
...
##### [2.6.1.4. Building and Creating Associated Objects](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many-building-and-creating-associated-objects)

The [`collection.build`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-build) method returns a new object of the associated type.
...
The [`collection.create`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/CollectionProxy.html#method-i-create) method returns a new object of the associated type.
...
##### [2.6.1.5. When are Objects Saved?](https://guides.rubyonrails.org/v8.1/association_basics.html\#methods-added-by-has-and-belongs-to-many-when-are-objects-saved-questionmark)
...
### [3.1.`belongs_to` vs `has_one`](https://guides.rubyonrails.org/v8.1/association_basics.html\#belongs-to-vs-has-one)
...
belongs\_to association. In this case the `account` table.

### [3.2.`has_many :through` vs `has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html\#has-many-through-vs-has-and-belongs-to-many)
...
key](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html)).
...
- You require [validations](https://guides.rubyonrails.org/v8.1/active_record_validations.html) or
[callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html) on the join model.
...
### [4.1. Polymorphic Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#polymorphic-associations)
...
![Polymorphic Association Diagram](https://guides.rubyonrails.org/v8.1/images/association_basics/polymorphic.png)
...
### [4.2. Models with Composite Primary Keys](https://guides.rubyonrails.org/v8.1/association_basics.html\#models-with-composite-primary-keys)
...
guide](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html#associations-between-models-with-composite-primary-keys).
...
### [4.3. Self Joins](https://guides.rubyonrails.org/v8.1/association_basics.html\#self-joins)
...
[`SchemaStatements#add_reference`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_reference).
...
### [5.1. Generating the Base Vehicle Model](https://guides.rubyonrails.org/v8.1/association_basics.html\#generating-the-base-vehicle-model)
...
### [5.2. Generating Child Models](https://guides.rubyonrails.org/v8.1/association_basics.html\#generating-child-models)
...
### [5.3. Creating Records](https://guides.rubyonrails.org/v8.1/association_basics.html\#creating-records)
...
### [5.4. Querying Records](https://guides.rubyonrails.org/v8.1/association_basics.html\#querying-records)
...
### [5.5. Adding Specific Behavior](https://guides.rubyonrails.org/v8.1/association_basics.html\#adding-specific-behavior)
...
### [5.6. Controllers](https://guides.rubyonrails.org/v8.1/association_basics.html\#controllers)
...
### [5.7. Overriding the inheritance column](https://guides.rubyonrails.org/v8.1/association_basics.html\#overriding-the-inheritance-column)
...
[inheritance\_column](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ModelSchema.html#method-c-inheritance_column) method.
...
### [5.8. Disabling the inheritance column](https://guides.rubyonrails.org/v8.1/association_basics.html\#disabling-the-inheritance-column)

There may be cases (like when working with a legacy database) where you need to
disable Single Table Inheritance altogether. If you don't disable STI properly,
you might encounter an [`ActiveRecord::SubclassNotFound`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/SubclassNotFound.html) error.

To disable STI, you can set the [inheritance\_column](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ModelSchema.html#method-c-inheritance_column) to `nil`.
...
### [5.9. Considerations](https://guides.rubyonrails.org/v8.1/association_basics.html\#considerations)

[`Single Table Inheritance (STI)`](https://guides.rubyonrails.org/v8.1/association_basics.html#single-table-inheritance-sti) works best
...
used by others. This can be solved by using [`Delegated Types`](https://guides.rubyonrails.org/v8.1/association_basics.html#delegated-types).

Additionally, if you’re using [polymorphic\\
associations](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations), where a model can belong to more than
...
(STI)`](https://guides.rubyonrails.org/v8.1/association_basics.html#single-table-inheritance-sti) problem of table bloat via
...
### [6.1. Setting up Delegated Types](https://guides.rubyonrails.org/v8.1/association_basics.html\#setting-up-delegated-types)
...
### [6.2. Generating Models](https://guides.rubyonrails.org/v8.1/association_basics.html\#generating-models)
...
### [6.3. Declaring `delegated_type`](https://guides.rubyonrails.org/v8.1/association_basics.html\#declaring-delegated-type)
...
### [6.4. Defining the `Entryable` Module](https://guides.rubyonrails.org/v8.1/association_basics.html\#defining-the-entryable-module)
...
| `Entry#comment_id` | Returns entryable\_id, when `entryable_type == "Comment"`, otherwise `nil` |

### [6.5. Object creation](https://guides.rubyonrails.org/v8.1/association_basics.html\#object-creation)
...
### [6.6. Adding further delegation](https://guides.rubyonrails.org/v8.1/association_basics.html\#adding-further-delegation)
...
### [7.1. Controlling Association Caching](https://guides.rubyonrails.org/v8.1/association_basics.html\#controlling-association-caching)
...
[`reload`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Relation.html#method-i-reload)
on the association:
...
### [7.2. Avoiding Name Collisions](https://guides.rubyonrails.org/v8.1/association_basics.html\#avoiding-name-collisions)
...
### [7.3. Updating the Schema](https://guides.rubyonrails.org/v8.1/association_basics.html\#updating-the-schema)
...
associations](https://guides.rubyonrails.org/v8.1/association_basics.html#belongs-to) and setting up the correct join table for [`has_many\\
:through`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through) and
[`has_and_belongs_to_many`](https://guides.rubyonrails.org/v8.1/association_basics.html#has-and-belongs-to-many) associations. You can read
more about when to use a `has_many :through vs has_and_belongs_to_many` [in the\\
has many through vs has and belongs to many\\
section](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through-vs-has-and-belongs-to-many).

#### [7.3.1. Creating Foreign Keys for `belongs_to` Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#creating-foreign-keys-for-belongs-to-associations)

When you declare a [`belongs_to` association](https://guides.rubyonrails.org/v8.1/association_basics.html#belongs-to), you need to create
...
#### [7.3.2. Creating Join Tables for `has_and_belongs_to_many` Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#creating-join-tables-for-has-and-belongs-to-many-associations)
...
give the default join table name of "authors\_books" because "a" outranks "b" in
lexical ordering.
...
Migration Guides](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-a-join-table)

#### [7.3.3. Creating Join Tables for `has_many :through` Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#creating-join-tables-for-has-many-through-associations)
...
### [7.4. Controlling Association Scope](https://guides.rubyonrails.org/v8.1/association_basics.html\#controlling-association-scope)
...
### [7.5. Bi-directional Associations](https://guides.rubyonrails.org/v8.1/association_basics.html\#bi-directional-associations)
...
- Validate the [presence](https://guides.rubyonrails.org/v8.1/active_record_validations.html#presence) and
[absence](https://guides.rubyonrails.org/v8.1/active_record_validations.html#absence) of associations in more
cases:
...
[`config.active_record.automatic_scope_inversing`](https://guides.rubyonrails.org/v8.1/configuring.html#config-active-record-automatic-scope-inversing) is set to true.
...
### [8.1. Options](https://guides.rubyonrails.org/v8.1/association_basics.html\#options)
...
API](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Associations/ClassMethods.html).
We'll discuss some of the common use cases below.

#### [8.1.1.`:class_name`](https://guides.rubyonrails.org/v8.1/association_basics.html\#class-name)
...
#### [8.1.2.`:dependent`](https://guides.rubyonrails.org/v8.1/association_basics.html\#dependent)
...
#### [8.1.3.`:foreign_key`](https://guides.rubyonrails.org/v8.1/association_basics.html\#foreign-key)
...
#### [8.1.4.`:primary_key`](https://guides.rubyonrails.org/v8.1/association_basics.html\#primary-key)
...
with has\_many `:through` association, which gives more flexibility and supports
the `:primary_key` option. You can read more about this in the
[`has_many :through` section](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through).

#### [8.1.5.`:touch`](https://guides.rubyonrails.org/v8.1/association_basics.html\#touch)
...
#### [8.1.6.`:validate`](https://guides.rubyonrails.org/v8.1/association_basics.html\#validate)
...
has\_many `:through` association. You can read more about this in the
[`has_many :through` section](https://guides.rubyonrails.org/v8.1/association_basics.html#has-many-through).

#### [8.1.7.`:inverse_of`](https://guides.rubyonrails.org/v8.1/association_basics.html\#inverse-of)
...
association](https://guides.rubyonrails.org/v8.1/association_basics.html#bi-directional-associations) section for more details.
...
#### [8.1.8.`:source_type`](https://guides.rubyonrails.org/v8.1/association_basics.html\#source-type)
...
association](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations).
...
#### [8.1.9.`:strict_loading`](https://guides.rubyonrails.org/v8.1/association_basics.html\#strict-loading)

Enforces strict loading every time an associated record is loaded through this
association.

#### [8.1.10.`:association_foreign_key`](https://guides.rubyonrails.org/v8.1/association_basics.html\#association-foreign-key)
...
#### [8.1.11.`:join_table`](https://guides.rubyonrails.org/v8.1/association_basics.html\#join-table)
...
#### [8.1.12.`:deprecated`](https://guides.rubyonrails.org/v8.1/association_basics.html\#deprecated)
...
### [8.2. Scopes](https://guides.rubyonrails.org/v8.1/association_basics.html\#scopes)
...
#### [8.2.1. General Scopes](https://guides.rubyonrails.org/v8.1/association_basics.html\#general-scopes)

You can use any of the standard [querying methods](https://guides.rubyonrails.org/v8.1/active_record_querying.html)
...
##### [8.2.1.1.`where`](https://guides.rubyonrails.org/v8.1/association_basics.html\#where)
...
##### [8.2.1.2.`includes`](https://guides.rubyonrails.org/v8.1/association_basics.html\#includes)
...
##### [8.2.1.3.`readonly`](https://guides.rubyonrails.org/v8.1/association_basics.html\#readonly)
...
##### [8.2.1.4.`select`](https://guides.rubyonrails.org/v8.1/association_basics.html\#general-scopes-select)
...
#### [8.2.2. Collection Scopes](https://guides.rubyonrails.org/v8.1/association_basics.html\#collection-scopes)
...
##### [8.2.2.1.`group`](https://guides.rubyonrails.org/v8.1/association_basics.html\#group)
...
##### [8.2.2.2.`limit`](https://guides.rubyonrails.org/v8.1/association_basics.html\#limit)
...
##### [8.2.2.3.`order`](https://guides.rubyonrails.org/v8.1/association_basics.html\#order)
...
##### [8.2.2.4.`select`](https://guides.rubyonrails.org/v8.1/association_basics.html\#collection-scopes-select)
...
##### [8.2.2.5.`distinct`](https://guides.rubyonrails.org/v8.1/association_basics.html\#distinct)
...
#### [8.2.3. Using the Association Owner](https://guides.rubyonrails.org/v8.1/association_basics.html\#using-the-association-owner)
...
### [8.3. Counter Cache](https://guides.rubyonrails.org/v8.1/association_basics.html\#counter-cache)
...
[`reset_counters`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/CounterCache/ClassMethods.html#method-i-reset_counters).

### [8.4. Callbacks](https://guides.rubyonrails.org/v8.1/association_basics.html\#callbacks)

[Normal callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html) hook into the life cycle of
...
Guide](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html#association-callbacks)

### [8.5. Extensions](https://guides.rubyonrails.org/v8.1/association_basics.html\#extensions)
...
[Back to top](https://guides.rubyonrails.org/v8.1/association_basics.html#main-skip-link)