...
1. [What is Action View?](https://guides.rubyonrails.org/v6.1/action_view_overview.html#what-is-action-view-questionmark)
2. [Using Action View with Rails](https://guides.rubyonrails.org/v6.1/action_view_overview.html#using-action-view-with-rails)
3. [Templates, Partials, and Layouts](https://guides.rubyonrails.org/v6.1/action_view_overview.html#templates-partials-and-layouts)   - [Templates](https://guides.rubyonrails.org/v6.1/action_view_overview.html#templates)
   - [Partials](https://guides.rubyonrails.org/v6.1/action_view_overview.html#partials)
   - [Layouts](https://guides.rubyonrails.org/v6.1/action_view_overview.html#layouts)
4. [Partial Layouts](https://guides.rubyonrails.org/v6.1/action_view_overview.html#partial-layouts)
5. [View Paths](https://guides.rubyonrails.org/v6.1/action_view_overview.html#view-paths)   - [Prepend view path](https://guides.rubyonrails.org/v6.1/action_view_overview.html#prepend-view-path)
   - [Append view path](https://guides.rubyonrails.org/v6.1/action_view_overview.html#append-view-path)
6. [Helpers](https://guides.rubyonrails.org/v6.1/action_view_overview.html#helpers)
7. [Localized Views](https://guides.rubyonrails.org/v6.1/action_view_overview.html#localized-views)

### [1 What is Action View?](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#what-is-action-view-questionmark)

In Rails, web requests are handled by [Action Controller](https://guides.rubyonrails.org/v6.1/action_controller_overview.html) and Action View. Typically, Action Controller is concerned with communicating with the database and performing CRUD actions where necessary. Action View is then responsible for compiling the response.
...
### [3 Templates, Partials, and Layouts](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#templates-partials-and-layouts)
...
#### [3.1 Templates](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#templates)
...
##### [3.1.1 ERB](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#erb)
...
##### [3.1.2 Builder](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#builder)
...
##### [3.1.3 Jbuilder](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#jbuilder)
...
##### [3.1.4 Template Caching](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#template-caching)
...
#### [3.2 Partials](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#partials)
...
##### [3.2.1 Naming Partials](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#naming-partials)
...
##### [3.2.2 Using Partials to simplify Views](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#using-partials-to-simplify-views)
...
##### [3.2.3 `render` without `partial` and `locals` options](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#render-without-partial-and-locals-options)
...
##### [3.2.4 The `as` and `object` options](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#the-as-and-object-options)
...
##### [3.2.5 Rendering Collections](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#rendering-collections)
...
##### [3.2.6 Spacer Templates](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#spacer-templates)
...
#### [3.3 Layouts](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#layouts)
...
### [5 View Paths](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#view-paths)
...
#### [5.1 Prepend view path](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#prepend-view-path)
...
#### [5.2 Append view path](https://guides.rubyonrails.org/v6.1/action_view_overview.html\#append-view-path)
...
Guide](https://guides.rubyonrails.org/v6.1/action_view_helpers.html) and the [Action View Form Helpers\\
...
You can read more about the Rails Internationalization (I18n) API [here](https://guides.rubyonrails.org/v6.1/i18n.html).
