...
1. [What is an API Application?](https://guides.rubyonrails.org/v6.1/api_app.html#what-is-an-api-application-questionmark)
2. [Why Use Rails for JSON APIs?](https://guides.rubyonrails.org/v6.1/api_app.html#why-use-rails-for-json-apis-questionmark)
3. [The Basic Configuration](https://guides.rubyonrails.org/v6.1/api_app.html#the-basic-configuration)   - [Creating a new application](https://guides.rubyonrails.org/v6.1/api_app.html#creating-a-new-application)
   - [Changing an existing application](https://guides.rubyonrails.org/v6.1/api_app.html#changing-an-existing-application)
4. [Choosing Middleware](https://guides.rubyonrails.org/v6.1/api_app.html#choosing-middleware)   - [Using the Cache Middleware](https://guides.rubyonrails.org/v6.1/api_app.html#using-the-cache-middleware)
   - [Using Rack::Sendfile](https://guides.rubyonrails.org/v6.1/api_app.html#using-rack-sendfile)
   - [Using ActionDispatch::Request](https://guides.rubyonrails.org/v6.1/api_app.html#using-actiondispatch-request)
   - [Using Session Middlewares](https://guides.rubyonrails.org/v6.1/api_app.html#using-session-middlewares)
   - [Other Middleware](https://guides.rubyonrails.org/v6.1/api_app.html#other-middleware)
   - [Removing Middleware](https://guides.rubyonrails.org/v6.1/api_app.html#removing-middleware)
5. [Choosing Controller Modules](https://guides.rubyonrails.org/v6.1/api_app.html#choosing-controller-modules)   - [Adding Other Modules](https://guides.rubyonrails.org/v6.1/api_app.html#adding-other-modules)
...
[`stale?`](https://api.rubyonrails.org/v6.1.7.10/classes/ActionController/ConditionalGet.html#method-i-stale-3F)
...
### [3 The Basic Configuration](https://guides.rubyonrails.org/v6.1/api_app.html\#the-basic-configuration)
...
#### [3.1 Creating a new application](https://guides.rubyonrails.org/v6.1/api_app.html\#creating-a-new-application)
...
#### [3.2 Changing an existing application](https://guides.rubyonrails.org/v6.1/api_app.html\#changing-an-existing-application)
...
### [4 Choosing Middleware](https://guides.rubyonrails.org/v6.1/api_app.html\#choosing-middleware)
...
See the [internal middleware](https://guides.rubyonrails.org/v6.1/rails_on_rack.html#internal-middleware-stack)
...
#### [4.1 Using the Cache Middleware](https://guides.rubyonrails.org/v6.1/api_app.html\#using-the-cache-middleware)
...
#### [4.2 Using Rack::Sendfile](https://guides.rubyonrails.org/v6.1/api_app.html\#using-rack-sendfile)
...
#### [4.3 Using ActionDispatch::Request](https://guides.rubyonrails.org/v6.1/api_app.html\#using-actiondispatch-request)
...
#### [4.4 Using Session Middlewares](https://guides.rubyonrails.org/v6.1/api_app.html\#using-session-middlewares)
...
#### [4.5 Other Middleware](https://guides.rubyonrails.org/v6.1/api_app.html\#other-middleware)
...
#### [4.6 Removing Middleware](https://guides.rubyonrails.org/v6.1/api_app.html\#removing-middleware)
...
### [5 Choosing Controller Modules](https://guides.rubyonrails.org/v6.1/api_app.html\#choosing-controller-modules)
...
guide](https://guides.rubyonrails.org/v6.1/active_support_instrumentation.html#action-controller) for
...
#### [5.1 Adding Other Modules](https://guides.rubyonrails.org/v6.1/api_app.html\#adding-other-modules)
