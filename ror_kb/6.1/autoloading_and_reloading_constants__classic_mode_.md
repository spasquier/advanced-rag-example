...
01. [Introduction](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#introduction)
02. [Constants Refresher](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constants-refresher)    - [Nesting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#nesting)
    - [Class and Module Definitions are Constant Assignments](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#class-and-module-definitions-are-constant-assignments)
    - [Constants are Stored in Modules](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constants-are-stored-in-modules)
    - [Resolution Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#resolution-algorithms)
03. [Vocabulary](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#vocabulary)    - [Parent Namespaces](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#parent-namespaces)
    - [Loading Mechanism](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#loading-mechanism)
04. [Autoloading Availability](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-availability)
05. [autoload\_paths and eager\_load\_paths](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoload-paths-and-eager-load-paths)
06. [Autoloading Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms)    - [Relative References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms-relative-references)
    - [Qualified References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms-qualified-references)
    - [Automatic Modules](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#automatic-modules)
    - [Generic Procedure](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#generic-procedure)
07. [require\_dependency](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#require-dependency)
08. [Constant Reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constant-reloading)
09. [Common Gotchas](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#common-gotchas)    - [Nesting and Qualified Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#nesting-and-qualified-constants)
    - [Defining vs Reopening Namespaces](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#defining-vs-reopening-namespaces)
    - [Autoloading and STI](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-and-sti)
    - [Autoloading and `require`](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-and-require)
    - [Autoloading and Initializers](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-and-initializers)
    - [`require_dependency` and Initializers](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#require-dependency-and-initializers)
    - [When Constants aren't Missed](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#when-constants-aren-t-missed)
    - [Autoloading within Singleton Classes](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-within-singleton-classes)
    - [Autoloading in `BasicObject`](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-in-basicobject)
    - [Autoloading in the Test Environment](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-in-the-test-environment)
10. [Troubleshooting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#troubleshooting)    - [Tracing Autoloads](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#tracing-autoloads)
    - [Where is a Given Autoload Triggered?](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#where-is-a-given-autoload-triggered-questionmark)
    - [Which Constants Have Been Autoloaded?](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#which-constants-have-been-autoloaded-questionmark)

### [1 Introduction](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#introduction)

This guide documents autoloading in `classic` mode, which is the traditional one. If you'd like to read about `zeitwerk` mode instead, the new one in Rails 6, please check [Autoloading and Reloading Constants (Zeitwerk Mode)](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants.html).
...
### [2 Constants Refresher](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#constants-refresher)
...
#### [2.1 Nesting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#nesting)
...
The _nesting_ at any given place is the collection of enclosing nested class and
...
_objects_, it has nothing to do with the constants used to access them, and is
...
#### [2.2 Class and Module Definitions are Constant Assignments](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#class-and-module-definitions-are-constant-assignments)
...
The execution context of a block passed to `Class.new` or `Module.new`
...
That is why we talk about _constant_ autoloading, Rails has the ability to
load constants on the fly.

#### [2.3 Constants are Stored in Modules](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#constants-are-stored-in-modules)
...
#### [2.4 Resolution Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#resolution-algorithms)

##### [2.4.1 Resolution Algorithm for Relative Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#resolution-algorithm-for-relative-constants)

At any given place in the code, let's define _cref_ to be the first element of
...
References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms-relative-references).

##### [2.4.2 Resolution Algorithm for Qualified Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#resolution-algorithm-for-qualified-constants)
...
Leading colons would make the first segment absolute rather than
...
its resolution next. Let's define _parent_ to be that qualifying class or module
...
In Ruby < 2.5 `String::Hash` evaluates to `Hash` and the interpreter
...
### [3 Vocabulary](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#vocabulary)

#### [3.1 Parent Namespaces](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#parent-namespaces)

Given a string with a constant path we define its _parent namespace_ to be the
...
#### [3.2 Loading Mechanism](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#loading-mechanism)
...
reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constant-reloading) is enabled.
...
### [4 Autoloading Availability](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-availability)
...
### [5 autoload\_paths and eager\_load\_paths](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoload-paths-and-eager-load-paths)
...
- In **development**, you want quicker startup with incremental loading of application code. So `eager_load` should be set to `false`, and Rails will autoload files as needed (see [Autoloading Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms) below) -- and then reload them when they change (see [Constant Reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constant-reloading) below).
...
Rails Applications](https://guides.rubyonrails.org/v6.1/configuring.html#rails-general-configuration)). In the past, before
...
See also [Autoloading in the Test Environment](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-in-the-test-environment).
...
### [6 Autoloading Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-algorithms)

#### [6.1 Relative References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-algorithms-relative-references)
...
##### [6.1.1 Constants after the `class` and `module` Keywords](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#constants-after-the-class-and-module-keywords)
...
##### [6.1.2 Top-Level Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#top-level-constants)
...
##### [6.1.3 Namespaces](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#namespaces)
...
`'Constant::Name'.underscore` gives the relative path without extension of
...
is performed, we are going to see why in the [next section](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#automatic-modules):
...
#### [6.2 Qualified References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-algorithms-qualified-references)
...
#### [6.3 Automatic Modules](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#automatic-modules)
...
#### [6.4 Generic Procedure](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#generic-procedure)
...
Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#resolution-algorithm-for-relative-constants) at the beginning of
this guide for the definition of _cref_, and [Resolution Algorithm for Qualified\\
Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#resolution-algorithm-for-qualified-constants) for the definition of
_parent_).
...
### [7 require\_dependency](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#require-dependency)
...
to load a file using the current [loading mechanism](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#loading-mechanism), and
...
[Autoloading and STI](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-and-sti) and [When Constants aren't\\
Triggered](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#when-constants-aren-t-missed).
...
### [8 Constant Reloading](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#constant-reloading)
...
### [9 Common Gotchas](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#common-gotchas)

#### [9.1 Nesting and Qualified Constants](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#nesting-and-qualified-constants)
...
the latter because it does not belong to the nesting (see [Nesting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#nesting)
and [Resolution Algorithms](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#resolution-algorithms)).
...
#### [9.2 Defining vs Reopening Namespaces](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#defining-vs-reopening-namespaces)
...
#### [9.3 Autoloading and STI](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-and-sti)
...
That is not a bug, the query includes all _known_ descendants of `Rectangle`.
...
#### [9.4 Autoloading and `require`](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-and-require)
...
#### [9.5 Autoloading and Initializers](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-and-initializers)
...
As [we saw earlier](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constant-reloading), Rails removes autoloaded constants,
...
#### [9.6 `require_dependency` and Initializers](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#require-dependency-and-initializers)
...
One could think about doing some [`require_dependency`](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#require-dependency)
calls in an initializer to make sure certain constants are loaded upfront, for
example as an attempt to address the [gotcha with STIs](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-and-sti).

Problem is, in development mode [autoloaded constants are wiped](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#constant-reloading)
...
#### [9.7 When Constants aren't Missed](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#when-constants-aren-t-missed)

##### [9.7.1 Relative References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#when-constants-aren-t-missed-relative-references)
...
##### [9.7.2 Qualified References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#when-constants-aren-t-missed-qualified-references)

This gotcha is only possible in Ruby < 2.5.
...
As [we saw before](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#resolution-algorithm-for-qualified-constants), Ruby looks
...
To find this gotcha the qualifying namespace has to be a class,
`Object` is not an ancestor of modules.

#### [9.8 Autoloading within Singleton Classes](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-within-singleton-classes)
...
anonymous, and as [we saw before](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#generic-procedure), Rails only checks the
...
#### [9.9 Autoloading in `BasicObject`](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-in-basicobject)
...
`User` constant is known at that point, in particular in a _second_ call to
`user`:
...
References](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html#autoloading-algorithms-qualified-references)).
...
#### [9.10 Autoloading in the Test Environment](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#autoloading-in-the-test-environment)
...
Occasionally you may need to explicitly eager\_load by using `Rails
...
### [10 Troubleshooting](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#troubleshooting)

#### [10.1 Tracing Autoloads](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#tracing-autoloads)
...
#### [10.2 Where is a Given Autoload Triggered?](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#where-is-a-given-autoload-triggered-questionmark)
...
#### [10.3 Which Constants Have Been Autoloaded?](https://guides.rubyonrails.org/v6.1/autoloading_and_reloading_constants_classic_mode.html\#which-constants-have-been-autoloaded-questionmark)
