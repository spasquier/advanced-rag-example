...
- [Blog](https://weblog.rubyonrails.org/)
...
# [Guides.rubyonrails.org](https://guides.rubyonrails.org/v6.1.0/index.html "Return to home page")

- [Home](https://guides.rubyonrails.org/v6.1.0/index.html)
- [Guides Index](https://guides.rubyonrails.org/v6.1.0/index.html)
...
Start Here[Getting Started with Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html)



Models[Active Record Basics](https://guides.rubyonrails.org/v6.1.0/active_record_basics.html)[Active Record Migrations](https://guides.rubyonrails.org/v6.1.0/active_record_migrations.html)[Active Record Validations](https://guides.rubyonrails.org/v6.1.0/active_record_validations.html)[Active Record Callbacks](https://guides.rubyonrails.org/v6.1.0/active_record_callbacks.html)[Active Record Associations](https://guides.rubyonrails.org/v6.1.0/association_basics.html)[Active Record Query Interface](https://guides.rubyonrails.org/v6.1.0/active_record_querying.html)



Views[Layouts and Rendering in Rails](https://guides.rubyonrails.org/v6.1.0/layouts_and_rendering.html)[Action View Form Helpers](https://guides.rubyonrails.org/v6.1.0/form_helpers.html)



Controllers[Action Controller Overview](https://guides.rubyonrails.org/v6.1.0/action_controller_overview.html)[Rails Routing from the Outside In](https://guides.rubyonrails.org/v6.1.0/routing.html)



Other Components[Active Support Core Extensions](https://guides.rubyonrails.org/v6.1.0/active_support_core_extensions.html)[Action Mailer Basics](https://guides.rubyonrails.org/v6.1.0/action_mailer_basics.html)[Active Job Basics](https://guides.rubyonrails.org/v6.1.0/active_job_basics.html)[Active Storage Overview](https://guides.rubyonrails.org/v6.1.0/active_storage_overview.html)[Action Cable Overview](https://guides.rubyonrails.org/v6.1.0/action_cable_overview.html)



Digging Deeper[Rails Internationalization (I18n) API](https://guides.rubyonrails.org/v6.1.0/i18n.html)[Testing Rails Applications](https://guides.rubyonrails.org/v6.1.0/testing.html)[Securing Rails Applications](https://guides.rubyonrails.org/v6.1.0/security.html)[Debugging Rails Applications](https://guides.rubyonrails.org/v6.1.0/debugging_rails_applications.html)[Configuring Rails Applications](https://guides.rubyonrails.org/v6.1.0/configuring.html)[The Rails Command Line](https://guides.rubyonrails.org/v6.1.0/command_line.html)[The Asset Pipeline](https://guides.rubyonrails.org/v6.1.0/asset_pipeline.html)[Autoloading and Reloading Constants (Zeitwerk Mode)](https://guides.rubyonrails.org/v6.1.0/autoloading_and_reloading_constants.html)[Autoloading and Reloading Constants (Classic Mode)](https://guides.rubyonrails.org/v6.1.0/autoloading_and_reloading_constants_classic_mode.html)[Caching with Rails: An Overview](https://guides.rubyonrails.org/v6.1.0/caching_with_rails.html)[Using Rails for API-only Applications](https://guides.rubyonrails.org/v6.1.0/api_app.html)



Extending Rails[Rails on Rack](https://guides.rubyonrails.org/v6.1.0/rails_on_rack.html)[Creating and Customizing Rails Generators & Templates](https://guides.rubyonrails.org/v6.1.0/generators.html)



Contributions[Contributing to Ruby on Rails](https://guides.rubyonrails.org/v6.1.0/contributing_to_ruby_on_rails.html)[API Documentation Guidelines](https://guides.rubyonrails.org/v6.1.0/api_documentation_guidelines.html)[Guides Guidelines](https://guides.rubyonrails.org/v6.1.0/ruby_on_rails_guides_guidelines.html)



Policies[Maintenance Policy](https://guides.rubyonrails.org/v6.1.0/maintenance_policy.html)



Release Notes[Upgrading Ruby on Rails](https://guides.rubyonrails.org/v6.1.0/upgrading_ruby_on_rails.html)[Version 6.0 - August 2019](https://guides.rubyonrails.org/v6.1.0/6_0_release_notes.html)[Version 5.2 - April 2018](https://guides.rubyonrails.org/v6.1.0/5_2_release_notes.html)[Version 5.1 - April 2017](https://guides.rubyonrails.org/v6.1.0/5_1_release_notes.html)[Version 5.0 - June 2016](https://guides.rubyonrails.org/v6.1.0/5_0_release_notes.html)[Version 4.2 - December 2014](https://guides.rubyonrails.org/v6.1.0/4_2_release_notes.html)[Version 4.1 - April 2014](https://guides.rubyonrails.org/v6.1.0/4_1_release_notes.html)[Version 4.0 - June 2013](https://guides.rubyonrails.org/v6.1.0/4_0_release_notes.html)[Version 3.2 - January 2012](https://guides.rubyonrails.org/v6.1.0/3_2_release_notes.html)[Version 3.1 - August 2011](https://guides.rubyonrails.org/v6.1.0/3_1_release_notes.html)[Version 3.0 - August 2010](https://guides.rubyonrails.org/v6.1.0/3_0_release_notes.html)[Version 2.3 - March 2009](https://guides.rubyonrails.org/v6.1.0/2_3_release_notes.html)[Version 2.2 - November 2008](https://guides.rubyonrails.org/v6.1.0/2_2_release_notes.html)

- [Contribute](https://guides.rubyonrails.org/v6.1.0/contributing_to_ruby_on_rails.html)
- Guides IndexGetting Started with RailsActive Record BasicsActive Record MigrationsActive Record ValidationsActive Record CallbacksActive Record AssociationsActive Record Query InterfaceLayouts and Rendering in RailsAction View Form HelpersAction Controller OverviewRails Routing from the Outside InActive Support Core ExtensionsAction Mailer BasicsActive Job BasicsActive Storage OverviewAction Cable OverviewRails Internationalization (I18n) APITesting Rails ApplicationsSecuring Rails ApplicationsDebugging Rails ApplicationsConfiguring Rails ApplicationsThe Rails Command LineThe Asset PipelineAutoloading and Reloading Constants (Zeitwerk Mode)Autoloading and Reloading Constants (Classic Mode)Caching with Rails: An OverviewUsing Rails for API-only ApplicationsRails on RackCreating and Customizing Rails Generators & TemplatesContributing to Ruby on RailsAPI Documentation GuidelinesGuides GuidelinesMaintenance PolicyUpgrading Ruby on RailsVersion 6.0 - August 2019Version 5.2 - April 2018Version 5.1 - April 2017Version 5.0 - June 2016Version 4.2 - December 2014Version 4.1 - April 2014Version 4.0 - June 2013Version 3.2 - January 2012Version 3.1 - August 2011Version 3.0 - August 2010Version 2.3 - March 2009Version 2.2 - November 2008
...
### ![](https://guides.rubyonrails.org/v6.1.0/images/chapters_icon.gif)Chapters

01. [Guide Assumptions](https://guides.rubyonrails.org/v6.1.0/getting_started.html#guide-assumptions)
02. [What is Rails?](https://guides.rubyonrails.org/v6.1.0/getting_started.html#what-is-rails-questionmark)
03. [Creating a New Rails Project](https://guides.rubyonrails.org/v6.1.0/getting_started.html#creating-a-new-rails-project)    - [Installing Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html#creating-a-new-rails-project-installing-rails)
    - [Creating the Blog Application](https://guides.rubyonrails.org/v6.1.0/getting_started.html#creating-the-blog-application)
04. [Hello, Rails!](https://guides.rubyonrails.org/v6.1.0/getting_started.html#hello-rails-bang)    - [Starting up the Web Server](https://guides.rubyonrails.org/v6.1.0/getting_started.html#starting-up-the-web-server)
    - [Say "Hello", Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html#say-hello-rails)
    - [Setting the Application Home Page](https://guides.rubyonrails.org/v6.1.0/getting_started.html#setting-the-application-home-page)
05. [MVC and You](https://guides.rubyonrails.org/v6.1.0/getting_started.html#mvc-and-you)    - [Generating a Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html#mvc-and-you-generating-a-model)
    - [Database Migrations](https://guides.rubyonrails.org/v6.1.0/getting_started.html#database-migrations)
    - [Using a Model to Interact with the Database](https://guides.rubyonrails.org/v6.1.0/getting_started.html#using-a-model-to-interact-with-the-database)
    - [Showing a List of Articles](https://guides.rubyonrails.org/v6.1.0/getting_started.html#showing-a-list-of-articles)
06. [CRUDit Where CRUDit Is Due](https://guides.rubyonrails.org/v6.1.0/getting_started.html#crudit-where-crudit-is-due)    - [Showing a Single Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html#showing-a-single-article)
    - [Resourceful Routing](https://guides.rubyonrails.org/v6.1.0/getting_started.html#resourceful-routing)
    - [Creating a New Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html#creating-a-new-article)
    - [Updating an Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html#updating-an-article)
    - [Deleting an Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html#deleting-an-article)
07. [Adding a Second Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html#adding-a-second-model)    - [Generating a Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html#adding-a-second-model-generating-a-model)
    - [Associating Models](https://guides.rubyonrails.org/v6.1.0/getting_started.html#associating-models)
    - [Adding a Route for Comments](https://guides.rubyonrails.org/v6.1.0/getting_started.html#adding-a-route-for-comments)
    - [Generating a Controller](https://guides.rubyonrails.org/v6.1.0/getting_started.html#generating-a-controller)
08. [Refactoring](https://guides.rubyonrails.org/v6.1.0/getting_started.html#refactoring)    - [Rendering Partial Collections](https://guides.rubyonrails.org/v6.1.0/getting_started.html#rendering-partial-collections)
    - [Rendering a Partial Form](https://guides.rubyonrails.org/v6.1.0/getting_started.html#rendering-a-partial-form)
    - [Using Concerns](https://guides.rubyonrails.org/v6.1.0/getting_started.html#using-concerns)
09. [Deleting Comments](https://guides.rubyonrails.org/v6.1.0/getting_started.html#deleting-comments)    - [Deleting Associated Objects](https://guides.rubyonrails.org/v6.1.0/getting_started.html#deleting-associated-objects)
10. [Security](https://guides.rubyonrails.org/v6.1.0/getting_started.html#security)    - [Basic Authentication](https://guides.rubyonrails.org/v6.1.0/getting_started.html#basic-authentication)
    - [Other Security Considerations](https://guides.rubyonrails.org/v6.1.0/getting_started.html#other-security-considerations)
11. [What's Next?](https://guides.rubyonrails.org/v6.1.0/getting_started.html#what-s-next-questionmark)
12. [Configuration Gotchas](https://guides.rubyonrails.org/v6.1.0/getting_started.html#configuration-gotchas)

### [1 Guide Assumptions](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#guide-assumptions)
...
### [2 What is Rails?](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#what-is-rails-questionmark)
...
### [3 Creating a New Rails Project](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-a-new-rails-project)
...
#### [3.1 Installing Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-a-new-rails-project-installing-rails)
...
##### [3.1.1 Installing Ruby](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#installing-ruby)
...
##### [3.1.2 Installing SQLite3](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#installing-sqlite3)
...
##### [3.1.3 Installing Node.js and Yarn](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#installing-node-js-and-yarn)
...
##### [3.1.4 Installing Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-a-new-rails-project-installing-rails-installing-rails)
...
#### [3.2 Creating the Blog Application](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-the-blog-application)
...
| config/ | Contains configuration for your application's routes, database, and more. This is covered in more detail in [Configuring Rails Applications](https://guides.rubyonrails.org/v6.1.0/configuring.html). |
...
| storage/ | Active Storage files for Disk Service. This is covered in [Active Storage Overview](https://guides.rubyonrails.org/v6.1.0/active_storage_overview.html). |
| test/ | Unit tests, fixtures, and other test apparatus. These are covered in [Testing Rails Applications](https://guides.rubyonrails.org/v6.1.0/testing.html). |
| tmp/ | Temporary files (like cache and pid files). |
| vendor/ | A place for all third-party code. In a typical Rails application this includes vendored gems. |
| .gitignore | This file tells git which files (or patterns) it should ignore. See [GitHub - Ignoring files](https://help.github.com/articles/ignoring-files) for more info about ignoring files. |
| .ruby-version | This file contains the default Ruby version. |

### [4 Hello, Rails!](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#hello-rails-bang)

To begin with, let's get some text up on screen quickly. To do this, you need to
get your Rails application server running.

#### [4.1 Starting up the Web Server](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#starting-up-the-web-server)
...
![Yay! You're on Rails! screenshot](https://guides.rubyonrails.org/v6.1.0/images/getting_started/rails_welcome.png)
...
#### [4.2 Say "Hello", Rails](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#say-hello-rails)
...
restart it with `bin/rails server`. Now visit [http://localhost:3000/articles](http://localhost:3000/articles),
and see our text displayed!

#### [4.3 Setting the Application Home Page](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#setting-the-application-home-page)
...
To learn more about routing, see [Rails Routing from the Outside In](https://guides.rubyonrails.org/v6.1.0/routing.html).

### [5 MVC and You](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#mvc-and-you)
...
#### [5.1 Generating a Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#mvc-and-you-generating-a-model)
...
call the model's constructor: we want to write `Article.new(...)`, **not**`Articles.new(...)`.
...
#### [5.2 Database Migrations](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#database-migrations)
...
To learn more about migrations, see [Active Record Migrations](https://guides.rubyonrails.org/v6.1.0/active_record_migrations.html).

Now we can interact with the table using our model.

#### [5.3 Using a Model to Interact with the Database](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#using-a-model-to-interact-with-the-database)
...
moment. To save the object to the database, we must call [`save`](https://api.rubyonrails.org/v6.1.0/classes/ActiveRecord/Persistence.html#method-i-save):
...
When we want to fetch this article from the database, we can call [`find`](https://api.rubyonrails.org/v6.1.0/classes/ActiveRecord/FinderMethods.html#method-i-find)
...
And when we want to fetch all articles from the database, we can call [`all`](https://api.rubyonrails.org/v6.1.0/classes/ActiveRecord/Scoping/Named/ClassMethods.html#method-i-all)
on the model:
...
This method returns an [`ActiveRecord::Relation`](https://api.rubyonrails.org/v6.1.0/classes/ActiveRecord/Relation.html) object, which
you can think of as a super-powered array.

To learn more about models, see [Active Record Basics](https://guides.rubyonrails.org/v6.1.0/active_record_basics.html) and [Active Record Query Interface](https://guides.rubyonrails.org/v6.1.0/active_record_querying.html).

Models are the final piece of the MVC puzzle. Next, we will connect all of the
pieces together.

#### [5.4 Showing a List of Articles](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#showing-a-list-of-articles)
...
### [6 CRUDit Where CRUDit Is Due](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#crudit-where-crudit-is-due)
...
#### [6.1 Showing a Single Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#showing-a-single-article)
...
previously](https://guides.rubyonrails.org/v6.1.0/getting_started.html#using-a-model-to-interact-with-the-database)) with the ID captured
...
Now we can see the article when we visit [http://localhost:3000/articles/1](http://localhost:3000/articles/1)!
...
#### [6.2 Resourceful Routing](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#resourceful-routing)
...
Rails provides a routes method named [`resources`](https://api.rubyonrails.org/v6.1.0/classes/ActionDispatch/Routing/Mapper/Resources.html#method-i-resources)
...
However, we will take this one step further by using the [`link_to`](https://api.rubyonrails.org/v6.1.0/classes/ActionView/Helpers/UrlHelper.html#method-i-link_to)
...
#### [6.3 Creating a New Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-a-new-article)
...
[`redirect_to`](https://api.rubyonrails.org/v6.1.0/classes/ActionController/Redirecting.html#method-i-redirect_to)
will cause the browser to make a new request,
whereas [`render`](https://api.rubyonrails.org/v6.1.0/classes/AbstractController/Rendering.html#method-i-render)
...
##### [6.3.1 Using a Form Builder](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#using-a-form-builder)
...
The [`form_with`](https://api.rubyonrails.org/v6.1.0/classes/ActionView/Helpers/FormHelper.html#method-i-form_with)
helper method instantiates a form builder. In the `form_with` block we call
methods like [`label`](https://api.rubyonrails.org/v6.1.0/classes/ActionView/Helpers/FormBuilder.html#method-i-label)
and [`text_field`](https://api.rubyonrails.org/v6.1.0/classes/ActionView/Helpers/FormBuilder.html#method-i-text_field)
...
To learn more about form builders, see [Action View Form Helpers](https://guides.rubyonrails.org/v6.1.0/form_helpers.html).

##### [6.3.2 Using Strong Parameters](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#using-strong-parameters)
...
Strong Parameters](https://guides.rubyonrails.org/v6.1.0/action_controller_overview.html#strong-parameters).

##### [6.3.3 Validations and Displaying Error Messages](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#validations-and-displaying-error-messages)
...
The [`full_messages_for`](https://api.rubyonrails.org/v6.1.0/classes/ActiveModel/Errors.html#method-i-full_messages_for)
...
When we visit [http://localhost:3000/articles/new](http://localhost:3000/articles/new), the `GET /articles/new`
...
To learn more about validations, see [Active Record Validations](https://guides.rubyonrails.org/v6.1.0/active_record_validations.html). To learn more about validation error messages,
see [Active Record Validations § Working with Validation Errors](https://guides.rubyonrails.org/v6.1.0/active_record_validations.html#working-with-validation-errors).

##### [6.3.4 Finishing Up](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#creating-a-new-article-finishing-up)

We can now create an article by visiting [http://localhost:3000/articles/new](http://localhost:3000/articles/new).
...
#### [6.4 Updating an Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#updating-an-article)
...
##### [6.4.1 Using Partials to Share View Code](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#using-partials-to-share-view-code)
...
Let's update `app/views/articles/new.html.erb` to use the partial via [`render`](https://api.rubyonrails.org/v6.1.0/classes/ActionView/Helpers/RenderingHelper.html#method-i-render):
...
Partials](https://guides.rubyonrails.org/v6.1.0/layouts_and_rendering.html#using-partials).

##### [6.4.2 Finishing Up](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#updating-an-article-finishing-up)

We can now update an article by visiting its edit page, e.g.
[http://localhost:3000/articles/1/edit](http://localhost:3000/articles/1/edit). To finish up, let's link to the edit
...
#### [6.5 Deleting an Article](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#deleting-an-article)
...
The `destroy` action fetches the article from the database, and calls [`destroy`](https://api.rubyonrails.org/v6.1.0/classes/ActiveRecord/Persistence.html#method-i-destroy)
...
Rails](https://guides.rubyonrails.org/v6.1.0/working_with_javascript_in_rails.html).

And that's it! We can now list, show, create, update, and delete articles!
InCRUDable!

### [7 Adding a Second Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#adding-a-second-model)

It's time to add a second model to the application. The second model will handle
comments on articles.

#### [7.1 Generating a Model](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#adding-a-second-model-generating-a-model)
...
#### [7.2 Associating Models](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#associating-models)
...
Associations](https://guides.rubyonrails.org/v6.1.0/association_basics.html) guide.

#### [7.3 Adding a Route for Comments](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#adding-a-route-for-comments)
...
For more information on routing, see the [Rails Routing](https://guides.rubyonrails.org/v6.1.0/routing.html)
guide.

#### [7.4 Generating a Controller](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#generating-a-controller)
...
![Article with Comments](https://guides.rubyonrails.org/v6.1.0/images/getting_started/article_with_comments.png)

### [8 Refactoring](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#refactoring)

Now that we have articles and comments working, take a look at the
`app/views/articles/show.html.erb` template. It is getting long and awkward. We
can use partials to clean it up.

#### [8.1 Rendering Partial Collections](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#rendering-partial-collections)
...
#### [8.2 Rendering a Partial Form](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#rendering-a-partial-form)
...
#### [8.3 Using Concerns](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#using-concerns)
...
We can add our status validation to the concern, but this is slightly more complex as validations are methods called at the class level. The `ActiveSupport::Concern` ( [API Guide](https://api.rubyonrails.org/v6.1.0/classes/ActiveSupport/Concern.html)) gives us a simpler way to include them:
...
### [9 Deleting Comments](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#deleting-comments)
...
#### [9.1 Deleting Associated Objects](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#deleting-associated-objects)
...
### [10 Security](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#security)

#### [10.1 Basic Authentication](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#basic-authentication)
...
![Basic HTTP Authentication Challenge](https://guides.rubyonrails.org/v6.1.0/images/getting_started/challenge.png)
...
#### [10.2 Other Security Considerations](https://guides.rubyonrails.org/v6.1.0/getting_started.html\#other-security-considerations)

Security, especially in web applications, is a broad and detailed area. Security
in your Rails application is covered in more depth in
the [Ruby on Rails Security Guide](https://guides.rubyonrails.org/v6.1.0/security.html).
...
- The [Ruby on Rails Guides](https://guides.rubyonrails.org/v6.1.0/index.html)
...
Check the [Ruby on Rails Guides Guidelines](https://guides.rubyonrails.org/v6.1.0/ruby_on_rails_guides_guidelines.html)
