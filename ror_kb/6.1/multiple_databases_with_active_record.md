...
1. [Setting up your application](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#setting-up-your-application)
2. [Generators and Migrations](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#generators-and-migrations)
3. [Activating automatic connection switching](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#activating-automatic-connection-switching)
4. [Using manual connection switching](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#using-manual-connection-switching)
5. [Horizontal sharding](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#horizontal-sharding)
6. [Granular Database Connection Switching](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#granular-database-connection-switching)
7. [Caveats](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#caveats)   - [Automatic swapping for horizontal sharding](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#automatic-swapping-for-horizontal-sharding)
   - [Load Balancing Replicas](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#load-balancing-replicas)
   - [Joining Across Databases](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#joining-across-databases)
   - [Schema Cache](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html#schema-cache)
...
Classes that connect to primary/primary\_replica can inherit from `ApplicationRecord` like
...
### [7 Caveats](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html\#caveats)

#### [7.1 Automatic swapping for horizontal sharding](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html\#automatic-swapping-for-horizontal-sharding)
...
#### [7.2 Load Balancing Replicas](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html\#load-balancing-replicas)
...
#### [7.3 Joining Across Databases](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html\#joining-across-databases)
...
#### [7.4 Schema Cache](https://guides.rubyonrails.org/v6.1/active_record_multiple_databases.html\#schema-cache)
