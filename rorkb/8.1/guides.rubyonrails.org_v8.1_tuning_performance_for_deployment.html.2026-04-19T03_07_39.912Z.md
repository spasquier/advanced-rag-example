[Skip to main content](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#main)
...
More information about how to configure your application can be found in the [Configuration Guide](https://guides.rubyonrails.org/v8.1/configuring.html).

[Skip to article body](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [Choosing an Application Server](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#choosing-an-application-server)
2. [What to Optimize for?](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#what-to-optimize-for-questionmark)
   - [Understanding Ruby's Concurrency and Parallelism](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#understanding-ruby-s-concurrency-and-parallelism)
   - [Practical Implications](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#practical-implications)
3. [Configurations](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#configurations)
   - [Puma](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#puma)
   - [YJIT](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#yjit)
   - [Memory Allocators and Configuration](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#memory-allocators-and-configuration)
4. [Performance Testing](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#performance-testing)
   - [What to Measure](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#what-to-measure)
   - [Production Measurement](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#production-measurement)
   - [Load Testers](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#load-testers)
   - [What You Can Change](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#what-you-can-change)
   - [Warmup](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#warmup)
   - [Which Requests](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#which-requests)
   - [What to Look For](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#what-to-look-for)
...
### [2.1. Understanding Ruby's Concurrency and Parallelism](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#understanding-ruby-s-concurrency-and-parallelism)
...
### [2.2. Practical Implications](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#practical-implications)
...
### [3.1. Puma](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#puma)
...
### [3.2. YJIT](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#yjit)
...
### [3.3. Memory Allocators and Configuration](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#memory-allocators-and-configuration)
...
### [4.1. What to Measure](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#what-to-measure)
...
### [4.2. Production Measurement](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#production-measurement)
...
### [4.3. Load Testers](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#load-testers)
...
### [4.4. What You Can Change](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#what-you-can-change)
...
### [4.5. Warmup](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#warmup)
...
### [4.6. Which Requests](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#which-requests)
...
### [4.7. What to Look For](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html\#what-to-look-for)
...
[Back to top](https://guides.rubyonrails.org/v8.1/tuning_performance_for_deployment.html#main-skip-link)