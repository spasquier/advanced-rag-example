[Skip to main content](https://guides.rubyonrails.org/v8.1/active_model_basics.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/active_model_basics.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [What is Active Model?](https://guides.rubyonrails.org/v8.1/active_model_basics.html#what-is-active-model-questionmark)
   - [API](https://guides.rubyonrails.org/v8.1/active_model_basics.html#api)
   - [Model](https://guides.rubyonrails.org/v8.1/active_model_basics.html#model)
   - [Attributes](https://guides.rubyonrails.org/v8.1/active_model_basics.html#attributes)
   - [Attribute Assignment](https://guides.rubyonrails.org/v8.1/active_model_basics.html#attribute-assignment)
   - [Attribute Methods](https://guides.rubyonrails.org/v8.1/active_model_basics.html#attribute-methods)
   - [Callbacks](https://guides.rubyonrails.org/v8.1/active_model_basics.html#callbacks)
   - [Conversion](https://guides.rubyonrails.org/v8.1/active_model_basics.html#conversion)
   - [Dirty](https://guides.rubyonrails.org/v8.1/active_model_basics.html#dirty)
   - [Naming](https://guides.rubyonrails.org/v8.1/active_model_basics.html#naming)
   - [SecurePassword](https://guides.rubyonrails.org/v8.1/active_model_basics.html#securepassword)
   - [Serialization](https://guides.rubyonrails.org/v8.1/active_model_basics.html#serialization)
   - [Translation](https://guides.rubyonrails.org/v8.1/active_model_basics.html#translation)
   - [Validations](https://guides.rubyonrails.org/v8.1/active_model_basics.html#validations)
   - [Lint Tests](https://guides.rubyonrails.org/v8.1/active_model_basics.html#lint-tests)

## [1. What is Active Model?](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#what-is-active-model-questionmark)

To understand Active Model, you need to know a little about [Active\\
Record](https://guides.rubyonrails.org/v8.1/active_record_basics.html). Active Record is an ORM (Object Relational
...
### [1.1. API](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#api)

[`ActiveModel::API`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/API.html)
adds the ability for a class to work with [Action\\
Pack](https://api.rubyonrails.org/v8.1.3/files/actionpack/README_rdoc.html) and [Action\\
View](https://guides.rubyonrails.org/v8.1/action_view_overview.html) right out of the box.
...
methods](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers.html), just like
...
Helpers](https://guides.rubyonrails.org/v8.1/form_helpers.html) and [Layouts and\\
Rendering](https://guides.rubyonrails.org/v8.1/layouts_and_rendering.html)
guides, respectively.

### [1.2. Model](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#model)

[`ActiveModel::Model`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Model.html)
includes [ActiveModel::API](https://guides.rubyonrails.org/v8.1/active_model_basics.html#api) to interact with Action Pack and Action View
...
### [1.3. Attributes](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#attributes)

[`ActiveModel::Attributes`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Attributes.html)
...
#### [1.3.1. Method: `attribute_names`](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#method-attribute-names)
...
#### [1.3.2. Method: `attributes`](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#method-attributes)
...
### [1.4. Attribute Assignment](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#attribute-assignment)

[`ActiveModel::AttributeAssignment`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/AttributeAssignment.html)
...
#### [1.4.1. Method alias: `attributes=`](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#method-alias-attributes)
...
### [1.5. Attribute Methods](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#attribute-methods)

[`ActiveModel::AttributeMethods`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/AttributeMethods.html)
...
#### [1.5.1. Method: `alias_attribute`](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#method-alias-attribute)
...
### [1.6. Callbacks](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#callbacks)

[`ActiveModel::Callbacks`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Callbacks.html)
gives plain Ruby objects [Active Record style\\
callbacks](https://guides.rubyonrails.org/v8.1/active_record_callbacks.html). The
...
#### [1.6.1. Defining Specific Callbacks](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#defining-specific-callbacks)
...
#### [1.6.2. Defining Callbacks with a Class](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#defining-callbacks-with-a-class)
...
#### [1.6.3. Aborting Callbacks](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#aborting-callbacks)
...
### [1.7. Conversion](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#conversion)

[`ActiveModel::Conversion`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Conversion.html)
...
#### [1.7.1. to\_model](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#to-model)
...
#### [1.7.2. to\_key](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#to-key)
...
#### [1.7.3. to\_param](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#to-param)
...
#### [1.7.4. to\_partial\_path](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#to-partial-path)
...
### [1.8. Dirty](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#dirty)

[`ActiveModel::Dirty`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Dirty.html)
...
#### [1.8.1. Querying an Object Directly for its List of All Changed Attributes](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#querying-an-object-directly-for-its-list-of-all-changed-attributes)
...
#### [1.8.2. Attribute-based Accessor Methods](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#attribute-based-accessor-methods)
...
### [1.9. Naming](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#naming)

[`ActiveModel::Naming`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Naming.html)
...
[`ActiveSupport::Inflector`](https://api.rubyonrails.org/v8.1.3/classes/ActiveSupport/Inflector.html)
methods.
...
**`element`** removes the namespace and returns the singular snake\_cased name.
...
**`collection`** removes the namespace and returns the plural snake\_cased name.
It is generally used by Action Pack and/or Action View helpers to aid in
rendering the name of partials/forms.
...
an isolated [Engine](https://guides.rubyonrails.org/v8.1/engines.html).

#### [1.9.1. Customize the Name of the Model](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#customize-the-name-of-the-model)
...
### [1.10. SecurePassword](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#securepassword)

[`ActiveModel::SecurePassword`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/SecurePassword.html)
...
### [1.11. Serialization](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#serialization)
...
#### [1.11.1. ActiveModel::Serializers::JSON](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#activemodel-serializers-json)

Active Model also provides the
[`ActiveModel::Serializers::JSON`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Serializers/JSON.html)
...
### [1.12. Translation](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#translation)

[`ActiveModel::Translation`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Translation.html)
provides integration between your object and the [Rails internationalization\\
(i18n) framework](https://guides.rubyonrails.org/v8.1/i18n.html).
...
### [1.13. Validations](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#validations)
...
#### [1.13.1. Validation Methods and Options](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#validation-methods-and-options)

You can add validations using some of the following methods:

- [`validate`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html#method-i-validate):
Adds validation through a method or a block to the class.

- [`validates`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates):
An attribute can be passed to the `validates` method and it provides a
shortcut to all default validators.

- [`validates!`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates-21)
...
- [`validates_with`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_with):
Passes the record off to the class or classes specified and allows them to add
errors based on more complex conditions.

- [`validates_each`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html#method-i-validates_each):
...
validation\\
documentation](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Validations/ClassMethods.html).
...
#### [1.13.2. Errors](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#errors)

`ActiveModel::Validations` automatically adds an `errors` method to your
instances initialized with a new
[`ActiveModel::Errors`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Errors.html)
...
### [1.14. Lint Tests](https://guides.rubyonrails.org/v8.1/active_model_basics.html\#lint-tests)

[`ActiveModel::Lint::Tests`](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Lint/Tests.html)
...
documentation](https://api.rubyonrails.org/v8.1.3/classes/ActiveModel/Lint/Tests.html)
for more details.
...
[Back to top](https://guides.rubyonrails.org/v8.1/active_model_basics.html#main-skip-link)