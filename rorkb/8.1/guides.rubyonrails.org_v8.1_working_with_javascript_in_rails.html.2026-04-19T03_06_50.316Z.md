[Skip to main content](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [Import Maps](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#import-maps)
   - [Installing importmap-rails](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#installing-importmap-rails)
   - [Adding npm Packages with importmap-rails](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#adding-npm-packages-with-importmap-rails)
2. [Adding npm Packages with JavaScript Bundlers](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#adding-npm-packages-with-javascript-bundlers)
   - [Installing a JavaScript Runtime](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#installing-a-javascript-runtime)
3. [Choosing Between Import Maps and a JavaScript Bundler](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#choosing-between-import-maps-and-a-javascript-bundler)
4. [Turbo](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#turbo)
   - [Turbo Drive](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#turbo-drive)
   - [Turbo Frames](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#turbo-frames)
   - [Turbo Streams](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#turbo-streams)
5. [Replacements for Rails/UJS Functionality](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#replacements-for-rails-ujs-functionality)
   - [Method](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#method)
   - [Confirmations](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#confirmations)
   - [Ajax Requests](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#ajax-requests)
...
### [1.1. Installing importmap-rails](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#installing-importmap-rails)
...
### [1.2. Adding npm Packages with importmap-rails](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#adding-npm-packages-with-importmap-rails)
...
### [2.1. Installing a JavaScript Runtime](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#installing-a-javascript-runtime)
...
#### [2.1.1. Installing Bun](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#installing-bun)
...
#### [2.1.2. Installing Node.js and Yarn](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#installing-node-js-and-yarn)
...
### [4.1. Turbo Drive](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#turbo-drive)
...
### [4.2. Turbo Frames](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#turbo-frames)
...
### [4.3. Turbo Streams](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#turbo-streams)
...
### [5.1. Method](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#method)
...
### [5.2. Confirmations](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#confirmations)
...
### [5.3. Ajax Requests](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html\#ajax-requests)
...
This token is required by Rails to prevent Cross-Site Request Forgery (CSRF) attacks. Read more in the [security guide](https://guides.rubyonrails.org/v8.1/security.html#cross-site-request-forgery-csrf).
...
[`csrf_meta_tags`](https://api.rubyonrails.org/v8.1.3/classes/ActionView/Helpers/CsrfHelper.html#method-i-csrf_meta_tags) in your application view. You could do something like:
...
[Back to top](https://guides.rubyonrails.org/v8.1/working_with_javascript_in_rails.html#main-skip-link)