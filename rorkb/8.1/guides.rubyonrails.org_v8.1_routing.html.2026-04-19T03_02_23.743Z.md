[Skip to main content](https://guides.rubyonrails.org/v8.1/routing.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/routing.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

1. [The Purpose of the Rails Router](https://guides.rubyonrails.org/v8.1/routing.html#the-purpose-of-the-rails-router)
   - [Routing Incoming URLs to Code](https://guides.rubyonrails.org/v8.1/routing.html#routing-incoming-urls-to-code)
   - [Generating Paths and URLs from Code](https://guides.rubyonrails.org/v8.1/routing.html#generating-paths-and-urls-from-code)
   - [Configuring the Rails Router](https://guides.rubyonrails.org/v8.1/routing.html#configuring-the-rails-router)
2. [Resource Routing: the Rails Default](https://guides.rubyonrails.org/v8.1/routing.html#resource-routing-the-rails-default)
   - [Resources on the Web](https://guides.rubyonrails.org/v8.1/routing.html#resources-on-the-web)
   - [CRUD, Verbs, and Actions](https://guides.rubyonrails.org/v8.1/routing.html#crud-verbs-and-actions)
   - [Path and URL Helpers](https://guides.rubyonrails.org/v8.1/routing.html#path-and-url-helpers)
   - [Defining Multiple Resources at the Same Time](https://guides.rubyonrails.org/v8.1/routing.html#defining-multiple-resources-at-the-same-time)
   - [Singular Resources](https://guides.rubyonrails.org/v8.1/routing.html#singular-resources)
   - [Controller Namespaces and Routing](https://guides.rubyonrails.org/v8.1/routing.html#controller-namespaces-and-routing)
   - [Nested Resources](https://guides.rubyonrails.org/v8.1/routing.html#nested-resources)
   - [Routing Concerns](https://guides.rubyonrails.org/v8.1/routing.html#routing-concerns)
   - [Creating Paths and URLs from Objects](https://guides.rubyonrails.org/v8.1/routing.html#creating-paths-and-urls-from-objects)
   - [Adding More RESTful Routes](https://guides.rubyonrails.org/v8.1/routing.html#adding-more-restful-routes)
3. [Non-Resourceful Routes](https://guides.rubyonrails.org/v8.1/routing.html#non-resourceful-routes)
   - [Bound Parameters](https://guides.rubyonrails.org/v8.1/routing.html#bound-parameters)
   - [Dynamic Segments](https://guides.rubyonrails.org/v8.1/routing.html#dynamic-segments)
   - [Static Segments](https://guides.rubyonrails.org/v8.1/routing.html#static-segments)
   - [The Query String](https://guides.rubyonrails.org/v8.1/routing.html#the-query-string)
   - [Defining Default Parameters](https://guides.rubyonrails.org/v8.1/routing.html#defining-default-parameters)
   - [Naming Routes](https://guides.rubyonrails.org/v8.1/routing.html#naming-routes)
   - [HTTP Verb Constraints](https://guides.rubyonrails.org/v8.1/routing.html#http-verb-constraints)
   - [Segment Constraints](https://guides.rubyonrails.org/v8.1/routing.html#segment-constraints)
   - [Request-Based Constraints](https://guides.rubyonrails.org/v8.1/routing.html#request-based-constraints)
   - [Advanced Constraints](https://guides.rubyonrails.org/v8.1/routing.html#advanced-constraints)
   - [Wildcard Segments](https://guides.rubyonrails.org/v8.1/routing.html#wildcard-segments)
   - [Format Segments](https://guides.rubyonrails.org/v8.1/routing.html#format-segments)
   - [Redirection](https://guides.rubyonrails.org/v8.1/routing.html#redirection)
   - [Routing to Rack Applications](https://guides.rubyonrails.org/v8.1/routing.html#routing-to-rack-applications)
   - [Using `root`](https://guides.rubyonrails.org/v8.1/routing.html#using-root)
   - [Unicode Character Routes](https://guides.rubyonrails.org/v8.1/routing.html#unicode-character-routes)
   - [Direct Routes](https://guides.rubyonrails.org/v8.1/routing.html#direct-routes)
   - [Using `resolve`](https://guides.rubyonrails.org/v8.1/routing.html#using-resolve)
4. [Customizing Resourceful Routes](https://guides.rubyonrails.org/v8.1/routing.html#customizing-resourceful-routes)
   - [Specifying a Controller to Use](https://guides.rubyonrails.org/v8.1/routing.html#specifying-a-controller-to-use)
   - [Specifying Constraints on `id`](https://guides.rubyonrails.org/v8.1/routing.html#specifying-constraints-on-id)
   - [Overriding the Named Route Helpers](https://guides.rubyonrails.org/v8.1/routing.html#overriding-the-named-route-helpers)
   - [Renaming the `new` and `edit` Path Names](https://guides.rubyonrails.org/v8.1/routing.html#renaming-the-new-and-edit-path-names)
   - [Prefixing the Named Route Helpers with `:as`](https://guides.rubyonrails.org/v8.1/routing.html#prefixing-the-named-route-helpers-with-as)
   - [Using `:as` in Nested Resources](https://guides.rubyonrails.org/v8.1/routing.html#using-as-in-nested-resources)
   - [Parametric Scopes](https://guides.rubyonrails.org/v8.1/routing.html#parametric-scopes)
   - [Restricting the Routes Created](https://guides.rubyonrails.org/v8.1/routing.html#restricting-the-routes-created)
   - [Translated Paths](https://guides.rubyonrails.org/v8.1/routing.html#translated-paths)
   - [Specifying the Singular Form of a Resource](https://guides.rubyonrails.org/v8.1/routing.html#specifying-the-singular-form-of-a-resource)
   - [Renaming Default Route Parameter `id`](https://guides.rubyonrails.org/v8.1/routing.html#renaming-default-route-parameter-id)
5. [Inspecting Routes](https://guides.rubyonrails.org/v8.1/routing.html#inspecting-routes)
   - [Listing Existing Routes](https://guides.rubyonrails.org/v8.1/routing.html#listing-existing-routes)
   - [Searching Routes](https://guides.rubyonrails.org/v8.1/routing.html#searching-routes)
   - [Listing Unused Routes](https://guides.rubyonrails.org/v8.1/routing.html#listing-unused-routes)
   - [Routes in Rails Console](https://guides.rubyonrails.org/v8.1/routing.html#routes-in-rails-console)
6. [Testing Routes](https://guides.rubyonrails.org/v8.1/routing.html#testing-routes)
   - [The `assert_generates` Assertion](https://guides.rubyonrails.org/v8.1/routing.html#the-assert-generates-assertion)
   - [The `assert_recognizes` Assertion](https://guides.rubyonrails.org/v8.1/routing.html#the-assert-recognizes-assertion)
   - [The `assert_routing` Assertion](https://guides.rubyonrails.org/v8.1/routing.html#the-assert-routing-assertion)
7. [Breaking Up a Large Route File With `draw`](https://guides.rubyonrails.org/v8.1/routing.html#breaking-up-a-large-route-file-with-draw)
...
[Rack](https://guides.rubyonrails.org/v8.1/rails_on_rack.html) application.) The router also generates path and URL
helpers based on the resources configured in the router.

### [1.1. Routing Incoming URLs to Code](https://guides.rubyonrails.org/v8.1/routing.html\#routing-incoming-urls-to-code)
...
Rails uses snake\_case for controller names when specifying routes. For example, if you have a controller named `UserProfilesController`, you would specify a route to the show action as `user_profiles#show`.

### [1.2. Generating Paths and URLs from Code](https://guides.rubyonrails.org/v8.1/routing.html\#generating-paths-and-urls-from-code)
...
### [1.3. Configuring the Rails Router](https://guides.rubyonrails.org/v8.1/routing.html\#configuring-the-rails-router)
...
### [2.1. Resources on the Web](https://guides.rubyonrails.org/v8.1/routing.html\#resources-on-the-web)
...
### [2.2. CRUD, Verbs, and Actions](https://guides.rubyonrails.org/v8.1/routing.html\#crud-verbs-and-actions)
...
action generally maps to a specific [CRUD](https://guides.rubyonrails.org/v8.1/active_record_basics.html#crud-reading-and-writing-data) operation on your data. A single entry in
...
### [2.3. Path and URL Helpers](https://guides.rubyonrails.org/v8.1/routing.html\#path-and-url-helpers)
...
The prefix used before "\_path" and "\_url" is the route name and can be identified by looking at the "prefix" column of the `bin/rails routes` command output. To learn more see [Listing Existing Routes](https://guides.rubyonrails.org/v8.1/routing.html#listing-existing-routes) below.

### [2.4. Defining Multiple Resources at the Same Time](https://guides.rubyonrails.org/v8.1/routing.html\#defining-multiple-resources-at-the-same-time)
...
### [2.5. Singular Resources](https://guides.rubyonrails.org/v8.1/routing.html\#singular-resources)
...
The call to `resolve` is necessary for converting instances of the `Geocoder` to singular routes through [record identification](https://guides.rubyonrails.org/v8.1/form_helpers.html#relying-on-record-identification).
...
### [2.6. Controller Namespaces and Routing](https://guides.rubyonrails.org/v8.1/routing.html\#controller-namespaces-and-routing)
...
#### [2.6.1. Using Module](https://guides.rubyonrails.org/v8.1/routing.html\#using-module)
...
#### [2.6.2. Using Scope](https://guides.rubyonrails.org/v8.1/routing.html\#using-scope)
...
### [2.7. Nested Resources](https://guides.rubyonrails.org/v8.1/routing.html\#nested-resources)
...
#### [2.7.1. Limits to Nesting](https://guides.rubyonrails.org/v8.1/routing.html\#limits-to-nesting)
...
#### [2.7.2. Shallow Nesting](https://guides.rubyonrails.org/v8.1/routing.html\#shallow-nesting)
...
### [2.8. Routing Concerns](https://guides.rubyonrails.org/v8.1/routing.html\#routing-concerns)
...
### [2.9. Creating Paths and URLs from Objects](https://guides.rubyonrails.org/v8.1/routing.html\#creating-paths-and-urls-from-objects)
...
### [2.10. Adding More RESTful Routes](https://guides.rubyonrails.org/v8.1/routing.html\#adding-more-restful-routes)

You are not limited to the [seven routes](https://guides.rubyonrails.org/v8.1/routing.html#crud-verbs-and-actions) that RESTful routing creates by default. You can add additional routes that apply to the collection or individual members of the collection.
...
#### [2.10.1. Adding Member Routes](https://guides.rubyonrails.org/v8.1/routing.html\#adding-member-routes)
...
#### [2.10.2. Adding Collection Routes](https://guides.rubyonrails.org/v8.1/routing.html\#adding-collection-routes)
...
#### [2.10.3. Adding Routes for Additional New Actions](https://guides.rubyonrails.org/v8.1/routing.html\#adding-routes-for-additional-new-actions)
...
It is possible to customize the default routes and helpers generated by `resources`, see [customizing resourceful routes section](https://guides.rubyonrails.org/v8.1/routing.html#customizing-resourceful-routes) for more.
...
### [3.1. Bound Parameters](https://guides.rubyonrails.org/v8.1/routing.html\#bound-parameters)
...
### [3.2. Dynamic Segments](https://guides.rubyonrails.org/v8.1/routing.html\#dynamic-segments)
...
This route will respond to paths such as `/photos/1/2`. The `params` hash will be { controller: 'photos', action: 'show', id: '1', user\_id: '2' }.
...
### [3.3. Static Segments](https://guides.rubyonrails.org/v8.1/routing.html\#static-segments)
...
### [3.4. The Query String](https://guides.rubyonrails.org/v8.1/routing.html\#the-query-string)
...
### [3.5. Defining Default Parameters](https://guides.rubyonrails.org/v8.1/routing.html\#defining-default-parameters)
...
### [3.6. Naming Routes](https://guides.rubyonrails.org/v8.1/routing.html\#naming-routes)
...
### [3.7. HTTP Verb Constraints](https://guides.rubyonrails.org/v8.1/routing.html\#http-verb-constraints)
...
information see the [security guide](https://guides.rubyonrails.org/v8.1/security.html#csrf-countermeasures)). In
general, avoid routing all verbs to a single action unless you have a good
reason.

### [3.8. Segment Constraints](https://guides.rubyonrails.org/v8.1/routing.html\#segment-constraints)
...
### [3.9. Request-Based Constraints](https://guides.rubyonrails.org/v8.1/routing.html\#request-based-constraints)

You can also constrain a route based on any method on the [Request object](https://guides.rubyonrails.org/v8.1/action_controller_overview.html#the-request-object) that returns a `String`.
...
You can [use a lambda](https://guides.rubyonrails.org/v8.1/routing.html#advanced-constraints) like in `get 'foo', constraints: lambda { |req| req.format == :json }` to only match the route to explicit JSON requests.

### [3.10. Advanced Constraints](https://guides.rubyonrails.org/v8.1/routing.html\#advanced-constraints)
...
#### [3.10.1. Constraints in a Block Form](https://guides.rubyonrails.org/v8.1/routing.html\#constraints-in-a-block-form)
...
### [3.11. Wildcard Segments](https://guides.rubyonrails.org/v8.1/routing.html\#wildcard-segments)
...
### [3.12. Format Segments](https://guides.rubyonrails.org/v8.1/routing.html\#format-segments)
...
### [3.13. Redirection](https://guides.rubyonrails.org/v8.1/routing.html\#redirection)
...
### [3.14. Routing to Rack Applications](https://guides.rubyonrails.org/v8.1/routing.html\#routing-to-rack-applications)

Instead of specifying `:to` as a String like `'articles#index'`, which corresponds to the `index` method in the `ArticlesController` class, you can specify any [Rack application](https://guides.rubyonrails.org/v8.1/rails_on_rack.html) as the endpoint for a matcher:
...
path instead, use [`mount`](https://api.rubyonrails.org/v8.1.3/classes/ActionDispatch/Routing/Mapper/Base.html#method-i-mount):
...
### [3.15. Using `root`](https://guides.rubyonrails.org/v8.1/routing.html\#using-root)
...
### [3.16. Unicode Character Routes](https://guides.rubyonrails.org/v8.1/routing.html\#unicode-character-routes)
...
### [3.17. Direct Routes](https://guides.rubyonrails.org/v8.1/routing.html\#direct-routes)
...
### [3.18. Using `resolve`](https://guides.rubyonrails.org/v8.1/routing.html\#using-resolve)
...
### [4.1. Specifying a Controller to Use](https://guides.rubyonrails.org/v8.1/routing.html\#specifying-a-controller-to-use)
...
### [4.2. Specifying Constraints on `id`](https://guides.rubyonrails.org/v8.1/routing.html\#specifying-constraints-on-id)
...
You can use the more [advanced constraints](https://guides.rubyonrails.org/v8.1/routing.html#advanced-constraints) available in non-resourceful routes section in this context as well.
...
### [4.3. Overriding the Named Route Helpers](https://guides.rubyonrails.org/v8.1/routing.html\#overriding-the-named-route-helpers)
...
### [4.4. Renaming the `new` and `edit` Path Names](https://guides.rubyonrails.org/v8.1/routing.html\#renaming-the-new-and-edit-path-names)
...
### [4.5. Prefixing the Named Route Helpers with `:as`](https://guides.rubyonrails.org/v8.1/routing.html\#prefixing-the-named-route-helpers-with-as)
...
### [4.6. Using `:as` in Nested Resources](https://guides.rubyonrails.org/v8.1/routing.html\#using-as-in-nested-resources)
...
### [4.7. Parametric Scopes](https://guides.rubyonrails.org/v8.1/routing.html\#parametric-scopes)
...
### [4.8. Restricting the Routes Created](https://guides.rubyonrails.org/v8.1/routing.html\#restricting-the-routes-created)
...
routes](https://guides.rubyonrails.org/v8.1/routing.html#listing-unused-routes).

### [4.9. Translated Paths](https://guides.rubyonrails.org/v8.1/routing.html\#translated-paths)
...
### [4.10. Specifying the Singular Form of a Resource](https://guides.rubyonrails.org/v8.1/routing.html\#specifying-the-singular-form-of-a-resource)
...
### [4.11. Renaming Default Route Parameter `id`](https://guides.rubyonrails.org/v8.1/routing.html\#renaming-default-route-parameter-id)
...
### [5.1. Listing Existing Routes](https://guides.rubyonrails.org/v8.1/routing.html\#listing-existing-routes)
...
### [5.2. Searching Routes](https://guides.rubyonrails.org/v8.1/routing.html\#searching-routes)
...
### [5.3. Listing Unused Routes](https://guides.rubyonrails.org/v8.1/routing.html\#listing-unused-routes)
...
### [5.4. Routes in Rails Console](https://guides.rubyonrails.org/v8.1/routing.html\#routes-in-rails-console)

You can access route helpers using `Rails.application.routes.url_helpers` within the [Rails Console](https://guides.rubyonrails.org/v8.1/command_line.html#bin-rails-console). They are also available via the [app](https://guides.rubyonrails.org/v8.1/command_line.html#the-app-and-helper-objects) object. For example:
...
- [`assert_generates`](https://api.rubyonrails.org/v8.1.3/classes/ActionDispatch/Assertions/RoutingAssertions.html#method-i-assert_generates)
- [`assert_recognizes`](https://api.rubyonrails.org/v8.1.3/classes/ActionDispatch/Assertions/RoutingAssertions.html#method-i-assert_recognizes)
- [`assert_routing`](https://api.rubyonrails.org/v8.1.3/classes/ActionDispatch/Assertions/RoutingAssertions.html#method-i-assert_routing)

### [6.1. The `assert_generates` Assertion](https://guides.rubyonrails.org/v8.1/routing.html\#the-assert-generates-assertion)
...
### [6.2. The `assert_recognizes` Assertion](https://guides.rubyonrails.org/v8.1/routing.html\#the-assert-recognizes-assertion)
...
### [6.3. The `assert_routing` Assertion](https://guides.rubyonrails.org/v8.1/routing.html\#the-assert-routing-assertion)
...
[Back to top](https://guides.rubyonrails.org/v8.1/routing.html#main-skip-link)