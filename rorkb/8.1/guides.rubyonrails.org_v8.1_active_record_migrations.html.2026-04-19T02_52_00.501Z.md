[Skip to main content](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#main)
...
[Skip to article body](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#article-body)

## ![Chapter Icon](https://guides.rubyonrails.org/v8.1/images/icon_book-close-bookmark-1.svg)  Chapters

01. [Migration Overview](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#migration-overview)
02. [Generating Migration Files](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#generating-migration-files)
    - [Creating a Standalone Migration](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-a-standalone-migration)
    - [Creating a New Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-a-new-table)
    - [Adding Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#adding-columns)
    - [Removing Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#removing-columns)
    - [Creating Associations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-associations)
    - [Other Generators that Create Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#other-generators-that-create-migrations)
    - [Passing Modifiers](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#passing-modifiers)
03. [Updating Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#updating-migrations)
    - [Creating a Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-a-table)
    - [Creating a Join Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#creating-a-join-table)
    - [Changing Tables](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#changing-tables)
    - [Changing Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#changing-columns)
    - [Column Modifiers](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#column-modifiers)
    - [References](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#references)
    - [Foreign Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#foreign-keys)
    - [Composite Primary Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#composite-primary-keys)
    - [Execute SQL](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#execute-sql)
    - [Using the `change` Method](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-the-change-method)
    - [Using `reversible`](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-reversible)
    - [Using the `up`/`down` Methods](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-the-up-down-methods)
    - [Throwing an error to prevent reverts](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#throwing-an-error-to-prevent-reverts)
    - [Reverting Previous Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#reverting-previous-migrations)
04. [Running Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#running-migrations)
    - [Rolling Back](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rolling-back)
    - [Setting Up the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#setting-up-the-database)
    - [Preparing the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#preparing-the-database)
    - [Resetting the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#resetting-the-database)
    - [Running Specific Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#running-specific-migrations)
    - [Running Migrations in Different Environments](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#running-migrations-in-different-environments)
    - [Changing the Output of Running Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#changing-the-output-of-running-migrations)
    - [Rails Migration Version Control](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rails-migration-version-control)
05. [Changing Existing Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#changing-existing-migrations)
06. [Schema Dumping and You](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#schema-dumping-and-you)
    - [What are Schema Files for?](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#what-are-schema-files-for-questionmark)
    - [Types of Schema Dumps](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#types-of-schema-dumps)
    - [Schema Dumps and Source Control](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#schema-dumps-and-source-control)
07. [Active Record and Referential Integrity](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#active-record-and-referential-integrity)
08. [Migrations and Seed Data](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#migrations-and-seed-data)
09. [Old Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#old-migrations)
    - [Migrations from Engines](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#migrations-from-engines)
10. [Miscellaneous](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#miscellaneous)
    - [Using UUIDs instead of IDs for Primary Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-uuids-instead-of-ids-for-primary-keys)
    - [Data Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#data-migrations)

## [1. Migration Overview](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#migration-overview)
...
you read the guides for [Active Record Basics](https://guides.rubyonrails.org/v8.1/active_record_basics.html) and
the [Active Record Associations](https://guides.rubyonrails.org/v8.1/association_basics.html) to learn more about
...
timeline to run](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rails-migration-version-control).
...
migrations in the [Rolling Back section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rolling-back).
...
Migrations section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-reversible) for more details.

## [2. Generating Migration Files](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#generating-migration-files)

### [2.1. Creating a Standalone Migration](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#creating-a-standalone-migration)
...
Migration Version Control section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rails-migration-version-control).
...
### [2.2. Creating a New Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#creating-a-new-table)
...
### [2.3. Adding Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#adding-columns)
...
[`add_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_column) statements.
...
This will generate the appropriate [`add_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_column) and [`add_index`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_index)
statements:
...
### [2.4. Removing Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#removing-columns)

Similarly, if the migration name is of the form "RemoveColumnFromTable" and is
followed by a list of column names and types then a migration containing the
appropriate [`remove_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-remove_column) statements will be created.
...
### [2.5. Creating Associations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#creating-associations)
...
guide](https://guides.rubyonrails.org/v8.1/association_basics.html).
...
this process. [References](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#references) are a shorthand for creating columns,
...
### [2.6. Other Generators that Create Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#other-generators-that-create-migrations)
...
### [2.7. Passing Modifiers](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#passing-modifiers)

When generating migrations, you can pass commonly used [type\\
modifiers](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#column-modifiers) directly on the command line. These modifiers,
...
## [3. Updating Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#updating-migrations)

Once you have created your migration file using one of the generators from the
above [section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#generating-migration-files), you can update the generated
migration file in the `db/migrate` folder to define further changes you want to
make to your database schema.

### [3.1. Creating a Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#creating-a-table)

The [`create_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-create_table) method is one of the most fundamental migration type, but
...
#### [3.1.1. Associations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#associations)
...
[`:polymorphic`](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations) option:
...
#### [3.1.2. Primary Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#primary-keys)
...
more about [composite primary keys](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html).
...
#### [3.1.3. Database Options](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#database-options)
...
#### [3.1.4. Comments](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#comments)
...
### [3.2. Creating a Join Table](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#creating-a-join-table)

The migration method [`create_join_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-create_join_table) creates an [HABTM (has and belongs\\
to many)](https://guides.rubyonrails.org/v8.1/association_basics.html#the-has-and-belongs-to-many-association) join
...
arguments provided to create\_join\_table, in lexical order. In this case,
...
For example, one would expect the tables "paper\_boxes" and "papers" to generate
a join table name of "papers\_paper\_boxes" because of the length of the name
"paper\_boxes", but it in fact generates a join table name of
"paper\_boxes\_papers" (because the underscore '\_' is lexicographically _less_
...
### [3.3. Changing Tables](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#changing-tables)
...
### [3.4. Changing Columns](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#changing-columns)

Similar to the `remove_column` and `add_column` methods we covered
[earlier](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#adding-columns), Rails also provides the [`change_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_column)
migration method.
...
migration. See the [Reversible Migrations section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#using-reversible) for more
details.

Besides `change_column`, the [`change_column_null`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_column_null) and
[`change_column_default`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_column_default) methods are used to change a null constraint and
...
change. Use [`change_column_null`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_column_null) to change a null constraint.
...
### [3.5. Column Modifiers](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#column-modifiers)
...
### [3.6. References](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#references)
...
See also the [Active Record Associations](https://guides.rubyonrails.org/v8.1/association_basics.html) guide to learn more.
...
See this guide to learn more about [polymorphic associations](https://guides.rubyonrails.org/v8.1/association_basics.html#polymorphic-associations).
...
documentation](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_reference).
...
### [3.7. Foreign Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#foreign-keys)

While it's not required, you might want to add foreign key constraints to
[guarantee referential integrity](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#active-record-and-referential-integrity).
...
The [`add_foreign_key`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_foreign_key) call adds a new constraint to the `articles` table.
...
and You](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#schema-dumping-and-you).

### [3.8. Composite Primary Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#composite-primary-keys)

Sometimes a single column's value isn't enough to uniquely identify every row of
a table, but a combination of two or more columns _does_ uniquely identify it.
...
Keys](https://guides.rubyonrails.org/v8.1/active_record_composite_primary_keys.html) guide to learn more.

### [3.9. Execute SQL](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#execute-sql)

If the helpers provided by Active Record aren't enough, you can use the
[`execute`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/DatabaseStatements.html#method-i-execute) method to execute SQL commands. For example,
...
documentation](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#data-migrations) for more details.

For more details and examples of individual methods, check the API
documentation.

In particular the documentation for
[`ActiveRecord::ConnectionAdapters::SchemaStatements`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html), which provides the
...
[`ActiveRecord::ConnectionAdapters::TableDefinition`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/TableDefinition.html).

And for the object yielded by `change_table`, see
[`ActiveRecord::ConnectionAdapters::Table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/Table.html).

### [3.10. Using the `change` Method](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-the-change-method)
...
- [`add_check_constraint`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_check_constraint)
- [`add_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_column)
- [`add_foreign_key`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_foreign_key)
- [`add_index`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_index)
- [`add_reference`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_reference)
- [`add_timestamps`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-add_timestamps)
...
- [`change_column_null`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_column_null)
...
- [`create_join_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-create_join_table)
- [`create_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-create_table)
- `disable_extension`
- [`drop_join_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-drop_join_table)
...
- [`rename_column`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-rename_column)
- [`rename_index`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-rename_index)
- [`rename_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-rename_table)

[`change_table`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/ConnectionAdapters/SchemaStatements.html#method-i-change_table) is also reversible, as long as the block only calls
...
### [3.11. Using `reversible`](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-reversible)
...
ActiveRecord methods. You can use [`reversible`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Migration.html#method-i-reversible) to specify what to do when
...
### [3.12. Using the `up`/`down` Methods](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-the-up-down-methods)
...
### [3.13. Throwing an error to prevent reverts](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#throwing-an-error-to-prevent-reverts)
...
### [3.14. Reverting Previous Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#reverting-previous-migrations)

You can use Active Record's ability to rollback migrations using the
[`revert`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Migration.html#method-i-revert) method:
...
## [4. Running Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#running-migrations)
...
### [4.1. Rolling Back](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#rolling-back)
...
#### [4.1.1. Transactions](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#transactions)
...
a Migration with self.disable\_ddl\_transaction!.

### [4.2. Setting Up the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#setting-up-the-database)

The `bin/rails db:setup` command will create the database, load the schema, and
initialize it with the seed data.

### [4.3. Preparing the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#preparing-the-database)
...
documentation](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#migrations-and-seed-data) for more details.
...
### [4.4. Resetting the Database](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#resetting-the-database)
...
out more about dumping the schema see [Schema Dumping and You](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#schema-dumping-and-you) section.
...
### [4.5. Running Specific Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#running-specific-migrations)
...
### [4.6. Running Migrations in Different Environments](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#running-migrations-in-different-environments)
...
### [4.7. Changing the Output of Running Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#changing-the-output-of-running-migrations)
...
| Method | Purpose |
| --- | --- |
| [`suppress_messages`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Migration.html#method-i-suppress_messages) | Takes a block as an argument and suppresses any output generated by the block. |
| [`say`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Migration.html#method-i-say) | Takes a message argument and outputs it as is. A second boolean argument can be passed to specify whether to indent or not. |
| [`say_with_time`](https://api.rubyonrails.org/v8.1.3/classes/ActiveRecord/Migration.html#method-i-say_with_time) | Outputs text along with how long it took to run its block. If the block returns an integer it assumes it is the number of rows affected. |
...
### [4.8. Rails Migration Version Control](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#rails-migration-version-control)
...
For example, if you have a migration file named 20240428000000\_create\_users.rb,
Rails will extract the version number (20240428000000) from the filename and
insert it into the schema\_migrations table after the migration has been
successfully executed.

You can view the contents of the schema\_migrations table directly in your
...
Then, within the database console, you can query the schema\_migrations table:
...
## [5. Changing Existing Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#changing-existing-migrations)
...
migrations in whole or in part (see [Reverting Previous Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#reverting-previous-migrations) above).

## [6. Schema Dumping and You](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#schema-dumping-and-you)

### [6.1. What are Schema Files for?](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#what-are-schema-files-for-questionmark)
...
than it is to replay the entire migration history. [Old migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#old-migrations) may fail
...
### [6.2. Types of Schema Dumps](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#types-of-schema-dumps)

The format of the schema dump generated by Rails is controlled by the
[`config.active_record.schema_format`](https://guides.rubyonrails.org/v8.1/configuring.html#config-active-record-schema-format) setting defined in
...
#### [6.2.1. Using the default `:ruby` schema](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-the-default-ruby-schema)
...
#### [6.2.2. Using the `:sql` schema dumper](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-the-sql-schema-dumper)
...
### [6.3. Schema Dumps and Source Control](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#schema-dumps-and-source-control)
...
## [7. Active Record and Referential Integrity](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#active-record-and-referential-integrity)
...
key constraints](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#foreign-keys) in the database.
...
## [8. Migrations and Seed Data](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#migrations-and-seed-data)
...
## [9. Old Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#old-migrations)
...
[Rails Migration Version Control section](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#rails-migration-version-control).
...
### [9.1. Migrations from Engines](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#migrations-from-engines)

When dealing with migrations from [Engines](https://guides.rubyonrails.org/v8.1/engines.html), there's a caveat to consider.
...
### [10.1. Using UUIDs instead of IDs for Primary Keys](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#using-uuids-instead-of-ids-for-primary-keys)
...
#### [10.1.1. Enabling UUIDs in Rails](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#enabling-uuids-in-rails)
...
### [10.2. Data Migrations](https://guides.rubyonrails.org/v8.1/active_record_migrations.html\#data-migrations)
...
[Back to top](https://guides.rubyonrails.org/v8.1/active_record_migrations.html#main-skip-link)